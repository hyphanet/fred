...
public class CSSParserTest {
	...
	private static final HashMap<String, String> CSS1_SELECTOR =
		new HashMap<>();
	...
	private static final HashMap<String, String> CSS2_SELECTOR =
		new HashMap<>();
	...
	private static final HashMap<String, String> CSS3_SELECTOR =
		new HashMap<>();
	...
	static {
		...
		CSS3_BAD_SELECTOR.add(
			"tr:nth-child(999999999999999n+999999999999999) {}"
		);
		CSS3_BAD_SELECTOR.add(
			"tr:nth-child(999999999999999n-999999999999999) {}"
		);
	...
	private static final String CSS_IMPORT_TYPE =
		"@import url(\"/KSK@test?type=text/plain\");";
	...
	private static final String CSS_IMPORT_BRACKET =
		"@import url(\"/KSK@thingy\\)\");";
	...
	private static final String LATE_CHARSET =
		"h3 { color:red;}\n@charset \"UTF-8\";";
	...
	private static final String LATE_BOM =
		"h3 { color:red;}\n\ufeffh4 { color:blue;}";
	private static final String LATE_BOMC =
		"h3 { color:red;}\nh4 { color:blue;}";
	...
	private static final String BROKEN_BEFORE_MEDIAC =
		" @media screen { h1 { color: blue }}";

	// Invalid media type

	private static final String CSS_INVALID_MEDIA_CASCADE =
		"@media blah { h1, h2 { color: green;} }";

	private static final LinkedHashMap<String, String> propertyTests =
		new LinkedHashMap<>();
	...
	static {
		...
		propertyTests.put(
			"td { background-position: bottom right center }\n",
			"td { }\n"
		);
		...
		// Invalid combination
		propertyTests.put(
			"@media speech { h1 { azimuth: left-side behind 30deg }; }",
			"@media speech { h1 { }}"
		);
		propertyTests.put(
		...
		propertyTests.put(
			"td { background-attachment: scroll}",
			"td { background-attachment: scroll}"
		);
		propertyTests.put(
		...
		propertyTests.put(
			"h3 { background-position: 30% top}",
			"h3 { background-position: 30% top}"
		);
		propertyTests.put(
			"h3 { background-position: 120% top}",
			"h3 { background-position: 120% top}"
		);
		propertyTests.put(
			"h3 { background-position: 8.5% top}",
			"h3 { background-position: 8.5% top}"
		);
		propertyTests.put("p { line-height: 120% }", "p { line-height: 120% }");
		// Fractional lengths
		propertyTests.put(
			"h3 { background-position: 3.3cm 20%}",
			"h3 { background-position: 3.3cm 20%}"
		);
		...
		propertyTests.put("h3 { background-image: url(/KSK@\");}", "h3 {} ");
		propertyTests.put(
			"h3 { background-image: url(/KSK@ test ));}",
			"h3 {}"
		);
		// This *is* valid.
		propertyTests.put(
		...
		propertyTests.put(
			"h3 { background: url(\"\\/\\/www.google.com/google.png\");}",
			"h3 {}"
		);
		propertyTests.put(
			"h3 { background: url(\"\\2f \\2f www.google.com/google.png\");}",
			"h3 {}"
		);
		propertyTests.put(
			"h3 { background: url(\"\\00002f\\00002fwww.google.com/google.png\");}",
			"h3 {}"
		);
		propertyTests.put(
			"h3 { background: url(\"%2f%2fwww.google.com/google.png\");}",
			"h3 {}"
		);
		propertyTests.put(
			"h3 { background: url(\"\\25 2f\\25 2fwww.google.com/google.png\");}",
			"h3 {}"
		);
		...
		propertyTests.put(
			"h1 { content: attr(\\202 \\ test);}",
			"h1 { content: attr(\\202 \\ test);}"
		);
		propertyTests.put(
			"h1 { content: attr(\\000202\\ test);}",
			"h1 { content: attr(\\000202\\ test);}"
		);
		propertyTests.put(
			"h1 { content: attr(\\;\\ test);}",
			"h1 { content: attr(\\;\\ test);}"
		);
		propertyTests.put(
			"h1 { content: attr(\\}\\ test);}",
		...
		propertyTests.put(
			"h2 { font-family: http://www.badguy.com/myfont.ttf}",
			"h2 {}"
		);
		propertyTests.put(
		...
		propertyTests.put(
			"div { box-sizing: invalidValueToTestFilter; }",
			"div { }"
		);
		propertyTests.put(
		...
		propertyTests.put(
			"body.abc { display: run-in }",
			"body.abc { display: run-in }"
		);
		propertyTests.put(
			"body.abc { display: none }",
			"body.abc { display: none }"
		);
		propertyTests.put(
			"body.abc { display: inherit }",
			"body.abc { display: inherit }"
		);
		propertyTests.put(
		...
		propertyTests.put(
			"div { display: ruby-text-container; }",
			"div { display: ruby-text-container; }"
		);
		propertyTests.put(
		...
		propertyTests.put(
			":link,:visited { cursor: url(example.svg#linkcursor) 2 5, url(hyper.cur), pointer }",
			":link { cursor: url(\"example.svg#linkcursor\") 2 5, url(\"hyper.cur\"), pointer }"
		);
		propertyTests.put(
			":link,:visited { cursor: url(example.svg#linkcursor) 2, url(hyper.cur), pointer }",
			":link { }"
		);
		...
		propertyTests.put(
			":active,:visited { color:red }",
			":active { color:red }"
		);
		propertyTests.put(
			":active,a:visited { color:red }",
			":active { color:red }"
		);
		propertyTests.put(
			":focus,:visited,:active { color:red }",
			":focus,:active { color:red }"
		);
		propertyTests.put(
			":focus,a:visited,:active { color:red }",
			":focus,:active { color:red }"
		);
		...
		propertyTests.put(
			"div { justify-items: legacy center; }",
			"div { justify-items: legacy center; }"
		);
		propertyTests.put(
			"div { justify-items: auto; }",
			"div { justify-items: auto; }"
		);
		propertyTests.put(
			"div { justify-items: baseline; }",
			"div { justify-items: baseline; }"
		);
		propertyTests.put(
			"div { justify-items: true left; }",
			"div { justify-items: true left; }"
		);
		propertyTests.put(
			"div { justify-items: self-start; }",
			"div { justify-items: self-start; }"
		);
		propertyTests.put(
			"div { justify-items: self-start legacy left; }",
			"div { }"
		);
		propertyTests.put(
		...
		propertyTests.put(
			"div { align-self: true center; }",
			"div { align-self: true center; }"
		);
		propertyTests.put(
			"div { align-self: center true; }",
			"div { align-self: center true; }"
		);
		propertyTests.put("div { align-self: center true center; }", "div { }");
		propertyTests.put(
			"div { justify-self: true center; }",
			"div { justify-self: true center; }"
		);
		propertyTests.put(
			"div { justify-self: center true; }",
			"div { justify-self: center true; }"
		);
		propertyTests.put(
			"div { justify-self: center true center; }",
			"div { }"
		);
		...
		propertyTests.put(
			"div { display: block list-item flow list-item; }",
			"div { }"
		);
		...
		propertyTests.put(
			"body { nav-down: h2#java current; }",
			"body { nav-down: h2#java current; }"
		);
		propertyTests.put(
			"body { nav-up: #java root; }",
			"body { nav-up: #java root; }"
		);
		propertyTests.put(
			"body { nav-left: div.bold '<target-name>'; }",
			"body { }"
		);
		propertyTests.put(
		...
		propertyTests.put(
			"button#foo { nav-left: invalidSelector \"sidebar\"; }",
			"button#foo { }"
		);
		...
		// valid, 2 values
		propertyTests.put(
			"div { transition-duration: 5s, 1s; }",
			"div { transition-duration: 5s, 1s; }"
		);
		propertyTests.put(
			"div { transition-delay: 1s, 3s; }",
			"div { transition-delay: 1s, 3s; }"
		);
		propertyTests.put(
		...
		propertyTests.put(
			"div { transition-timing-function: \"test\"; }",
			"div { }"
		);
	}
	...
	private void testBadSelectorFiltering(Set<String> badSelectorSet)
		...
		for (String key : badSelectorSet) {
			assertEquals(
				"Bad selector filtering should produce empty string: '" +
				key +
				"'",
				"",
				filter(key)
	...
	public void testImports() throws IOException, URISyntaxException {
		...
		assertEquals(
			"key=" + CSS_IMPORT_UNQUOTED + " should be empty",
			"",
			filter(CSS_IMPORT_UNQUOTED)
		);
		assertEquals(
			"key=" +
			CSS_IMPORT_NOURL +
	...
	private String filter(String css) throws IOException, URISyntaxException {
		...
		GenericReadFilterCallback cb = new GenericReadFilterCallback(
			new URI(
	...
	public void testCharset() throws IOException, URISyntaxException {
		...
		assertEquals(
			"output=\"" + filter(LATE_BOM) + "\"",
			LATE_BOMC,
			filter(LATE_BOM)
		);
	}

	private void getCharsetTest(String charset)
		throws IOException, URISyntaxException {
	...
	private void getCharsetTest(String charset, String family)
		...
		String detectedCharset = filter.getCharset(
			bytes,
			bytes.length,
			charset
		);
		...
		detectedCharset = ContentFilter.detectCharset(
			bytes,
			bytes.length,
			cssMIMEType,
			null
		...
		try (
			...
			filterStatus = ContentFilter.filter(
				inputStream,
				outputStream,
				"text/css",
				new URI(
		...
		String filtered = new String(
			BucketTools.toByteArray(outputBucket),
			charset
		);
		assertEquals(
	...
	private void charsetTestUnsupported(String charset)
		throws IOException, URISyntaxException {
		String original = "@charset \"" + charset + "\";\nh2 { color: red;}";
		byte[] bytes = original.getBytes(charset);
		CSSReadFilter filter = new CSSReadFilter();
		...
		SimpleReadOnlyArrayBucket inputBucket = new SimpleReadOnlyArrayBucket(
			bytes
		);
	...
	@Test
	public void testDoubleCommentStart()
		throws IOException, URISyntaxException {
		assertEquals("Double comment start does not crash", filter("/*/*"), "");
	}

	@Test
	public void testTripleCommentStart()
		throws IOException, URISyntaxException {
		assertEquals(
			"Triple comment start does not crash",
			filter("/*/*/*"),
			""
		);
	}
