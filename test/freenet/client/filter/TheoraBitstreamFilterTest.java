...
public class TheoraBitstreamFilterTest {
	...
	public void parseIdentificationHeaderTest() throws IOException {
		...
		TheoraBitstreamFilter theoraBitstreamFilter = new TheoraBitstreamFilter(
			page
		);
		assertEquals(
			page.asPackets(),
			theoraBitstreamFilter.parse(page).asPackets()
		);
	}
	...
	public void parseTest() throws IOException {
		try (
			...
			TheoraBitstreamFilter theoraBitstreamFilter =
				new TheoraBitstreamFilter(page);
