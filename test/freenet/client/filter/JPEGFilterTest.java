...
public class JPEGFilterTest {
	...
	@Test
	public void testThatAThumbnailExtensionCodeIsPreserved()
		throws IOException {
	...
	private void writeStartOfImageMarker(OutputStream outputStream)
		throws IOException {
		outputStream.write(new byte[] { (byte) 0xff, (byte) 0xd8 });
	}

	private void writeAppMarker(OutputStream outputStream, byte[] payload)
		throws IOException {
	...
	private void writeEndOfImageMarker(ByteArrayOutputStream outputStream)
		throws IOException {
