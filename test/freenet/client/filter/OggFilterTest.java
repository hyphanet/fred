...
public class OggFilterTest {
	...
	private void writeToTestOutputFile(ByteArrayOutputStream output)
		throws IOException {
		...
		try (
			FileOutputStream newFileStream = new FileOutputStream(
				testOutputFile
			)
		) {
