...
public class NewPacketFormatTest extends TestCase {
	...
	public void testEmptyCreation() throws BlockedTooLongException {
		...
		SessionKey s = new SessionKey(null, null, null, null, null, null, null, null, new NewPacketFormatKeyContext(0, 0));
	...
	public void testLostLastAck() throws BlockedTooLongException, InterruptedException {
		...
		SessionKey senderKey = new SessionKey(null, null, null, null, null, null, null, null, new NewPacketFormatKeyContext(0, 0));
		senderNode.currentKey = senderKey;
		SessionKey receiverKey = new SessionKey(null, null, null, null, null, null, null, null, new NewPacketFormatKeyContext(0, 0));
	...
	public void testLoadStatsSendWhenPeerWants() throws BlockedTooLongException, InterruptedException {
		...
		final SessionKey senderKey = new SessionKey(null, null, null, null, null, null, null, null, new NewPacketFormatKeyContext(0, 0));
		NullBasePeerNode senderNode = new NullBasePeerNode() {
	...
	public void testSequenceNumberEncryption() {
		...
		SessionKey sessionKey = new SessionKey(null, null, null, incommingCipher, null, ivCipher, ivNonce, null, null);
