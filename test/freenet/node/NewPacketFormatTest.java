...
public class NewPacketFormatTest {
  ...
  public void testLostLastAck() throws BlockedTooLongException, InterruptedException {
    ...
    senderQueue.queueAndEstimateSize(
        new MessageItem(new byte[1024], null, false, null, (short) 0, false, false), 1024);
  ...
  public void testResendAlreadyCompleted() throws BlockedTooLongException, InterruptedException {
    ...
    senderQueue.queueAndEstimateSize(
        new MessageItem(new byte[128], null, false, null, (short) 0, false, false), 1024);
  ...
  // Test sending it when the peer wants it to be sent. This is as a real message, *not* as a lossy
  // message.
  @Test
  public void testLoadStatsSendWhenPeerWants()
    ...
    final SessionKey senderKey =
        new SessionKey(
            null, null, null, null, null, null, null, null, new NewPacketFormatKeyContext(0, 0), 1);
    NullBasePeerNode senderNode =
        new NullBasePeerNode() {

          boolean shouldSend = true;

          @Override
          public MessageItem makeLoadStats(
              boolean realtime, boolean highPriority, boolean noRemember) {
  ...
  public void testLoadStatsLowLevel() throws BlockedTooLongException, InterruptedException {
    ...
    senderQueue.queueAndEstimateSize(
        new MessageItem(new byte[128], null, false, null, (short) 0, false, true), 1024);
  ...
  public void testEncryption()
    ...
    senderQueue.queueAndEstimateSize(
        new MessageItem(message, null, false, null, (short) 0, false, false), 1024);
