...
public class LocationTest {
	...
	public void testDistance() {
		...
		assertEquals(
			0.5,
			Location.distance(VALID_1, Location.normalize(VALID_1 + 0.5)),
			EPSILON
		);
		assertEquals(
			0.5,
		...
		assertEquals(
			0.5,
			Location.distance(VALID_2, Location.normalize(VALID_2 + 0.5)),
			EPSILON
		);
		assertEquals(
			0.5,
	...
	public void testChange() {
		...
		assertEquals(
			0.5,
			Location.change(VALID_1, Location.normalize(VALID_1 + 0.5)),
			EPSILON
		);
		assertEquals(
			0.5,
		...
		assertEquals(
			0.5,
			Location.change(VALID_2, Location.normalize(VALID_2 + 0.5)),
			EPSILON
		);
		assertEquals(
			0.5,
	...
	public void testDistanceAllowInvalid() {
		...
		assertEquals(
			DIST_12,
			Location.distanceAllowInvalid(VALID_1, VALID_2),
			EPSILON
		);
		assertEquals(
			DIST_12,
			Location.distanceAllowInvalid(VALID_2, VALID_1),
			EPSILON
		);
		...
		assertEquals(
			0.5,
			Location.distanceAllowInvalid(
				VALID_1,
				Location.normalize(VALID_1 + 0.5)
			),
			EPSILON
		);
		assertEquals(
		...
		assertEquals(
			...
			Location.distanceAllowInvalid(
				VALID_2,
				Location.normalize(VALID_2 + 0.5)
			),
			EPSILON
		);
		assertEquals(
		...
		assertEquals(
			0.0,
			Location.distanceAllowInvalid(VALID_1, VALID_1),
			EPSILON
		);
		assertEquals(
			0.0,
			Location.distanceAllowInvalid(VALID_2, VALID_2),
			EPSILON
		);
		...
		assertEquals(
			2.0 - VALID_1,
			Location.distanceAllowInvalid(INVALID_1, VALID_1),
			EPSILON
		);
		assertEquals(
			2.0 - VALID_1,
			Location.distanceAllowInvalid(VALID_1, INVALID_1),
			EPSILON
		);
		assertEquals(
			2.0 - VALID_1,
			Location.distanceAllowInvalid(INVALID_2, VALID_1),
			EPSILON
		);
		assertEquals(
			2.0 - VALID_1,
			Location.distanceAllowInvalid(VALID_1, INVALID_2),
			EPSILON
		);
		assertEquals(
			2.0 - VALID_2,
			Location.distanceAllowInvalid(INVALID_1, VALID_2),
			EPSILON
		);
		assertEquals(
			2.0 - VALID_2,
			Location.distanceAllowInvalid(VALID_2, INVALID_1),
			EPSILON
		);
		assertEquals(
			2.0 - VALID_2,
			Location.distanceAllowInvalid(INVALID_2, VALID_2),
			EPSILON
		);
		assertEquals(
			2.0 - VALID_2,
			Location.distanceAllowInvalid(VALID_2, INVALID_2),
			EPSILON
		);
		...
		assertEquals(
			0.0,
			Location.distanceAllowInvalid(INVALID_1, INVALID_1),
			EPSILON
		);
		assertEquals(
			0.0,
			Location.distanceAllowInvalid(INVALID_1, INVALID_2),
			EPSILON
		);
		assertEquals(
			0.0,
			Location.distanceAllowInvalid(INVALID_2, INVALID_1),
			EPSILON
		);
		assertEquals(
			0.0,
			Location.distanceAllowInvalid(INVALID_2, INVALID_2),
			EPSILON
		);
	}
}
