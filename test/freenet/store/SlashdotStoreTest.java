...
public class SlashdotStoreTest {
	...
	public void testDeletion()
		...
		SlashdotStore<CHKBlock> ss = new SlashdotStore<>(
			store,
			10,
			0,
			100,
		...
		String data = decodeBlock(verify, key);
		System.err.println(
			"Got data: " + data + " but should have been deleted!"
		);
		fail();
	}
	...
	private ClientCHKBlock encodeBlock(String test)
