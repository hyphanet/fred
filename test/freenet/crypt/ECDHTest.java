...
public class ECDHTest {
	...
	public void testGetAgreedSecret()
		throws InvalidKeyException, IllegalStateException, NoSuchAlgorithmException, InvalidAlgorithmParameterException {
	...
	public static void main(String[] args)
		...
		System.out.println(
			"Alice S: " + toHex(alice.getAgreedSecret(bob.getPublicKey()))
		);
		System.out.println(
