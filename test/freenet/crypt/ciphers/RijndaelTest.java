...
public class RijndaelTest {
	...
	private final byte[] PLAINTXT128_1 = HexUtil.hexToBytes(
		"0123456789abcdef1123456789abcdef"
	);
	private final byte[] KEY128_1 = HexUtil.hexToBytes(
		"deadbeefcafebabe0123456789abcdef"
	);
	private final byte[] CIPHER128_1 = HexUtil.hexToBytes(
		"8c5b8c04805c0e07dd62b381730d5d10"
	);

	private final byte[] PLAINTXT192_1 = HexUtil.hexToBytes(
		"0123456789abcdef1123456789abcdef2123456789abcdef"
	);
	private final byte[] KEY192_1 = HexUtil.hexToBytes(
		"deadbeefcafebabe0123456789abcdefcafebabedeadbeef"
	);
	private final byte[] CIPHER192_1 = HexUtil.hexToBytes(
		"7fae974786a9741d96693654bc7a8aff09b3f116840ffced"
	);

	private final byte[] PLAINTXT256_1 = HexUtil.hexToBytes(
		"0123456789abcdef1123456789abcdef2123456789abcdef3123456789abcdef"
	);
	private final byte[] KEY256_1 = HexUtil.hexToBytes(
		"deadbeefcafebabe0123456789abcdefcafebabedeadbeefcafebabe01234567"
	);
	private final byte[] CIPHER256_1 = HexUtil.hexToBytes(
		"6fcbc68fc938e5f5a7c24d7422f4b5f153257b6fb53e0bca26770497dd65078c"
	);
	...
	public void testKnownValue() throws UnsupportedCipherException {
		...
		if (false) {
			...
			assertTrue(
				"(192,192) ENCIPHER",
				Arrays.equals(res192, CIPHER192_1)
			);
			byte[] des192 = new byte[192 / 8];
			aes192.decipher(res192, des192);
			assertTrue(
				"(192,192) DECIPHER",
				Arrays.equals(des192, PLAINTXT192_1)
			);
		}
	...
	// ecb_vk.txt
	private byte[] TEST_VK_PT = HexUtil.hexToBytes(
	...
	public void testStandardTestVK() throws UnsupportedCipherException {
		...
		for (int i = 0; i < TEST_VK128.length; i++) {
			...
			assertTrue(
				"ECB_VK KEYSIZE=128 I=" + (i + 1),
				Arrays.equals(cipher, TEST_VK128[i][1])
			);
		}
		...
		for (int i = 0; i < TEST_VK192.length; i++) {
			...
			assertTrue(
				"ECB_VK KEYSIZE=192 I=" + (i + 1),
				Arrays.equals(cipher, TEST_VK192[i][1])
			);
		}
	}
	...
	public void testStandardTestVKJCA()
		throws UnsupportedCipherException, InvalidKeyException, NoSuchAlgorithmException, NoSuchPaddingException, IllegalBlockSizeException, BadPaddingException {
		...
		for (int i = 0; i < TEST_VK192.length; i++) {
			...
			assertTrue(
				"ECB_VK KEYSIZE=192 I=" + (i + 1),
				Arrays.equals(output, TEST_VK192[i][1])
			);
		}
	}
	...
	private byte[] TEST_VK_PTx256 = HexUtil.hexToBytes(
	...
	public void testNonStandardTestVK() throws UnsupportedCipherException {
		...
		for (int i = 0; i < TEST_VK256x256.length; i++) {
			...
			assertTrue(
				"ECB_VK KEYSIZE=256 I=" + (i + 1),
				Arrays.equals(cipher, TEST_VK256x256[i][1])
			);
		}
	}
	...
	public void testGladmanTestVectors()
		throws UnsupportedCipherException, IOException, InvalidKeyException, NoSuchAlgorithmException, NoSuchPaddingException, IllegalBlockSizeException, BadPaddingException {
		checkGladmanTestVectors("t");
		checkGladmanTestVectors("k");
	}

	private void checkGladmanTestVectors(String type)
		throws UnsupportedCipherException, IOException, NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException, IllegalBlockSizeException, BadPaddingException {
		for (int testNumber : GLADMAN_TEST_NUMBERS) {
			...
			try {
				...
				int blockSize = Integer.parseInt(
					line.substring("BLOCKSIZE=".length())
				);
				line = br.readLine();
				int keySize = Integer.parseInt(
					line.substring("KEYSIZE=  ".length())
				);
				...
				while (true) {
					...
					if (prefix.equals("TEST= ")) {
						...
						if (
							...
							// Encrypt
							byte[] copyOfPlaintext = Arrays.copyOf(
								plaintext,
								plaintext.length
							);
							...
							// Decrypt
							byte[] copyOfCiphertext = Arrays.copyOf(
								ciphertext,
								ciphertext.length
							);
							...
							if (blockSize == 128) {
								if (
									...
									assertTrue(
										Arrays.equals(output, plaintext)
									);
								}
							}
							// Clear
