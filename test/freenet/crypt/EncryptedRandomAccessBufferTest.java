...
public class EncryptedRandomAccessBufferTest {
	...
	@Test
	public void testSuccesfulRoundTrip()
		...
		for (EncryptedRandomAccessBufferType type : types) {
			...
			EncryptedRandomAccessBuffer erat = new EncryptedRandomAccessBuffer(
				type,
				barat,
				secret,
				true
	...
	@Test
	public void testSuccesfulRoundTripReadHeader()
		throws IOException, GeneralSecurityException {
		for (EncryptedRandomAccessBufferType type : types) {
			byte[] bytes = new byte[100];
			ByteArrayRandomAccessBuffer barat = new ByteArrayRandomAccessBuffer(
			...
			erat.pwrite(0, message, 0, message.length);
			erat.close();
			ByteArrayRandomAccessBuffer barat2 =
				new ByteArrayRandomAccessBuffer(bytes);
			EncryptedRandomAccessBuffer erat2 = new EncryptedRandomAccessBuffer(
				type,
				barat2,
				secret,
				false
	...
	public void testWrongERATType()
		...
		erat.close();
		ByteArrayRandomAccessBuffer barat2 = new ByteArrayRandomAccessBuffer(
			bytes
		);
	...
	@Test
	public void testWrongMasterSecret()
		throws IOException, GeneralSecurityException {
		byte[] bytes = new byte[100];
		ByteArrayRandomAccessBuffer barat = new ByteArrayRandomAccessBuffer(
			bytes
	...
	@Test
	public void testPreadFileOffsetTooSmall()
		throws IOException, GeneralSecurityException {
		byte[] bytes = new byte[100];
		ByteArrayRandomAccessBuffer barat = new ByteArrayRandomAccessBuffer(
			bytes
	...
	@Test
	public void testPreadFileOffsetTooBig()
		throws IOException, GeneralSecurityException {
		byte[] bytes = new byte[100];
		ByteArrayRandomAccessBuffer barat = new ByteArrayRandomAccessBuffer(
			bytes
	...
	@Test
	public void testPwriteFileOffsetTooSmall()
		throws IOException, GeneralSecurityException {
		byte[] bytes = new byte[100];
		ByteArrayRandomAccessBuffer barat = new ByteArrayRandomAccessBuffer(
			bytes
	...
	@Test
	public void testPwriteFileOffsetTooBig()
		throws IOException, GeneralSecurityException {
		byte[] bytes = new byte[100];
		ByteArrayRandomAccessBuffer barat = new ByteArrayRandomAccessBuffer(
			bytes
	...
	public void testStoreTo()
		...
		r.nextBytes(buf);
		FileRandomAccessBuffer rafw = new FileRandomAccessBuffer(
			tempFile,
			buf.length + types[0].headerLen,
			false
		);
		EncryptedRandomAccessBuffer eraf = new EncryptedRandomAccessBuffer(
			types[0],
			rafw,
			secret,
			true
		...
		EncryptedRandomAccessBuffer restored =
			(EncryptedRandomAccessBuffer) BucketTools.restoreRAFFrom(
				dis,
	...
	public void testSerialize()
		...
		EncryptedRandomAccessBuffer restored =
			(EncryptedRandomAccessBuffer) ois.readObject();
