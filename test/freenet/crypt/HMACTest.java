...
public class HMACTest {
	...
	static byte[] knownKey = Hex.decode(
		"0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b"
	);
	static byte[] knownSHA256 = Hex.decode(
	...
	public void testBenchmark() {
		...
		for (int len = 8; len <= 32768; len *= 4) {
			...
			System.out.println(
				"Legacy HMAC took " + TimeUtil.formatTime(legacyLength, 6, true)
			);
			System.out.println(
				"Current HMAC took " +
				TimeUtil.formatTime(currentLength, 6, true)
			);
			System.out.println(
