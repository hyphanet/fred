...
public class TimeUtilTest {
	...
	public void testFormatTime_KnownValues() {
		...
		for (int i = 0; i < valAndExpected.length; i++) {
			...
			assertEquals(
				TimeUtil.formatTime(methodLong.longValue()),
				valAndExpected[i][1]
			);
		}
	}
	...
	public void testFormatTime_LongIntBoolean_maxTerms() {
		...
		for (int i = 0; i < valAndExpected.length; i++) assertEquals(
			TimeUtil.formatTime(oneForTermLong, i, true),
			valAndExpected[i]
		);
	}
	...
	public void testToMillis_maxLong() {
		assertEquals(
			TimeUtil.toMillis("15250284452w3d7h12m55.807s"),
			Long.MAX_VALUE
		);
	}
	...
	public void testToMillis_minLong() {
		assertEquals(
			TimeUtil.toMillis("-15250284452w3d7h12m55.808s"),
			Long.MIN_VALUE
		);
	}
