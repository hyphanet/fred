...
public class Bzip2CompressorTest {
	...
	public void testByteArrayDecompress() throws IOException {
		...
		writtenBytes = Compressor.COMPRESSOR_TYPE.BZIP2.decompress(
			compressedData,
			0,
	...
	public void testCompressException() throws IOException {
		...
		try {
			Compressor.COMPRESSOR_TYPE.BZIP2.compress(
				inBucket,
				factory,
				32,
				32
	...
	private byte[] doBucketDecompress(byte[] compressedData)
		throws IOException {
		ByteArrayInputStream decompressorInput = new ByteArrayInputStream(
			compressedData
		);
	...
	private byte[] doCompress(byte[] uncompressedData) throws IOException {
		...
		outBucket = Compressor.COMPRESSOR_TYPE.BZIP2.compress(
			inBucket,
			factory,
			32768,
			32768
