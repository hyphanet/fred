...
public class SingleOffsetReplacingOutputStreamTest {
	...
	public void allBytesBeforeTheOffsetAreUnchanged() throws IOException {
		filterOutputStreamWithOffsetAndReplacementWritingByteArrays(
			32768,
			1,
			65536
		);
	...
	@Test
	public void byteAtBeginningOfSecondBufferCanBeReplaced()
		throws IOException {
		filterOutputStreamWithOffsetAndReplacementWritingByteArrays(10, 2, 10);
	}

	@Test
	public void byteInTheMiddleOfSecondBufferCanBeReplaced()
		throws IOException {
		filterOutputStreamWithOffsetAndReplacementWritingByteArrays(10, 3, 15);
	}

	@Test
	public void byteAtOffsetZeroCanBeReplacedWhenWritingSingleBytes()
		throws IOException {
		filterOutputStreamWithOffsetAndReplacementWritingSingleBytes(
			4096,
			16,
			0
		);
	...
	@Test
	public void byteInMiddleOfStreamBeReplacedWhenWritingSingleBytes()
		throws IOException {
		filterOutputStreamWithOffsetAndReplacementWritingSingleBytes(
			8192,
			8,
	...
	@Test
	public void byteAtEndOfStreamCanBeReplacedWhenWritingSingleBytes()
		throws IOException {
		filterOutputStreamWithOffsetAndReplacementWritingSingleBytes(
			16384,
			4,
	...
	@Test
	public void byteAtStartOfBufferCanBeReplacedWhenWritingHalfBuffers()
		throws IOException {
		filterOutputStreamWithOffsetAndReplacementWritingHalfBuffers(
			4096,
			16,
			0
		);
	...
	@Test
	public void byteAtMiddleOfBufferCanBeReplacedWhenWritingHalfBuffers()
		throws IOException {
		filterOutputStreamWithOffsetAndReplacementWritingHalfBuffers(
			8192,
			8,
	...
	@Test
	public void byteAtEndOfBufferCanBeReplacedWhenWritingHalfBuffers()
		throws IOException {
		filterOutputStreamWithOffsetAndReplacementWritingHalfBuffers(
			16384,
			4,
