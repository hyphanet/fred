...
public class OldLZMACompressorTest {
	...
	private static final byte[] COMPRESSED_DATA_1_LZMA_OLD = new byte[] {
		0,
		48,
		-18,
		72,
	...
	public void testOldLzmaCompressor() throws IOException {
		Compressor.COMPRESSOR_TYPE lzcompressor =
			Compressor.COMPRESSOR_TYPE.LZMA;
		Compressor compressorZero =
			Compressor.COMPRESSOR_TYPE.getCompressorByMetadataID((short) 2);
	...
	public void testByteArrayDecompress()
		...
		writtenBytes = Compressor.COMPRESSOR_TYPE.LZMA.decompress(
			compressedData,
			0,
	...
	private byte[] doCompress(byte[] uncompressedData)
		...
		outBucket = Compressor.COMPRESSOR_TYPE.LZMA.compress(
			inBucket,
			factory,
	...
	private byte[] doBucketDecompress(byte[] compressedData)
		...
		COMPRESSOR_TYPE.LZMA.decompress(
			decompressorInput,
			decompressorOutput,
			32768,
			32768 * 2
