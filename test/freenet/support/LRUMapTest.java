...
public class LRUMapTest {
	...
	private LRUMap<Object, Object> createSampleHashTable(int size) {
		...
		for (int i = 0; i < sampleObjects.length; i++) methodLRUht.push(
			sampleObjects[i][0],
			sampleObjects[i][1]
		);
		return methodLRUht;
	 ...
	 */
	private boolean verifyKeyValPresence(
		LRUMap<Object, Object> aLRUht,
		Object aKey,
		Object aValue
	) {
	...
	public void testPushNull() {
		LRUMap<Object, Object> methodLRUht = createSampleHashTable(
			sampleElemsNumber
		);
		try {
	...
	public void testPushSameObjTwice() {
		...
		//check presence
		assertTrue(
			verifyKeyValPresence(methodLRUht, sampleObj[0][0], sampleObj[0][1])
		);
		assertTrue(
			verifyKeyValPresence(methodLRUht, sampleObj[1][0], sampleObj[1][1])
		);
		//check size
