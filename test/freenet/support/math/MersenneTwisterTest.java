...
public class MersenneTwisterTest {
	...
	public void testBytesToInts() {
		...
		for (int i = 0; i < INPUT_1.length; i++) assertEquals(
			INPUT_1[i],
			output[i]
		);
	}
	...
	public void testConsistencySeedFromInts() throws NoSuchAlgorithmException {
		...
		assertEquals(
			bytesToString(EXPECTED_OUTPUT_MT_INTS),
	...
	public void testConsistencySeedFromBytes() throws NoSuchAlgorithmException {
		...
		assertEquals(
			bytesToString(EXPECTED_OUTPUT_MT_BYTES),
			bytesToString(md.digest())
		);
	}

	@Test
	public void testConsistencySeedFromInteger()
		...
		assertEquals(
			bytesToString(EXPECTED_OUTPUT_MT_INT),
			bytesToString(md.digest())
		);
	}
	...
	public void testConsistencySeedFromLong() throws NoSuchAlgorithmException {
		...
		assertEquals(
			bytesToString(EXPECTED_OUTPUT_MT_LONG),
			bytesToString(md.digest())
		);
	}
