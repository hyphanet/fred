...
public class L10nExtensionTest {
	...
	public void l10nFunctionReturnStringNullIfNotArgumentsAreGiven() {
		assertThat(
			l10nFunction.execute(emptyMap(), null, null, 0),
			equalTo("null")
		);
	}
	...
	public void l10nFunctionRetrievesGivenArgumentWithPrefixFromContextToNodeL10n() {
		...
		assertThat(
			l10nFunction.execute(arguments, null, context, 0),
			equalTo("Localized Value")
		);
	}
	...
	private final Function l10nFunction = l10nExtension
		.getFunctions()
		.get("l10n");
}
