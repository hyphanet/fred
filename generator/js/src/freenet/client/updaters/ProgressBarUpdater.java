...
/**
 * This Updater is to replace the progress bar at the progress page. It simply replaces it, but if
 * the content is {@link UpdaterConstants.FINISHED}, then it will reload the page
 */
