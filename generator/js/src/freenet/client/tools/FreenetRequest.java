...
public class FreenetRequest {
   ...
   * @param parameters - The parameters to send along with the request
   ...
   *
   * @param path - The path to send the request to
   * @param parameter - The parameter to send along with the request
   * @return The sent request
   */
   ...
   * @param path - The path to send the request to
   * @param parameter - The parameter to send along with the request
   * @param callback - The callback that is registered to the request
   * @return The sent request
   */
  public static Request sendRequest(
      String path, QueryParameter parameter, RequestCallback callback) {
   ...
   */
  public static Request sendRequest(
      String path, QueryParameter[] parameters, RequestCallback callback) {
    ...
    for (int i = 0; i < paramList.size(); i++) {
      queryString =
          queryString.concat(paramList.get(i).getName() + "=" + paramList.get(i).getValue());
