...
public class TextModeClientInterfaceServer implements Runnable {
    ...
    public static TextModeClientInterfaceServer maybeCreate(Node node, NodeClientCore core, Config config)
        ...
        TMCIConfig.register("enabled", false, 1, true, true /* FIXME only because can't be changed on the fly */,
                            "TextModeClientInterfaceServer.enabled", "TextModeClientInterfaceServer.enabledLong",
        ...
        TMCIConfig.register("allowedHosts", NetworkInterface.DEFAULT_BIND_TO, 2, true, false,
                            ...
                            "TextModeClientInterfaceServer.allowedHostsLong", new TMCIAllowedHostsCallback(core));
        TMCIConfig.register("port", 2323, 1, true, false, "TextModeClientInterfaceServer.telnetPortNumber",
                            "TextModeClientInterfaceServer.telnetPortNumberLong", new TCMIPortNumberCallback(core),
                            false);
        ...
        if (direct) {
            ...
            TextModeClientInterface directTMCI = new TextModeClientInterface(node, core, client,
                                                     core.getDownloadsDir(), System.in, System.out);
