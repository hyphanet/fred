...
public class NodeARKInserter implements ClientPutCallback, RequestClient {
    ...
    private void startInserter() {
        ...
        inserter = new ClientPutter(this, b, uri, null,    // Modern ARKs easily fit inside 1KB so should be pure SSKs => no MIME type; this improves fetchability considerably
                                    ctx, RequestStarter.INTERACTIVE_PRIORITY_CLASS, false, false, this, null, false,
                                    node.clientCore.clientContext, null, -1);
            ...
            synchronized (this) {
                if (fs.get("physical.udp") == null) {
                    ...
                    try {
                        ...
                        Logger.error(this,
                                     "Error parsing own " + darknetOpennetString + " ref: " + e1 + " : "
    ...
    public void onGeneratedURI(FreenetURI uri, BaseClientPutter state, ObjectContainer container) {
        ...
        if (l < crypto.myARKNumber) {
            Logger.error(this,
                         "Inserted " + darknetOpennetString + " ARK edition # lower than attempted: " + l
