...
import freenet.node.load.NodeStats.RequestType;
import freenet.node.load.NodeStats.RunningRequestsSnapshot;
...
import freenet.node.stats.NodePinger;
...
import freenet.support.crypt.DiffieHellmanLightContext;
import freenet.support.crypt.Global;
import freenet.support.crypt.HMAC;
import freenet.support.crypt.KeyAgreementSchemeContext;
...
//		}
	...
	public void reportRoutedTo(double target, boolean isLocal, boolean realTime, PeerNode prev, Set<PeerNode> routedTo) {
		...
		node.nodeStats.reportRoutingMiss(isLocal, realTime, distance);
