...
public class RequestStarterGroup {
	...
	RequestStarterGroup(Node node, NodeClientCore core, int portNumber, RandomSource random, Config config, SimpleFieldSet fs, ClientContext ctx, long dbHandle, ObjectContainer container) {
		...
		chkRequestThrottleBulk = new MyRequestThrottle(throttleWindowBulk, 5000, "CHK Request", fs == null ? null : fs.subset("CHKRequestThrottle"), 32768, false);
		chkRequestThrottleRT = new MyRequestThrottle(throttleWindowRT, 5000, "CHK Request (RT)", fs == null ? null : fs.subset("CHKRequestThrottleRT"), 32768, true);
		...
		chkFetchSchedulerBulk = new ClientRequestScheduler(false, false, false, random, chkRequestStarterBulk, node, core, schedulerConfig, "CHKrequester", ctx);
		if(container != null)
			chkFetchSchedulerBulk.startCore(core, dbHandle, container);
		chkFetchSchedulerRT = new ClientRequestScheduler(false, false, true, random, chkRequestStarterRT, node, core, schedulerConfig, "CHKrequester", ctx);
		if(container != null)
		...
		chkInsertThrottleBulk = new MyRequestThrottle(throttleWindowBulk, 20000, "CHK Insert", fs == null ? null : fs.subset("CHKInsertThrottle"), 32768, false);
		chkInsertThrottleRT = new MyRequestThrottle(throttleWindowRT, 20000, "CHK Insert (RT)", fs == null ? null : fs.subset("CHKInsertThrottleRT"), 32768, true);
		...
		chkPutSchedulerBulk = new ClientRequestScheduler(true, false, false, random, chkInsertStarterBulk, node, core, schedulerConfig, "CHKinserter", ctx);
		if(container != null)
			chkPutSchedulerBulk.startCore(core, dbHandle, container);
		chkPutSchedulerRT = new ClientRequestScheduler(true, false, true, random, chkInsertStarterRT, node, core, schedulerConfig, "CHKinserter", ctx);
		if(container != null)
		...
		sskRequestThrottleBulk = new MyRequestThrottle(throttleWindowBulk, 5000, "SSK Request", fs == null ? null : fs.subset("SSKRequestThrottle"), 1024, false);
		sskRequestThrottleRT = new MyRequestThrottle(throttleWindowRT, 5000, "SSK Request (RT)", fs == null ? null : fs.subset("SSKRequestThrottleRT"), 1024, true);
		...
		sskFetchSchedulerBulk = new ClientRequestScheduler(false, true, false, random, sskRequestStarterBulk, node, core, schedulerConfig, "SSKrequester", ctx);
		if(container != null)
			sskFetchSchedulerBulk.startCore(core, dbHandle, container);
		sskFetchSchedulerRT = new ClientRequestScheduler(false, true, true, random, sskRequestStarterRT, node, core, schedulerConfig, "SSKrequester", ctx);
		if(container != null)
		...
		//insertThrottle = new ChainedRequestThrottle(10000, 2.0F, requestThrottle);
		// FIXME reenable the above
		sskInsertThrottleBulk = new MyRequestThrottle(throttleWindowBulk, 20000, "SSK Insert", fs == null ? null : fs.subset("SSKInsertThrottle"), 1024, false);
		sskInsertThrottleRT = new MyRequestThrottle(throttleWindowRT, 20000, "SSK Insert", fs == null ? null : fs.subset("SSKInsertThrottleRT"), 1024, true);
		...
		sskPutSchedulerBulk = new ClientRequestScheduler(true, true, false, random, sskInsertStarterBulk, node, core, schedulerConfig, "SSKinserter", ctx);
		if(container != null)
			sskPutSchedulerBulk.startCore(core, dbHandle, container);
		sskPutSchedulerRT = new ClientRequestScheduler(true, true, true, random, sskInsertStarterRT, node, core, schedulerConfig, "SSKinserter", ctx);
		if(container != null)
	...
	public class MyRequestThrottle implements BaseRequestThrottle {
		...
		public MyRequestThrottle(ThrottleWindowManager throttleWindow, int rtt, String string, SimpleFieldSet fs, int size, boolean realTime) {
