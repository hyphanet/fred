...
public class NotEnoughNiceLevelsUserAlert extends AbstractUserAlert {
    ...
    public String getText() {
        return NodeL10n.getBase().getString("NotEnoughNiceLevelsUserAlert.content", new String[] { "available",
                "required" }, new String[] { String.valueOf(NativeThread.NATIVE_PRIORITY_RANGE),
