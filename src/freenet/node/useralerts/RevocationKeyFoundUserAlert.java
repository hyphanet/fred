...
public class RevocationKeyFoundUserAlert extends AbstractUserAlert {
	...
	private static HTMLNode getHTML(boolean disabledNotBlown, String msg) {
		...
		if (disabledNotBlown) {
			div.addChild(
				"p",
				NodeL10n.getBase()
					.getString("RevocationKeyFoundUserAlert.textDisabled")
			);
			div.addChild(
				"p",
				NodeL10n.getBase()
					.getString(
						"RevocationKeyFoundUserAlert.textDisabledDetail",
						"message",
						msg
					)
			);
			...
			div.addChild(
				"p",
				NodeL10n.getBase().getString("RevocationKeyFoundUserAlert.text")
			);
			div.addChild(
				"p",
				NodeL10n.getBase()
					.getString(
						"RevocationKeyFoundUserAlert.textDetail",
						"message",
						msg
					)
			);
	...
	private static String getText(boolean disabledNotBlown, String msg) {
		if (disabledNotBlown) {
			...
			return (
				NodeL10n.getBase()
					.getString("RevocationKeyFoundUserAlert.text") +
				" " +
				NodeL10n.getBase()
					.getString(
						"RevocationKeyFoundUserAlert.textDetail",
	...
	private static String getTitle(boolean disabledNotBlown) {
		if (disabledNotBlown) return NodeL10n.getBase()
			.getString("RevocationKeyFoundUserAlert.titleDisabled");
		else return NodeL10n.getBase()
			.getString("RevocationKeyFoundUserAlert.title");
	}
