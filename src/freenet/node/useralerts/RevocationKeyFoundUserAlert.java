...
public class RevocationKeyFoundUserAlert extends AbstractUserAlert {
    public RevocationKeyFoundUserAlert(String msg, boolean disabledNotBlown) {
        super(false, getTitle(disabledNotBlown), getText(disabledNotBlown, msg), getText(disabledNotBlown, msg),
              getHTML(disabledNotBlown, msg), UserAlert.CRITICAL_ERROR, true, null, false, null);
    }
    ...
    private static HTMLNode getHTML(boolean disabledNotBlown, String msg) {
        ...
        if (disabledNotBlown) {
            ...
            div.addChild("p",
                         NodeL10n.getBase().getString("RevocationKeyFoundUserAlert.textDisabledDetail", "message",
                             msg));
        } else {
