    ...
    public HTMLNode getHTMLText() {
        ...
        NodeL10n.getBase().addL10nSubstitution(textNode,
                ...
                + (node.ipDetector.isDetecting()
                   ? "detectingWithConfigLink" : "unknownAddressWithConfigLink"), new String[] { "link" },
        ...
        if (node.ipDetector.noDetectPlugins()) {
            ...
            NodeL10n.getBase().addL10nSubstitution(p, "IPUndetectedUserAlert.loadDetectPlugins",
                    new String[] { "plugins",
                                   "config", }, new HTMLNode[] { HTMLNode.link("/plugins/"),
        ...
        itemNode.addChild("span", "class", "configshortdesc", o.getLocalisedShortDesc()).addChild("input",
                          new String[] { "type",
                                         "name", "value" }, new String[] { "text",
                                         sc.getPrefix() + ".tempIPAddressHint", o.getValueString() });
        ...
        if (opennetPort <= 0) {
            ...
            textNode.addChild("#",
                              ...
                              + l10n("suggestForwardTwoPorts", new String[] { "port1", "port2" },
                                     new String[] { Integer.toString(darknetPort),
