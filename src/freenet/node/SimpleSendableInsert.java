...
public class SimpleSendableInsert extends SendableInsert {
  ...
  public SimpleSendableInsert(NodeClientCore core, KeyBlock block, short prioClass) {
    ...
    if (block instanceof CHKBlock) scheduler = core.requestStarters.chkPutSchedulerBulk;
    else if (block instanceof SSKBlock) scheduler = core.requestStarters.sskPutSchedulerBulk;
