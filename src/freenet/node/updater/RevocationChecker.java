...
public class RevocationChecker implements ClientGetCallback, RequestClient {
            ...
            synchronized (this) {
                ...
                if ((revocationGetter != null) &&!(revocationGetter.isCancelled() || revocationGetter.isFinished())) {
                    ...
                    if ((revocationGetter != null) && logMINOR) {
                        Logger.minor(this,
                                     "revocation fetcher: cancelled=" + revocationGetter.isCancelled() + ", finished="
                    ...
                    cg = revocationGetter = new ClientGetter(this, manager.getRevocationURI(), ctxRevocation,
                            ...
                            : RequestStarter.IMMEDIATE_SPLITFILE_PRIORITY_CLASS, this, null,
                                new BinaryBlobWriter(new ArrayBucket()), null);
        ...
        if (e.isFatal()) {
            if (!e.isDefinitelyFatal()) {
                ...
                String message = l10n("revocationFetchFailedMaybeInternalError", new String[] { "detail", "key" },
                                      new String[] { e.toUserFriendlyString(),
    ...
    public RandomAccessThing getBlobThing() {
        ...
        try {
            ...
            Logger.error(
                this,
                "We do not have the blob file for the revocation even though we have successfully downloaded it!", e);
