...
public class MainJarUpdater extends NodeUpdater implements Deployer {
    ...
    private class DependencyJarFetcher implements JarFetcher, ClientGetCallback, RequestClient, ClientEventListener {
        ...
        DependencyJarFetcher(File filename, FreenetURI chk, long expectedLength, byte[] expectedHash,
                             JarFetcherCallback cb, boolean essential, boolean executable)
                throws FetchException {
            ...
            getter = new ClientGetter(this, chk, myCtx, RequestStarter.IMMEDIATE_SPLITFILE_PRIORITY_CLASS, this,
        ...
        public void onSuccess(FetchResult result, ClientGetter state, ObjectContainer container) {
            ...
            if (!MainJarDependenciesChecker.validFile(tempFile, expectedHash, expectedLength, executable)) {
                ...
                if (cb != null) {
                    cb.onFailure(new FetchException(FetchException.BUCKET_ERROR,
