...
public class MainJarUpdater extends NodeUpdater implements Deployer {
  ...
  public void cleanupDependencies() {
    ...
    if (is == null) {
      System.err.println(
          "Can't find dependencies file. Other nodes will not be able to use Update Over Mandatory"
              + " through this one.");
      return;
    }
    ...
    try {
      ...
      System.err.println(
          "Can't read dependencies file. Other nodes will not be able to use Update Over Mandatory"
              + " through this one.");
      return;
    } finally {
      Closer.close(is);
