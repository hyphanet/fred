...
public class SeedServerPeerNode extends PeerNode {
	...
	public SeedServerPeerNode(SimpleFieldSet fs, ProtectedNode node2, NodeCrypto crypto, boolean fromLocal) throws FSParseException, PeerParseException, ReferenceSignatureVerificationException, PeerTooOldException {
