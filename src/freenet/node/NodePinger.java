...
public class NodePinger implements Runnable {
	...
	final CapacityChecker capacityInputRealtime = new CapacityChecker(
		true,
		true
	);
	final CapacityChecker capacityInputBulk = new CapacityChecker(true, false);
	final CapacityChecker capacityOutputRealtime = new CapacityChecker(
		false,
		true
	);
	final CapacityChecker capacityOutputBulk = new CapacityChecker(
		false,
		false
	);
	...
	class CapacityChecker {
		...
		void calculate(PeerNode[] peers) {
			...
			for (PeerNode peer : peers) {
				PeerLoadStats stats = peer
					.outputLoadTracker(isRealtime)
