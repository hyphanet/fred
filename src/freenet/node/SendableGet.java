...
public abstract class SendableGet extends BaseSendableGet {
    ...
    public abstract void onFailure(LowLevelGetException e, Object token, ObjectContainer container,
     ...
     */
    @Override
    public void internalError(final Throwable t, final RequestScheduler sched, ObjectContainer container,
    ...
    public void unregister(ObjectContainer container, ClientContext context, short oldPrio) {
        ...
        context.checker.removeRequest(this, persistent, container, context,
                                      (oldPrio == -1) ? getPriorityClass(container) : oldPrio);
    }
}
