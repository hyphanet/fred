...
public class SSKInsertSender extends BaseSender implements PrioRunnable, AnyInsertSender, ByteCounter {
    ...
    private enum DO { FINISHED, WAIT, NEXT_PEER }
    ...
    void start() {
        node.executor.execute(this,
                              "SSKInsertSender for UID " + uid + " on " + node.getDarknetPortNumber() + " at "
            ...
            node.usm.addAsyncFilter(mf, new SlowAsyncMessageFilterCallback() {
                ...
                public void onMatched(Message m) {
                    if ((m.getSpec() == DMT.FNPRejectedLoop) || (m.getSpec() == DMT.FNPRejectedOverload)) {
                        ...
                        if (logMINOR) {
                            Logger.minor(this,
                                         "Accepted after timeout on " + SSKInsertSender.this
    ...
    private void finish(int code, PeerNode next) {
        if (logMINOR) {
            Logger.minor(this,
                         "Finished: " + getStatusString(code) + " on " + this + " from "
