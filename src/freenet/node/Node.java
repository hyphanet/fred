...
public class Node implements TimeSkewDetectorCallback {
    public class MigrateOldStoreData implements Runnable {
        ...
        public void run() {
            ...
            System.err.println("Finished migrating old "
                               + (clientCache ? "client cache" : "datastore"));
        }
    }
    ...
    private class ClientCacheTypeCallback extends StringCallback
            ...
            synchronized (this) {    // Serialise this part.
                ...
                if (val.equals("salt-hash")) {
                    ...
                    if (key == null) {
                        ...
                        try {
                            if (securityLevels.physicalThreatLevel
                            ...
                            throw new InvalidConfigValueException(
                                "Master keys file corrupted (too " + e1.sizeToString() + ")");
                        } catch (IOException e1) {
                            throw new InvalidConfigValueException(
                                "Master keys file cannot be accessed: " + e1);
                        }
                    }
    ...
    public static final int RANDOMIZED_TIME_BETWEEN_BURSTING_HANDSHAKE_BURSTS = HANDSHAKE_TIMEOUT
                                                                                * 36;
    ...
    private InvalidConfigValueException lowBandwidthLimit(int limit) {
        return new InvalidConfigValueException(l10n("bandwidthMinimum", new String[] { "limit",
                "minimum" }, new String[] { Integer.toString(limit),
                Integer.toString(minimumBandwidth) }));
    }
     ...
     */
    public void startProbe(final byte htl, final long uid, final Type type,
    ...
    Node(PersistentConfig config, RandomSource r, RandomSource weakRandom, LoggingConfigHandler lc,
        ...
        this.userDir = setupProgramDir(installConfig, "userDir", ".", "Node.userDir",
        ...
        this.pluginDir = setupProgramDir(installConfig, "pluginDir",
                userDir().file("plugins").toString(), "Node.pluginDir", "Node.pluginDirLong",
                nodeConfig);

        // l10n stuffs
        nodeConfig.register("l10n", Locale.getDefault().getLanguage().toLowerCase(), sortOrder++,
                            false, true, "Node.l10nLanguage", "Node.l10nLanguageLong",
                            new L10nCallback());
        ...
        nodeConfig.register("autoChangeDatabaseEncryption", true, sortOrder++, true, false,
                            "Node.autoChangeDatabaseEncryption",
                            "Node.autoChangeDatabaseEncryptionLong", new BooleanCallback() {
            @Override
            public Boolean get() {
                synchronized (Node.this) {
        ...
        nodeConfig.register("masterKeyFile", "master.keys", sortOrder++, true, true,
        ...
        shutdownHook.addEarlyJob(new NativeThread("Shutdown database", NativeThread.HIGH_PRIORITY,
                true) {
            @Override
            public void realRun() {
        ...
        shutdownHook.addLateJob(new NativeThread("Close database", NativeThread.HIGH_PRIORITY,
                true) {
            @Override
            public void realRun() {
                if (db == null) {
        ...
        nodeConfig.register("defragDatabaseOnStartup", false, sortOrder++, false, true,
                            "Node.defragDatabaseOnStartup", "Node.defragDatabaseOnStartupLong",
                            new BooleanCallback() {
            @Override
            public Boolean get() {
                synchronized (Node.this) {
        ...
        nodeConfig.register("defragOnce", false, sortOrder++, false, true, "Node.defragOnce",
                            "Node.defragOnceLong", new BooleanCallback() {
            @Override
            public Boolean get() {
                synchronized (Node.this) {
                    return defragOnce;
        ...
        nodeConfig.register("showFriendsVisibilityAlert", false, sortOrder++, true, false,
                            ...
                            "Node.showFriendsVisibilityAlertLong", new BooleanCallback() {
            @Override
            public Boolean get() {
                synchronized (Node.this) {
        ...
        boolean dontCreate = ( !dbFile.exists()) && ( !dbFileCrypt.exists())
                             && ( !toadlets.fproxyHasCompletedWizard());
        ...
        if ( !dontCreate) {
            try {
                ...
                System.err.println("Unable to decrypt database: master.keys file too "
                                   + e2.sizeToString() + "!");
        ...
        nodeConfig.register("disableProbabilisticHTLs", false, sortOrder++, true, false,
                            "Node.disablePHTLS", "Node.disablePHTLSLong", new BooleanCallback() {
            @Override
            public Boolean get() {
        ...
        nodeConfig.register("enableULPRDataPropagation", true, sortOrder++, true, false,
                            "Node.enableULPRDataPropagation", "Node.enableULPRDataPropagationLong",
                            new BooleanCallback() {
            @Override
            public Boolean get() {
        ...
        nodeConfig.register("enableSwapping", true, sortOrder++, true, false,
                            "Node.enableSwapping", "Node.enableSwappingLong",
                            new BooleanCallback() {
            @Override
            public Boolean get() {
        ...
        nodeConfig.register("publishOurPeersLocation", true, sortOrder++, true, false,
                            "Node.publishOurPeersLocation", "Node.publishOurPeersLocationLong",
                            new BooleanCallback() {
            @Override
            public Boolean get() {
        ...
        nodeConfig.register("enableSwapQueueing", true, sortOrder++, true, false,
                            "Node.enableSwapQueueing", "Node.enableSwapQueueingLong",
                            new BooleanCallback() {
            @Override
            public Boolean get() {
        ...
        nodeConfig.register("enablePacketCoalescing", true, sortOrder++, true, false,
                            "Node.enablePacketCoalescing", "Node.enablePacketCoalescingLong",
                            new BooleanCallback() {
            @Override
            public Boolean get() {
        ...
        nodeConfig.register("outputBandwidthLimit", "15K", sortOrder++, false, true,
                            "Node.outBWLimit", "Node.outBWLimitLong", new IntCallback() {
            @Override
            public Integer get() {
            ...
            public void set(Integer obwLimit) throws InvalidConfigValueException {
                ...
                try {
                    outputThrottle.changeNanosAndBucketSize(SECONDS.toNanos(1) / obwLimit,
                            obwLimit / 2);
        ...
        try {
            outputThrottle = new TokenBucket(bucketSize, SECONDS.toNanos(1) / obwLimit,
                    obwLimit / 2);
        } catch (IllegalArgumentException e) {
            throw new NodeInitException(NodeInitException.EXIT_BAD_BWLIMIT, e.getMessage());
        }
        ...
        nodeConfig.register("inputBandwidthLimit", "-1", sortOrder++, false, true,
                            "Node.inBWLimit", "Node.inBWLimitLong", new IntCallback() {
            @Override
            public Integer get() {
        ...
        nodeConfig.register("throttleLocalTraffic", false, sortOrder++, true, false,
                            "Node.throttleLocalTraffic", "Node.throttleLocalTrafficLong",
                            new BooleanCallback() {
            @Override
            public Boolean get() {
        ...
        nodeStats    = new NodeStats(this, sortOrder, new SubConfig("node.load", config), obwLimit,
                                     ibwLimit, lastVersion);

        // clientCore needs new load management and other settings from stats.
        clientCore = new NodeClientCore(this, config, nodeConfig, installConfig,
                getDarknetPortNumber(), sortOrder, oldConfig, fproxyConfig, toadlets, nodeDBHandle,
                db);
        ...
        opennetConfig.register("maxOpennetPeers", OpennetManager.MAX_PEERS_FOR_SCALING, 1, true,
                               false, "Node.maxOpennetPeers", "Node.maxOpennetPeersLong",
                               new IntCallback() {
            @Override
            public Integer get() {
            ...
            public void set(Integer inputMaxOpennetPeers) throws InvalidConfigValueException {
                ...
                if (inputMaxOpennetPeers > OpennetManager.MAX_PEERS_FOR_SCALING) {
                    throw new InvalidConfigValueException(l10n("maxOpennetPeersMustBeTwentyOrLess",
        ...
        if (maxOpennetPeers > OpennetManager.MAX_PEERS_FOR_SCALING) {
            Logger.error(this,
                         "maxOpennetPeers may not be over " + OpennetManager.MAX_PEERS_FOR_SCALING);
                        ...
                        if (opennet == null) {
                            try {
                                ...
                                clientCore.alerts.register(new SimpleUserAlert(false,
                                        ...
                                        l10n("enableOpennetFailed", "message",
                                             e.getLocalizedMessage()), l10n("enableOpennetFailed",
                                                 "message",
        ...
        opennetConfig.register("acceptSeedConnections", false, 2, true, true,
                               "Node.acceptSeedConnectionsShort", "Node.acceptSeedConnections",
                               new BooleanCallback() {
            @Override
            public Boolean get() {
        ...
        nodeConfig.register("passOpennetPeersThroughDarknet", true, sortOrder++, true, false,
                            ...
                            "Node.passOpennetPeersThroughDarknetLong", new BooleanCallback() {
            @Override
            public Boolean get() {
                synchronized (Node.this) {
        ...
        // Name
        nodeConfig.register("name", myName, sortOrder++, false, true, "Node.nodeName",
                            "Node.nodeNameLong", new NodeNameCallback());
        myName = nodeConfig.getString("name");

        // Datastore
        nodeConfig.register("storeForceBigShrinks", false, sortOrder++, true, false,
                            "Node.forceBigShrink", "Node.forceBigShrinkLong",
                            new BooleanCallback() {
            @Override
            public Boolean get() {
                synchronized (Node.this) {
         ...
         */
        nodeConfig.register("storeSize", "10M", sortOrder++, false, true, "Node.storeSize",
        ...
        if ((maxTotalDatastoreSize < 0)
                || ((maxTotalDatastoreSize < (32 * 1024 * 1024)) && !storeType.equals("ram"))) {    // totally arbitrary minimum!
        ...
        nodeConfig.register("storeUseSlotFilters", true, sortOrder++, true, false,
                            "Node.storeUseSlotFilters", "Node.storeUseSlotFiltersLong",
                            new BooleanCallback() {
            public Boolean get() {
                synchronized (Node.this) {
        ...
        nodeConfig.register("storeSaltHashSlotFilterPersistenceTime",
                            ResizablePersistentIntBuffer.DEFAULT_PERSISTENCE_TIME, sortOrder++,
                            true, false, "Node.storeSaltHashSlotFilterPersistenceTime",
                            "Node.storeSaltHashSlotFilterPersistenceTimeLong", new IntCallback() {
            @Override
            public Integer get() {
        ...
        this.storeDir              = setupProgramDir(installConfig, "storeDir",
                userDir().file("datastore").getPath(), "Node.storeDirectory",
                "Node.storeDirectoryLong", nodeConfig);
         ...
         */
        nodeConfig.register("storePreallocate", true, sortOrder++, true, true,
                            "Node.storePreallocate", "Node.storePreallocateLong",
                            new BooleanCallback() {
            @Override
            public Boolean get() {
                    ...
                    try {
                        ...
                        System.err.println(
                            NodeL10n.getBase().getString(
                                "SecurityLevels.cantDeletePasswordFile", "filename",
                                masterKeysFile.getAbsolutePath()));
                        clientCore.alerts
                            .register(new SimpleUserAlert(true, NodeL10n.getBase()
                                .getString("SecurityLevels.cantDeletePasswordFileTitle"), NodeL10n
                                .getBase()
                                .getString("SecurityLevels.cantDeletePasswordFile"), NodeL10n
                                .getBase()
        ...
        nodeConfig.register("cachingFreenetStoreMaxSize", defaultCacheSize, sortOrder++, true,
                            false, "Node.cachingFreenetStoreMaxSize",
                            "Node.cachingFreenetStoreMaxSizeLong", new LongCallback() {
            @Override
            public Long get() {
                synchronized (Node.this) {
            ...
            public void set(Long val) throws InvalidConfigValueException, NodeNeedRestartException {
                ...
                throw new NodeNeedRestartException(
                    "Caching Maximum Size cannot be changed on the fly");
            }
        }, true);
        ...
        if (storeType.equals("salt-hash")) {
            ...
            if ((lastVersion > 0) && (lastVersion <= lastVersionWithBloom)) {
                ...
                int  extraMemoryMB = (int) Math.min(Integer.MAX_VALUE,
                                         ((extraMemory + 1024 * 1024 - 1) / (1024 * 1024)));

                if (extraMemoryMB >= 10) {
                    System.out.println("Need " + extraMemoryMB
                                       + "MB extra space in heap for slot filters.");

                    UpdateDeployContext.CHANGED changed =
                        UpdateDeployContext.tryIncreaseMemoryLimit(extraMemoryMB,
                            " Increased because of slot filters in " + (lastVersionWithBloom + 1));

                    if (changed == CHANGED.SUCCESS) {
                        WrapperManager.restart();
                        System.err.println(
                            "Unable to restart after increasing memory limit for the slot filters (the total memory usage is decreased relative to bloom filters but the heap size needs to grow). Probably due to not running in the wrapper.");
                        System.err.println(
                            "If the node crashes due to out of memory, be it on your own head!");
                        System.err.println("You need to increase wrapper.java.maxmemory by "
                                           + extraMemoryMB);
                    } else if (changed == CHANGED.FAIL) {
                        System.err.println(
                            "Unable to increase the memory limit for the slot filters (the total memory usage is decreased relative to bloom filters but the heap size needs to grow). Most likely due to being unable to write wrapper.conf or similar problem.");
                        System.err.println(
                            "If the node crashes due to out of memory, be it on your own head!");
                        System.err.println("You need to increase wrapper.java.maxmemory by "
                                           + extraMemoryMB);
                        ...
                        System.err.println(
                            "Memory limit has already been increased for slot filters, continuing startup.");
                    }
                }
            }
        ...
        if (notEnoughSpaceForAutoCrypt) {
            createAutoCryptFailedUserAlert();
        }

        // Client cache
        // Default is 10MB, in memory only. The wizard will change this.
        nodeConfig.register("clientCacheType", "ram", sortOrder++, true, true,
                            "Node.clientCacheType", "Node.clientCacheTypeLong",
                            new ClientCacheTypeCallback());
        clientCacheType = nodeConfig.getString("clientCacheType");
        nodeConfig.register("clientCacheSize", "10M", sortOrder++, false, true,
        ...
        for (int i = 0; (i < 2) && !startedClientCache; i++) {
            if (clientCacheType.equals("salt-hash")) {
                ...
                try {
                    ...
                    System.err.println(
                        "Impossible: master keys file " + masterKeysFile + " too "
                        + e.sizeToString()
        ...
        nodeConfig.register("useSlashdotCache", true, sortOrder++, true, false,
                            "Node.useSlashdotCache", "Node.useSlashdotCacheLong",
                            new BooleanCallback() {
            @Override
            public Boolean get() {
        ...
        nodeConfig.register("writeLocalToDatastore", false, sortOrder++, true, false,
                            "Node.writeLocalToDatastore", "Node.writeLocalToDatastoreLong",
                            new BooleanCallback() {
            @Override
            public Boolean get() {
        ...
        nodeConfig.register("slashdotCacheLifetime", MINUTES.toMillis(30), sortOrder++, true,
                            false, "Node.slashdotCacheLifetime", "Node.slashdotCacheLifetimeLong",
                            new LongCallback() {
            @Override
            public Long get() {
        ...
        nodeConfig.register("slashdotCacheSize", "10M", sortOrder++, false, true,
        ...
        maxSlashdotCacheKeys  = (int) Math.min(maxSlashdotCacheSize / sizePerKey,
                Integer.MAX_VALUE);
        ...
        nodeConfig.register("skipWrapperWarning", false, sortOrder++, true, false,
                            "Node.skipWrapperWarning", "Node.skipWrapperWarningLong",
                            new BooleanCallback() {
            @Override
        ...
        nodeConfig.register("enableRoutedPing", false, sortOrder++, true, false,
                            "Node.enableRoutedPing", "Node.enableRoutedPingLong",
                            new BooleanCallback() {
            @Override
            public Boolean get() {
                synchronized (Node.this) {
        ...
        shutdownHook.addEarlyJob(new NativeThread("Shutdown plugins", NativeThread.HIGH_PRIORITY,
                true) {
            @Override
            public void realRun() {
        ...
        for (File f : list) {
            ...
            if (f.isFile()
                    && name.toLowerCase().matches(
                        "((chk)|(ssk)|(pubkey))-[0-9]*\\.((store)|(cache))(\\.((keys)|(lru)))?")) {
            ...
            if (FileUtil.renameTo(tmpFile, certs)) {
                ...
                if (certs.length() != tmpFile.length()) {
                    ...
                    if (tmpFile.renameTo(manual)) {
                        System.err.println("Please delete " + certs + " and rename " + manual
                                           + " over it");
                    } else {
                        tmpFile.delete();
                    }
     ...
     * parameters.
     */
    public ProgramDirectory setupProgramDir(SubConfig installConfig, String cfgKey,
            String defaultValue, String shortdesc, String longdesc, String moveErrMsg,
            SubConfig oldConfig)
            throws NodeInitException {
    ...
    protected ProgramDirectory setupProgramDir(SubConfig installConfig, String cfgKey,
            String defaultValue, String shortdesc, String longdesc, SubConfig oldConfig)
            throws NodeInitException {
    ...
    private static class DB4ODiagnosticListener implements DiagnosticListener {
        ...
        public void onDiagnostic(Diagnostic arg0) {
            ...
            if (arg0 instanceof DiagnosticBase) {
                ...
                Logger.debug(this,
                             "Diagnostic: " + d.getClass() + " : " + d.problem() + " : "
                             + d.solution() + " : " + d.reason(), new Exception("debug"));
            } else {
                Logger.debug(this, "Diagnostic: " + arg0 + " : " + arg0.getClass(),
                             new Exception("debug"));
            }
        }
    }
    ...
    private Configuration getNewDatabaseConfiguration(DatabaseKey databaseKey) {
        ...
        dbConfig.objectClass(freenet.client.async.PersistentCooldownQueueItem.class).objectField(
            "key").indexed(true);
        dbConfig.objectClass(freenet.client.async.PersistentCooldownQueueItem.class).objectField(
            "keyAsBytes").indexed(true);
        dbConfig.objectClass(freenet.client.async.PersistentCooldownQueueItem.class).objectField(
            "time").indexed(true);
        dbConfig.objectClass(freenet.client.async.RegisterMe.class).objectField("core").indexed(
            true);
        dbConfig.objectClass(freenet.client.async.RegisterMe.class).objectField("priority").indexed(
            true);
        dbConfig.objectClass(freenet.client.async.PersistentCooldownQueueItem.class).objectField(
            "time").indexed(true);
        ...
        dbConfig.objectClass(freenet.client.async.InsertCompressor.class).objectField(
            "nodeDBHandle").indexed(true);
        dbConfig.objectClass(freenet.node.fcp.FCPClient.class).objectField("name").indexed(true);
        dbConfig.objectClass(freenet.client.async.DatastoreCheckerItem.class).objectField(
            "prio").indexed(true);
        dbConfig.objectClass(freenet.client.async.DatastoreCheckerItem.class).objectField(
            "getter").indexed(true);
        dbConfig.objectClass(freenet.support.io.PersistentBlobTempBucketTag.class).objectField(
            "index").indexed(true);
        dbConfig.objectClass(freenet.support.io.PersistentBlobTempBucketTag.class).objectField(
            "bucket").indexed(true);
        dbConfig.objectClass(freenet.support.io.PersistentBlobTempBucketTag.class).objectField(
...
//      dbConfig.queries().evaluationMode(QueryEvaluationMode.LAZY);
    ...
    private void setupDatabase(DatabaseKey databaseKey)
            throws MasterKeysWrongPasswordException, MasterKeysFileSizeException, IOException {
        ...
        if (dbFileBackup.exists() && !dbFile.exists()) {
            if ( !dbFileBackup.renameTo(dbFile)) {
                throw new IOException("Database backup file " + dbFileBackup
                                      + " exists but cannot be renamed to " + dbFile
                                      + ". Not loading database, please fix permissions problems!");
            }
        }

        if (dbFileCryptBackup.exists() && !dbFileCrypt.exists()) {
            if ( !dbFileCryptBackup.renameTo(dbFileCrypt)) {
                throw new IOException("Database backup file " + dbFileCryptBackup
                                      + " exists but cannot be renamed to " + dbFileCrypt
                                      + ". Not loading database, please fix permissions problems!");
            }
        }
            ...
            if (securityLevels.getPhysicalThreatLevel() == PHYSICAL_THREAT_LEVEL.MAXIMUM) {
                ...
                synchronized (this) {
                    databaseEncrypted = false;
                       ...
                       && (securityLevels.getPhysicalThreatLevel() == PHYSICAL_THREAT_LEVEL.LOW)
                       && autoChangeDatabaseEncryption
                       && enoughSpaceForAutoChangeEncryption(dbFileCrypt, false)) {
                ...
                if (databaseKey == null) {
                    ...
                    try {
                        ...
                        System.err.println(
                            "Unable to decrypt the node.db4o. Please enter the correct password and set the physical security level to LOW via the GUI.");
                ...
                WrapperManager.signalStarting((int) Math.min(DAYS.toMillis(1),
                        MINUTES.toMillis(5) + length));
                ...
                if (FileUtil.renameTo(tempFile, dbFile)) {
                    ...
                    database = openCryptDatabase(databaseKey);
                       ...
                       && (securityLevels.getPhysicalThreatLevel() != PHYSICAL_THREAT_LEVEL.LOW)
                       && autoChangeDatabaseEncryption
                       && enoughSpaceForAutoChangeEncryption(dbFile, true)) {
                ...
                if (FileUtil.renameTo(tempFile, dbFileCrypt)) {
                    ...
                    throw new IOException(
                        "Unable to encrypt the old node.db4o.crypt because cannot rename database file");
                }
            } else if ((dbFileCrypt.exists() && !dbFile.exists())
                       || (securityLevels.getPhysicalThreatLevel() == PHYSICAL_THREAT_LEVEL.NORMAL)
                       || ((securityLevels.getPhysicalThreatLevel() == PHYSICAL_THREAT_LEVEL.HIGH)
                           && (databaseKey != null))) {
        ...
        if (logDEBUG && (database != null)) {
            try {
                ...
                for (Object o : contents) {
                    ...
                    try {
                        Logger.minor(this,
                                     "DATABASE: " + o.getClass() + ":" + o + ":"
                                     + database.ext().getID(o));
                    } catch (Throwable t) {
                ...
                ObjectSet<SplitFileInserterSegment> segments =
                    database.query(SplitFileInserterSegment.class);
                ...
                for (SplitFileInserterSegment seg : segments) {
                    try {
                        ...
                        System.out.println("Segment " + seg + " finished=" + finished
                                           + " cancelled=" + cancelled + " empty=" + empty
                                           + " encoded=" + encoded + " size="
                                           + seg.countDataBlocks() + " data "
                                           + seg.countCheckBlocks() + " check started=" + started);
                ...
                System.err.println(
                    "Unable to dump database contents. Treating as corrupt database.");
                e.printStackTrace();
    ...
    private boolean enoughSpaceForAutoChangeEncryption(File file, boolean isCrypt) {
        ...
        if (freeSpace < minSpace) {
            System.err.println(l10n(isCrypt
                                    ? "notEnoughSpaceToAutoEncrypt"
                                    : "notEnoughSpaceToAutoDecrypt", new String[] { "size",
                    "file" }, new String[] { SizeUtil.formatSize(minSpace),
    ...
    private ObjectContainer openCryptDatabase(DatabaseKey databaseKey) throws IOException {
        ...
        ObjectContainer database = Db4o.openFile(getNewDatabaseConfiguration(databaseKey),
                                       dbFileCrypt.toString());
    ...
    private void maybeDefragmentDatabase(File databaseFile, final DatabaseKey databaseKey)
            throws IOException {
        synchronized (this) {
            if ( !defragDatabaseOnStartup) {
                return;
            }
        }
        ...
        DefragmentConfig config = new DefragmentConfig(databaseFile.getPath(),
                                      backupFile.getPath(), new BTreeIDMapping(tmpFile.getPath()));
        ...
        try {
            ...
            if (backupFile.exists()) {
                ...
                if ( !backupFile.renameTo(databaseFile)) {
                    System.err.println(
                        "Unable to rename backup file back to database file! Restarting on the assumption that it didn't get closed...");
                    WrapperManager.restart();
        ...
        if (newSize <= 0) {
            System.err.println(
                "DEFRAG PRODUCED AN EMPTY FILE! Trying to restore old database file...");
            databaseFile.delete();

            if ( !tmpFile.renameTo(databaseFile)) {
                System.err.println("Unable to restore old database file but it should be in "
                                   + tmpFile);

                throw new IOException(
                    "Defrag produced an empty file; Unable to restore old database file but it should be in "
                    + tmpFile);
            }
        } else {
            ...
            FileUtil.secureDelete(tmpFile);
            FileUtil.secureDelete(backupFile);
            System.err.println("Defragment completed. " + SizeUtil.formatSize(oldSize) + " ("
                               + oldSize + ") -> " + SizeUtil.formatSize(newSize) + " (" + newSize
                               + ") (" + (int) change + "% shrink)");
        }
    ...
    private final UserAlert masterPasswordUserAlert = new UserAlert() {
        ...
        public HTMLNode getHTMLText() {
            ...
            SecurityLevelsToadlet.generatePasswordFormPage(false, clientCore.getToadletContainer(),
                    content, false, false, false, null, null);
    ...
    private void createAutoCryptFailedUserAlert() {
        ...
        if (notEnoughSpaceRenameFailed) {
            title = isCrypt
                    ? l10n("failedToRenameEncryptingTitle") : l10n("failedToRenameDecryptingTitle");
            text = l10n((isCrypt ? "failedToRenameEncrypting" : "failedToRenameDecrypting"),
                        new String[] { "fromfile",
                                       "tofile" }, new String[] {
                                       renameFailedFrom.getAbsolutePath(),
                                       renameFailedTo.getAbsolutePath() });
        } else {
            title = isCrypt
                    ? l10n("notEnoughSpaceToAutoEncryptTitle")
                    : l10n("notEnoughSpaceToAutoDecryptTitle");
            text = l10n((isCrypt ? "notEnoughSpaceToAutoEncrypt" : "notEnoughSpaceToAutoDecrypt"),
                        new String[] { "size",
                                       "file" }, new String[] {
                                       SizeUtil.formatSize(notEnoughSpaceMinimumSpace),
                                       dbFile.getAbsolutePath() });
        }

        this.clientCore.alerts.register(new SimpleUserAlert(true, title, text, title,
                ( !isCrypt) && (this.db != null) ? UserAlert.WARNING : UserAlert.ERROR));
    }

    private void initRAMClientCacheFS() {
        chkClientcache = new CHKStore();
        new RAMFreenetStore<CHKBlock>(chkClientcache,
                            (int) Math.min(Integer.MAX_VALUE, maxClientCacheKeys));
        pubKeyClientcache = new PubkeyStore();
        new RAMFreenetStore<DSAPublicKey>(pubKeyClientcache,
                            (int) Math.min(Integer.MAX_VALUE, maxClientCacheKeys));
        sskClientcache = new SSKStore(getPubKey);
        new RAMFreenetStore<SSKBlock>(sskClientcache,
                            (int) Math.min(Integer.MAX_VALUE, maxClientCacheKeys));
    }
    ...
    private void initRAMFS() {
        ...
        new RAMFreenetStore<CHKBlock>(chkDatastore,
                            (int) Math.min(Integer.MAX_VALUE, maxStoreKeys));
        chkDatacache = new CHKStore();
        new RAMFreenetStore<CHKBlock>(chkDatacache,
                            (int) Math.min(Integer.MAX_VALUE, maxCacheKeys));
        pubKeyDatastore = new PubkeyStore();
        new RAMFreenetStore<DSAPublicKey>(pubKeyDatastore,
                            (int) Math.min(Integer.MAX_VALUE, maxStoreKeys));
        pubKeyDatacache = new PubkeyStore();
        getPubKey.setDataStore(pubKeyDatastore, pubKeyDatacache);
        new RAMFreenetStore<DSAPublicKey>(pubKeyDatacache,
                            (int) Math.min(Integer.MAX_VALUE, maxCacheKeys));
        sskDatastore = new SSKStore(getPubKey);
        new RAMFreenetStore<SSKBlock>(sskDatastore,
                            (int) Math.min(Integer.MAX_VALUE, maxStoreKeys));
        sskDatacache = new SSKStore(getPubKey);
        new RAMFreenetStore<SSKBlock>(sskDatacache,
                            (int) Math.min(Integer.MAX_VALUE, maxCacheKeys));
    }
    ...
    private void initSaltHashFS(final String suffix, boolean dontResizeOnStart, byte[] masterKey)
        ...
        try {
            ...
            final FreenetStore<CHKBlock> chkDataFS    = makeStore("CHK", true, chkDatastore,
                                                            dontResizeOnStart, masterKey);
            final CHKStore               chkDatacache = new CHKStore();
            final FreenetStore<CHKBlock> chkCacheFS   = makeStore("CHK", false, chkDatacache,
                                                            dontResizeOnStart, masterKey);
            ...
            final FreenetStore<DSAPublicKey> pubkeyDataFS    = makeStore("PUBKEY", true,
                                                                   pubKeyDatastore,
                                                                   dontResizeOnStart, masterKey);
            final PubkeyStore                pubKeyDatacache = new PubkeyStore();
            final FreenetStore<DSAPublicKey> pubkeyCacheFS   = makeStore("PUBKEY", false,
                                                                   pubKeyDatacache,
                                                                   dontResizeOnStart, masterKey);
            ...
            final FreenetStore<SSKBlock> sskDataFS    = makeStore("SSK", true, sskDatastore,
                                                            dontResizeOnStart, masterKey);
            final SSKStore               sskDatacache = new SSKStore(getPubKey);
            final FreenetStore<SSKBlock> sskCacheFS   = makeStore("SSK", false, sskDatacache,
                                                            dontResizeOnStart, masterKey);
            ...
            boolean delay = chkDataFS.start(ticker, false) | chkCacheFS.start(ticker, false)
                            ...
                            | pubkeyCacheFS.start(ticker, false) | sskDataFS.start(ticker, false)
    ...
    private void initSaltHashClientCacheFS(final String suffix, boolean dontResizeOnStart,
        ...
        try {
            ...
            final FreenetStore<CHKBlock> chkDataFS      = makeClientcache("CHK", true,
                                                              chkClientcache, dontResizeOnStart,
                                                              clientCacheMasterKey);
            final PubkeyStore                pubKeyClientcache = new PubkeyStore();
            final FreenetStore<DSAPublicKey> pubkeyDataFS      = makeClientcache("PUBKEY", true,
                                                                     pubKeyClientcache,
                                                                     dontResizeOnStart,
                                                                     clientCacheMasterKey);
            final SSKStore               sskClientcache = new SSKStore(getPubKey);
            final FreenetStore<SSKBlock> sskDataFS      = makeClientcache("SSK", true,
                                                              sskClientcache, dontResizeOnStart,
                                                              clientCacheMasterKey);
    ...
    private <T extends StorableBlock> FreenetStore<T> makeClientcache(String type, boolean isStore,
            StoreCallback<T> cb, boolean dontResizeOnStart, byte[] clientCacheMasterKey)
            throws IOException {
        FreenetStore<T> store = makeStore(type, "clientcache", maxClientCacheKeys, cb,
    ...
    private <T extends StorableBlock> FreenetStore<T> makeStore(String type, String store,
            long maxKeys, StoreCallback<T> cb, boolean lateStart, byte[] clientCacheMasterKey)
            throws IOException {
        Logger.normal(this, "Initializing " + type + " Data" + store);
        System.out.println("Initializing " + type + " Data" + store + " (" + maxStoreKeys
                           + " keys)");

        SaltedHashFreenetStore<T> fs = SaltedHashFreenetStore.<T>construct(getStoreDir(),
                                           type + "-" + store, cb, random, maxKeys,
                                           storeUseSlotFilters, shutdownHook, storePreallocate,
                                           storeSaltHashResizeOnStart && !lateStart,
                                           lateStart ? ticker : null, clientCacheMasterKey);

        cb.setStore(fs);

        if (cachingFreenetStoreMaxSize > 0) {
            return new CachingFreenetStore<T>(cb, cachingFreenetStoreMaxSize,
                    cachingFreenetStorePeriod, fs, ticker);
        } else {
            return fs;
        }
    }
    ...
    public void start(boolean noSwaps) throws NodeInitException {
        ...
        peers.tryReadPeers(nodeDir.file("peers-" + getDarknetPortNumber()).getPath(),
                           darknetCrypto, null, false, false);
        ...
        Logger.normal(this,
                      "Freenet 0.7.5 Build #" + Version.buildNumber() + " r"
                      + Version.cvsRevision());
        System.out.println("Freenet 0.7.5 Build #" + Version.buildNumber() + " r"
                           + Version.cvsRevision());
        Logger.normal(this,
...
//      pluginManager3 = new freenet.plugin_new.PluginManager(pluginManagerConfig);
    ...
    private void checkForEvilJVMBugs() {
        ...
        if (logMINOR) {
            Logger.minor(this,
                         "JVM vendor: " + jvmVendor + ", JVM name: " + jvmName + ", JVM version: "
                         + javaVersion + ", OS name: " + osName + ", OS version: " + osVersion);
        }
        ...
        if (( !isOpenJDK) && (jvmVendor.startsWith("Sun ") || jvmVendor.startsWith(
                "Oracle ")) || (jvmVendor.startsWith(
                "The FreeBSD Foundation") && (jvmSpecVendor.startsWith(
                    "Sun ") || jvmSpecVendor.startsWith("Oracle "))) || (jvmVendor.startsWith(
                        "Apple "))) {
            ...
            if (is150 || is160) {
                ...
                Logger.minor(this,
                             "JVM version: " + javaVersion + " subver: " + subver + " from "
                             + secondPart);
            }
            ...
            if (jvmVendor.startsWith("Free Software Foundation")) {
                ...
                clientCore.alerts.register(new SimpleUserAlert(true, l10n("usingGCJTitle"),
                        l10n("usingGCJ"), l10n("usingGCJTitle"), UserAlert.WARNING));
            }
        }
...
//      }
    ...
    private KeyBlock makeRequestLocal(Key key, long uid, boolean canReadClientCache,
        ...
        if (key instanceof NodeCHK) {
            kb = fetch(key, false, canReadClientCache, canWriteClientCache, canWriteDatastore,
                       null);
            ...
            if (pubKey != null) {
                ...
                kb = fetch(sskKey, canReadClientCache, canWriteClientCache, canWriteDatastore,
                           false, null);
            } else {
                if (logMINOR) {
    ...
    public Object makeRequestSender(Key key, short htl, long uid, RequestTag tag, PeerNode source,
        ...
        if (logMINOR) {
            Logger.minor(this,
                         "makeRequestSender(" + key + ',' + htl + ',' + uid + ',' + source
                         + ") on " + getDarknetPortNumber());
        }

        // In store?
        if ( !ignoreStore) {
            KeyBlock kb = makeRequestLocal(key, uid, canReadClientCache, canWriteClientCache,
                              canWriteDatastore, offersOnly);
        ...
        RequestSender sender = (key instanceof NodeCHK)
                               ? tracker.getTransferringRequestSenderByKey((NodeCHK) key,
                                   realTimeFlag) : null;
        ...
        sender = new RequestSender(key, null, htl, uid, tag, this, source, offersOnly,
                                   canWriteClientCache, canWriteDatastore, realTimeFlag);
    ...
    public KeyBlock fetch(Key key, boolean canReadClientCache, boolean canWriteClientCache,
        ...
        if (key instanceof NodeSSK) {
            return fetch((NodeSSK) key, false, canReadClientCache, canWriteClientCache,
                         canWriteDatastore, forULPR, meta);
        } else if (key instanceof NodeCHK) {
            return fetch((NodeCHK) key, false, canReadClientCache, canWriteClientCache,
                         canWriteDatastore, forULPR, meta);
        } else {
    ...
    public SSKBlock fetch(NodeSSK key, boolean dontPromote, boolean canReadClientCache,
                          boolean canWriteClientCache, boolean canWriteDatastore, boolean forULPR,
                          BlockMetadata meta) {
        ...
        if (canReadClientCache) {
            try {
                SSKBlock block = sskClientcache.fetch(key, dontPromote || !canWriteClientCache,
                                     canReadClientCache, forULPR, false, meta);
        ...
        if (forULPR || useSlashdotCache || canReadClientCache) {
            try {
                SSKBlock block = sskSlashdotcache.fetch(key, dontPromote, canReadClientCache,
                                     forULPR, false, meta);
        ...
        try {
            ...
            SSKBlock block = sskDatastore.fetch(key, dontPromote || !canWriteDatastore,
                                 canReadClientCache, forULPR, ignoreOldBlocks, meta);

            if (block == null) {
                SSKStore store = oldSSK;

                if (store != null) {
                    block = store.fetch(key, dontPromote || !canWriteDatastore, canReadClientCache,
    ...
    public CHKBlock fetch(NodeCHK key, boolean dontPromote, boolean canReadClientCache,
        ...
        try {
            ...
            if (block == null) {
                ...
                if (store != null) {
                    block = store.fetch(key, dontPromote || !canWriteDatastore, ignoreOldBlocks,
                                        meta);
                }
            }
            ...
            block = chkDatacache.fetch(key, dontPromote || !canWriteDatastore, ignoreOldBlocks,
                                       meta);
    ...
    public void dumpStoreHits() {
        ...
        Logger.minor(this,
                     ...
                     + chkDatastore.hits() + '/' + (chkDatastore.hits() + chkDatastore.misses())
    ...
    public void storeShallow(CHKBlock block, boolean canWriteClientCache,
     ...
     */
    public void storeShallow(SSKBlock block, boolean canWriteClientCache,
                             boolean canWriteDatastore, boolean fromULPR)
            throws KeyCollisionException {
    ...
    public void store(SSKBlock block, boolean deep, boolean overwrite, boolean canWriteClientCache,
        ...
        try {
            ...
            getPubKey.cacheKey((block.getKey()).getPubKeyHash(), (block.getKey()).getPubKey(),
                               deep, canWriteClientCache, canWriteDatastore,
                               forULPR || useSlashdotCache, writeLocalToDatastore);
    ...
    public CHKInsertSender makeInsertSender(NodeCHK key, short htl, long uid, InsertTag tag,
        ...
        is = new CHKInsertSender(key, uid, tag, headers, htl, source, this, prb, fromStore,
                                 canWriteClientCache, forkOnCacheable, preferInsert,
    ...
    public SSKInsertSender makeInsertSender(SSKBlock block, short htl, long uid, InsertTag tag,
            PeerNode source, boolean fromStore, boolean canWriteClientCache,
            boolean canWriteDatastore, boolean forkOnCacheable, boolean preferInsert,
            boolean ignoreLowBackoff, boolean realTimeFlag) {
        ...
        is = new SSKInsertSender(block, uid, tag, htl, source, this, fromStore,
                                 canWriteClientCache, forkOnCacheable, preferInsert,
                                 ignoreLowBackoff, realTimeFlag);
        is.start();
    ...
    public ClientKeyBlock fetchKey(ClientKey key, boolean canReadClientCache,
        ...
        if (key instanceof ClientCHK) {
            return fetch((ClientCHK) key, canReadClientCache, canWriteClientCache,
                         canWriteDatastore);
        } else if (key instanceof ClientSSK) {
            return fetch((ClientSSK) key, canReadClientCache, canWriteClientCache,
                         canWriteDatastore);
        } else {
    ...
    public ClientKeyBlock fetch(ClientSSK clientSSK, boolean canReadClientCache,
        ...
        // was corrupt.
        getPubKey.cacheKey(clientSSK.pubKeyHash, key, false, canWriteClientCache,
                           canWriteDatastore, false, writeLocalToDatastore);
    ...
    private ClientKeyBlock fetch(ClientCHK clientCHK, boolean canReadClientCache,
        ...
        CHKBlock block = fetch(clientCHK.getNodeCHK(), false, canReadClientCache,
                               canWriteClientCache, canWriteDatastore, false, null);
    ...
    public void receivedNodeToNodeMessage(PeerNode src, int type, ShortBuffer messageData,
        ...
        if (listener == null) {
            Logger.error(this,
                         "Unknown n2nm ID: " + type + " - discarding packet length "
    ...
    private NodeToNodeMessageListener diffNoderefListener = new NodeToNodeMessageListener() {
        ...
        public void handleMessage(byte[] data, boolean fromDarknet, PeerNode src, int type) {
            Logger.normal(this,
                          "Received differential node reference node to node message from "
                          + src.getPeer());
     ...
     */
    public void handleNodeToNodeTextMessageSimpleFieldSet(SimpleFieldSet fs,
            DarknetPeerNode source, int fileNumber)
            throws FSParseException {
        if (logMINOR) {
        ...
        if (overallType == Node.N2N_MESSAGE_TYPE_FPROXY) {
            ...
            Logger.error(this,
                         "Received unknown node to node message type '" + overallType + "' from "
                         + source.getPeer());
        }
    }
    ...
    private void handleFproxyNodeToNodeTextMessageSimpleFieldSet(SimpleFieldSet fs,
        ...
        if (type == Node.N2N_TEXT_MESSAGE_TYPE_USERALERT) {
            ...
            Logger.error(this,
                         "Received unknown fproxy node to node message sub-type '" + type
                         + "' from " + source.getPeer());
        }
    }
    ...
    public void connectToSeednode(SeedServerTestPeerNode node)
            throws OpennetDisabledException, FSParseException, PeerParseException,
    ...
    public DarknetPeerNode createNewDarknetNode(SimpleFieldSet fs, FRIEND_TRUST trust,
        ...
        return new DarknetPeerNode(fs, this, darknetCrypto, peers, false,
                                   darknetCrypto.packetMangler, trust, visibility);
    }

    public OpennetPeerNode createNewOpennetNode(SimpleFieldSet fs)
            throws FSParseException, OpennetDisabledException, PeerParseException,
                   ReferenceSignatureVerificationException {
        if (opennet == null) {
    ...
    public Set<ForwardPort> getPublicInterfacePorts() {
        ...
        // FIXME IPv6 support
        set.add(new ForwardPort("darknet", false, ForwardPort.PROTOCOL_UDP_IPV4,
                                darknetCrypto.portNumber));

        if (opennet != null) {
            NodeCrypto crypto = opennet.crypto;

            if (crypto != null) {
                set.add(new ForwardPort("opennet", false, ForwardPort.PROTOCOL_UDP_IPV4,
                                        crypto.portNumber));
            }
        }
    ...
    public void setMasterPassword(String password, boolean inFirstTimeWizard)
            throws AlreadySetPasswordException, MasterKeysWrongPasswordException,
    ...
    private void activatePasswordedClientCache(MasterKeys keys) {
        synchronized (this) {
            ...
            if ( !clientCacheType.equals("salt-hash")) {
                System.err.println("Unknown client cache type, cannot activate passworded store: "
                                   + clientCacheType);
    ...
    public boolean shouldStoreDeep(Key key, PeerNode source, PeerNode[] routedTo) {
        ...
        if ((source != null) && !source.isLowUptime()) {
            if (Location.distance(source, target) < myDist) {
                if (logMINOR) {
                    Logger.minor(this,
                                 "Not storing because source is closer to target for " + key
                                 + " : " + source);
                }
        ...
        for (PeerNode pn : routedTo) {
            if ((Location.distance(pn, target) < myDist) && !pn.isLowUptime()) {
                if (logMINOR) {
                    Logger.minor(this,
                                 "Not storing because peer " + pn + " is closer to target for "
                                 + key + " his loc " + pn.getLocation() + " my loc " + myLoc
                                 + " target is " + target);
                }
                ...
                if (logMINOR) {
                    Logger.minor(this,
                                 "Should store maybe, peer " + pn + " loc = " + pn.getLocation()
                                 + " my loc is " + myLoc + " target is " + target
                                 + " low uptime is " + pn.isLowUptime());
                }
            }
        }
        ...
        if (logMINOR) {
            Logger.minor(this,
                         "Should store returning true for " + key + " target=" + target + " myLoc="
                         + myLoc + " peers: " + routedTo.length);
        }
    ...
    private void checkOutputBandwidthLimit(int obwLimit) throws InvalidConfigValueException {
        if (obwLimit <= 0) {
            throw new InvalidConfigValueException(l10n("bwlimitMustBePositive"));
        }
    ...
    private void checkInputBandwidthLimit(int ibwLimit) throws InvalidConfigValueException {
        ...
        if (ibwLimit <= 1) {
            throw new InvalidConfigValueException(l10n("bandwidthLimitMustBePositiveOrMinusOne"));
        }
