...
//                          }
                    ...
                    if (type == null) {
                        handler.outputHandler.queue(new ProtocolErrorMessage(ProtocolErrorMessage.INVALID_FIELD, false,
                ...
                if (TYPENAME_OFFICIAL.equals(type)) {
                    ...
                    handler.outputHandler.queue(new ProtocolErrorMessage(ProtocolErrorMessage.INTERNAL_ERROR, false,
                ...
                if (pi == null) {
                    handler.outputHandler.queue(new ProtocolErrorMessage(ProtocolErrorMessage.NO_SUCH_PLUGIN, false,
