...
public class FCPPersistentRoot {
    ...
    public static FCPPersistentRoot create(final long nodeDBHandle, RequestStatusCache cache,
    ...
    public FCPClient registerForeverClient(final String name, NodeClientCore core, FCPConnectionHandler handler,
