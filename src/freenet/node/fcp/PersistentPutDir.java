...
public class PersistentPutDir extends FCPMessage {
    ...
    public PersistentPutDir(String identifier, FreenetURI publicURI, FreenetURI privateURI, int verbosity,
                            short priorityClass, short persistenceType, boolean global, String defaultName,
                            ...
                            byte[] splitfileCryptoKey, ObjectContainer container) {
    ...
    private SimpleFieldSet generateFieldSet(ObjectContainer container) {
        ...
        for (int i = 0; i < elements.length; i++) {
            ...
            if (tempURI != null) {
                ...
                if (data == null) {
                    Logger.error(this,
                                 "Bucket already freed: " + e.getData() + " for " + e + " for " + e.getName() + " for "
                                 + identifier);
