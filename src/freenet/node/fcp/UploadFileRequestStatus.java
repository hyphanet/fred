...
public class UploadFileRequestStatus extends UploadRequestStatus {
    ...
    UploadFileRequestStatus(String identifier, short persistence, boolean started, boolean finished, boolean success,
                            ...
                            String failureReasonLong, long dataSize, String mimeType, File origFilename,
