...
public class ClientPutDir extends ClientPutBase {
	...
	public ClientPutDir(FCPConnectionHandler handler, ClientPutDirMessage message, 
		...
		super(message.uri, message.identifier, message.verbosity, handler,
				...
				message.getCHKOnly, message.dontCompress, message.maxRetries, message.earlyEncode, message.canWriteClientCache, message.forkOnCacheable, message.compressorDescriptor, server, container);
		logMINOR = Logger.shouldLog(Logger.MINOR, this);
...
//		this.manifestElements.putAll(manifestElements);
	...
	*/
	public ClientPutDir(FCPClient client, FreenetURI uri, String identifier, int verbosity, short priorityClass, short persistenceType, String clientToken, boolean getCHKOnly, boolean dontCompress, int maxRetries, File dir, String defaultName, boolean allowUnreadableFiles, boolean global, boolean earlyEncode, boolean canWriteClientCache, boolean forkOnCacheable, FCPServer server, ObjectContainer container) throws FileNotFoundException, IdentifierCollisionException, MalformedURLException {
		super(uri, identifier, verbosity , null, client, priorityClass, persistenceType, clientToken, global, getCHKOnly, dontCompress, maxRetries, earlyEncode, canWriteClientCache, forkOnCacheable, null, server, container);
		wasDiskPut = true;
		logMINOR = Logger.shouldLog(Logger.MINOR, this);
	...
	public ClientPutDir(FCPClient client, FreenetURI uri, String identifier, int verbosity, short priorityClass, short persistenceType, String clientToken, boolean getCHKOnly, boolean dontCompress, int maxRetries, HashMap<String, Object> elements, String defaultName, boolean global, boolean earlyEncode, boolean canWriteClientCache, boolean forkOnCacheable, FCPServer server, ObjectContainer container) throws IdentifierCollisionException, MalformedURLException {
		super(uri, identifier, verbosity , null, client, priorityClass, persistenceType, clientToken, global, getCHKOnly, dontCompress, maxRetries, earlyEncode, canWriteClientCache, forkOnCacheable, null, server, container);
		wasDiskPut = false;
		logMINOR = Logger.shouldLog(Logger.MINOR, this);
