...
public class FCPClient {
	...
	public void removeByIdentifier(String identifier, boolean kill, FCPServer server) throws MessageInvalidException {
		ClientRequest req;
	 ...
	 */
	public void setWatchGlobal(boolean enabled, int verbosityMask, FCPServer server) {
		if(isGlobalQueue) {
