...
public class NewPacketFormat implements PacketFormat {
	...
	private int watchListPointer; //Index of the packet with the lowest sequence number
	private int watchListOffset; //Sequence number of the packet at seqNumWatchList[watchListPointer]
