 ...
 * @author toad
 */
public class NodeIPPortDetectorImpl implements ProtectedNodeIPPortDetector {
	...
	NodeIPPortDetectorImpl(Node node, NodeIPDetector ipDetector, ProtectedNodeCrypto crypto, boolean enableARKs) {
		this.node = node;
	...
	public Peer[] detectPrimaryPeers() {
		final boolean logMINOR = NodeIPPortDetectorImpl.logMINOR;
