    ...
    public HTMLNode getConfirmWarning(NETWORK_THREAT_LEVEL newThreatLevel, String checkboxName) {
        ...
        if (((newThreatLevel == NETWORK_THREAT_LEVEL.HIGH) && (networkThreatLevel != NETWORK_THREAT_LEVEL.MAXIMUM))
            ...
            if (node.peers.getDarknetPeers().length == 0) {
                ...
                parent.addChild("input", new String[] { "type", "name", "value" }, new String[] { "checkbox",
                        checkboxName, "off" }, l10n("noFriendsCheckbox"));
                ...
                parent.addChild("input", new String[] { "type", "name", "value" }, new String[] { "checkbox",
                        checkboxName, "off" }, l10n("noConnectedFriendsCheckbox"));
                ...
                parent.addChild("input", new String[] { "type", "name", "value" }, new String[] { "checkbox",
                        checkboxName, "off" }, l10n("fewConnectedFriendsCheckbox"));

                return parent;
            }
        } else if (newThreatLevel == NETWORK_THREAT_LEVEL.LOW) {
            parent.addChild("p", l10n("networkThreatLevelLowWarning"));
            parent.addChild("input", new String[] { "type", "name", "value" }, new String[] { "checkbox", checkboxName,
                    "off" }, l10n("networkThreatLevelLowCheckbox"));
        ...
        if (newThreatLevel == NETWORK_THREAT_LEVEL.MAXIMUM) {
            ...
            NodeL10n.getBase().addL10nSubstitution(p, "SecurityLevels.maxSecurityYouNeedFriends",
                    new String[] { "bold" }, new HTMLNode[] { HTMLNode.STRONG });
            parent.addChild("input", new String[] { "type", "name", "value" }, new String[] { "checkbox", checkboxName,
                    "off" }, l10n("maximumNetworkThreatLevelCheckbox"));
