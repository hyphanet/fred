...
public abstract class Version {
	...
	public static final int buildNumber = 115;

	/** Oldest build of Fred we will talk to */
	public static final int lastGoodBuild = 115;
	...
	static {
		StringTokenizer cvsId =
			new StringTokenizer("$Id: Version.java,v 1.113 2005/08/23 18:40:28 amphibian Exp $");
		cvsId.nextToken();
		cvsId.nextToken();
