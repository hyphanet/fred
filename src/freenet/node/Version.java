...
public abstract class Version {
	...
	public static final int buildNumber = 30;

	/** Oldest build of Fred we will talk to */
	public static final int lastGoodBuild = 30;
	...
	static {
		StringTokenizer cvsId =
			new StringTokenizer("$Id: Version.java,v 1.30 2005/08/03 11:44:32 amphibian Exp $");
		cvsId.nextToken();
		cvsId.nextToken();
