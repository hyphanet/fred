...
public abstract class Version {
	...
	public static final int buildNumber = 82;

	/** Oldest build of Fred we will talk to */
	public static final int lastGoodBuild = 82;
	...
	static {
		StringTokenizer cvsId =
			new StringTokenizer("$Id: Version.java,v 1.80 2005/08/17 16:14:12 amphibian Exp $");
		cvsId.nextToken();
		cvsId.nextToken();
