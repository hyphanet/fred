...
public abstract class Version {
	...
	public static final int buildNumber = 59;

	/** Oldest build of Fred we will talk to */
	public static final int lastGoodBuild = 59;
	...
	static {
		StringTokenizer cvsId =
			new StringTokenizer("$Id: Version.java,v 1.57 2005/08/12 11:42:44 amphibian Exp $");
		cvsId.nextToken();
		cvsId.nextToken();
