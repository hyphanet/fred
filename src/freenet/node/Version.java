...
public abstract class Version {
	...
	public static final int buildNumber = 113;

	/** Oldest build of Fred we will talk to */
	public static final int lastGoodBuild = 113;
	...
	static {
		StringTokenizer cvsId =
			new StringTokenizer("$Id: Version.java,v 1.111 2005/08/23 18:32:05 amphibian Exp $");
		cvsId.nextToken();
		cvsId.nextToken();
