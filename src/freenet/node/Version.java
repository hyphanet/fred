...
public abstract class Version {
	...
	public static final int buildNumber = 103;

	/** Oldest build of Fred we will talk to */
	public static final int lastGoodBuild = 103;
	...
	static {
		StringTokenizer cvsId =
			new StringTokenizer("$Id: Version.java,v 1.101 2005/08/23 12:40:32 amphibian Exp $");
		cvsId.nextToken();
		cvsId.nextToken();
