...
public abstract class Version {
	...
	public static final int buildNumber = 89;

	/** Oldest build of Fred we will talk to */
	public static final int lastGoodBuild = 89;
	...
	static {
		StringTokenizer cvsId =
			new StringTokenizer("$Id: Version.java,v 1.87 2005/08/18 17:28:58 amphibian Exp $");
		cvsId.nextToken();
		cvsId.nextToken();
