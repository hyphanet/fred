...
public abstract class Version {
	...
	public static final int buildNumber = 85;

	/** Oldest build of Fred we will talk to */
	public static final int lastGoodBuild = 85;
	...
	static {
		StringTokenizer cvsId =
			new StringTokenizer("$Id: Version.java,v 1.83 2005/08/17 20:44:14 amphibian Exp $");
		cvsId.nextToken();
		cvsId.nextToken();
