...
public abstract class Version {
	...
	public static final int buildNumber = 90;

	/** Oldest build of Fred we will talk to */
	public static final int lastGoodBuild = 90;
	...
	static {
		StringTokenizer cvsId =
			new StringTokenizer("$Id: Version.java,v 1.88 2005/08/18 22:17:35 amphibian Exp $");
		cvsId.nextToken();
		cvsId.nextToken();
