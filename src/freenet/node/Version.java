...
public abstract class Version {
	...
	public static final int buildNumber = 114;

	/** Oldest build of Fred we will talk to */
	public static final int lastGoodBuild = 114;
	...
	static {
		StringTokenizer cvsId =
			new StringTokenizer("$Id: Version.java,v 1.112 2005/08/23 18:35:23 amphibian Exp $");
		cvsId.nextToken();
		cvsId.nextToken();
