...
public abstract class Version {
	...
	public static final int buildNumber = 66;

	/** Oldest build of Fred we will talk to */
	public static final int lastGoodBuild = 66;
	...
	static {
		StringTokenizer cvsId =
			new StringTokenizer("$Id: Version.java,v 1.64 2005/08/13 14:01:32 amphibian Exp $");
		cvsId.nextToken();
		cvsId.nextToken();
