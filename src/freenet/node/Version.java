...
public abstract class Version {
	...
	public static final int buildNumber = 111;

	/** Oldest build of Fred we will talk to */
	public static final int lastGoodBuild = 111;
	...
	static {
		StringTokenizer cvsId =
			new StringTokenizer("$Id: Version.java,v 1.109 2005/08/23 17:20:31 amphibian Exp $");
		cvsId.nextToken();
		cvsId.nextToken();
