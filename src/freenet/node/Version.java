...
public abstract class Version {
	...
	public static final int buildNumber = 112;

	/** Oldest build of Fred we will talk to */
	public static final int lastGoodBuild = 112;
	...
	static {
		StringTokenizer cvsId =
			new StringTokenizer("$Id: Version.java,v 1.110 2005/08/23 17:45:54 amphibian Exp $");
		cvsId.nextToken();
		cvsId.nextToken();
