...
public abstract class Version {
	...
	public static final int buildNumber = 34;

	/** Oldest build of Fred we will talk to */
	public static final int lastGoodBuild = 34;
	...
	static {
		StringTokenizer cvsId =
			new StringTokenizer("$Id: Version.java,v 1.34 2005/08/03 18:22:08 nextgens Exp $");
		cvsId.nextToken();
		cvsId.nextToken();
