...
public abstract class Version {
	...
	public static final int buildNumber = 62;

	/** Oldest build of Fred we will talk to */
	public static final int lastGoodBuild = 62;
	...
	static {
		StringTokenizer cvsId =
			new StringTokenizer("$Id: Version.java,v 1.60 2005/08/12 12:53:04 amphibian Exp $");
		cvsId.nextToken();
		cvsId.nextToken();
