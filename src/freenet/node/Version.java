...
public abstract class Version {
	...
	public static final int buildNumber = 93;

	/** Oldest build of Fred we will talk to */
	public static final int lastGoodBuild = 93;
	...
	static {
		StringTokenizer cvsId =
			new StringTokenizer("$Id: Version.java,v 1.91 2005/08/19 13:25:12 amphibian Exp $");
		cvsId.nextToken();
		cvsId.nextToken();
