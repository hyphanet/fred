...
public abstract class Version {
	...
	public static final int buildNumber = 106;

	/** Oldest build of Fred we will talk to */
	public static final int lastGoodBuild = 106;
	...
	static {
		StringTokenizer cvsId =
			new StringTokenizer("$Id: Version.java,v 1.104 2005/08/23 15:01:02 amphibian Exp $");
		cvsId.nextToken();
		cvsId.nextToken();
