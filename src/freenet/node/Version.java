...
public abstract class Version {
	...
	public static final int buildNumber = 6;

	/** Oldest build of Fred we will talk to */
	public static final int lastGoodBuild = 5;
	...
	static {
		StringTokenizer cvsId =
			new StringTokenizer("$Id: Version.java,v 1.6 2005/07/22 15:40:58 amphibian Exp $");
		cvsId.nextToken();
		cvsId.nextToken();
