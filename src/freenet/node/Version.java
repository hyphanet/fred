...
public abstract class Version {
	...
	public static final int buildNumber = 86;

	/** Oldest build of Fred we will talk to */
	public static final int lastGoodBuild = 86;
	...
	static {
		StringTokenizer cvsId =
			new StringTokenizer("$Id: Version.java,v 1.84 2005/08/18 13:06:44 amphibian Exp $");
		cvsId.nextToken();
		cvsId.nextToken();
