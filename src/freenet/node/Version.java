...
public abstract class Version {
	...
	public static final int buildNumber = 107;

	/** Oldest build of Fred we will talk to */
	public static final int lastGoodBuild = 107;
	...
	static {
		StringTokenizer cvsId =
			new StringTokenizer("$Id: Version.java,v 1.105 2005/08/23 15:45:59 amphibian Exp $");
		cvsId.nextToken();
		cvsId.nextToken();
