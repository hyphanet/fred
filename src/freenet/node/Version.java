...
public abstract class Version {
	...
	public static final int buildNumber = 28;

	/** Oldest build of Fred we will talk to */
	public static final int lastGoodBuild = 28;
	...
	static {
		StringTokenizer cvsId =
			new StringTokenizer("$Id: Version.java,v 1.28 2005/08/02 23:19:20 amphibian Exp $");
		cvsId.nextToken();
		cvsId.nextToken();
