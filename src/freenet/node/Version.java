...
public abstract class Version {
	...
	public static final int buildNumber = 58;

	/** Oldest build of Fred we will talk to */
	public static final int lastGoodBuild = 58;
	...
	static {
		StringTokenizer cvsId =
			new StringTokenizer("$Id: Version.java,v 1.56 2005/08/11 17:58:07 amphibian Exp $");
		cvsId.nextToken();
		cvsId.nextToken();
