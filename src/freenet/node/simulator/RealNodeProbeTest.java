...
public class RealNodeProbeTest extends RealNodeRoutingTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        final Type types[] = {
            Type.BANDWIDTH, Type.BUILD, Type.IDENTIFIER, Type.LINK_LENGTHS, Type.LOCATION, Type.STORE_SIZE,
            Type.UPTIME_48H, Type.UPTIME_7D, Type.REJECT_STATS, Type.OVERALL_BULK_OUTPUT_CAPACITY_USAGE
        };
        int index = 0;
        ...
        while (true) {
            ...
            try {
                ...
                if (selection == types.length) {
                    ...
                    String[] options = {
                        "probeBandwidth", "probeBuild", "probeIdentifier", "probeLinkLengths", "probeLinkLengths",
                        "probeUptime"
                    };
