...
public class RealNodePingTest {
    ...
    public static void main(String[] args) throws FSParseException, PeerParseException, InterruptedException, ReferenceSignatureVerificationException, NodeInitException, InvalidThresholdException {
        ...
        Node node1 = NodeStarter.createTestNode(5001, "pingtest", false, false, true, Node.DEFAULT_MAX_HTL, 0, random, executor);
        Node node2 = NodeStarter.createTestNode(5002, "pingtest", false, false, true, Node.DEFAULT_MAX_HTL, 0, random, executor);
        // Connect
        node1.connect(node2);
        node2.connect(node1);
        // No swapping
