...
public class RealNodePingTest {
	...
	public static final int DARKNET_PORT1 =
		RealNodeBusyNetworkTest.DARKNET_PORT_END;
	public static final int DARKNET_PORT2 =
		RealNodeBusyNetworkTest.DARKNET_PORT_END + 1;
	...
	public static void main(String[] args)
		throws FSParseException, PeerParseException, InterruptedException, ReferenceSignatureVerificationException, NodeInitException, InvalidThresholdException, PeerTooOldException {
		...
		Node node1 = NodeStarter.createTestNode(
			DARKNET_PORT1,
			0,
			"pingtest",
			true,
		...
		Node node2 = NodeStarter.createTestNode(
			DARKNET_PORT2,
			0,
			"pingtest",
			true,
		...
		while (true) {
			...
			if (success) Logger.error(
				RealNodePingTest.class,
				"PING " + pingID + " successful"
			);
