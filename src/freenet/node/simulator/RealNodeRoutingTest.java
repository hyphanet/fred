...
public class RealNodeRoutingTest extends RealNodeTest {
	...
	protected static Node[] createNodes(int numberOfNodes, String dir, RandomSource random, RandomSource topologyRandom,
		...
		for(int i = 0; i < NUMBER_OF_NODES; i++) {
			...
			nodes[i] = NodeStarter.createTestNode(i+1, DARKNET_PORT_BASE + i, 0, dir, true, MAX_HTL, 0 /* no dropped packets */, random, executor, 500 * NUMBER_OF_NODES, 65536, true, ENABLE_SWAPPING, false, false, false, ENABLE_SWAP_QUEUEING, true, 0, ENABLE_FOAF, false, true, false, null);
