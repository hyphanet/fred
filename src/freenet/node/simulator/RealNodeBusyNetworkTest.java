...
public class RealNodeBusyNetworkTest extends RealNodeRoutingTest {
    ...
    public static void main(String[] args)
            throws FSParseException, PeerParseException, CHKEncodeException, InvalidThresholdException,
                   ...
                   UnsupportedEncodingException, CHKVerifyException, CHKDecodeException,
        ...
        for (int i = 0; i < NUMBER_OF_NODES; i++) {
            nodes[i] = NodeStarter.createTestNode(DARKNET_PORT_BASE + i, 0, name, false, MAX_HTL, 20 /* 5% */, random,
                    executor, 500 * NUMBER_OF_NODES, (CHKBlock.DATA_LENGTH + CHKBlock.TOTAL_HEADERS_LENGTH) * 100,
                    true, ENABLE_SWAPPING, false, ENABLE_ULPRS, ENABLE_PER_NODE_FAILURE_TABLES, ENABLE_SWAP_QUEUEING,
        ...
        for (int i = 0; i < clients.length; i++) {
            clients[i] = nodes[i].clientCore.makeClient(RequestStarter.IMMEDIATE_SPLITFILE_PRIORITY_CLASS, false,
                    false);
        }
