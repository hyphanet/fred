...
public class BootstrapPullTest {
	...
	public static void main(String[] args) throws InvalidThresholdException, IOException, NodeInitException, InterruptedException {
        ...
        secondNode = NodeStarter.createTestNode(DARKNET_PORT, OPENNET_PORT, dir.getPath(), false, Node.DEFAULT_MAX_HTL, 0, random, executor, 1000, 5*1024*1024, true, true, true, true, true, true, true, 12*1024, false, true, false, ipOverride);
