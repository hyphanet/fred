...
public class CHKInsertHandler implements PrioRunnable, ByteCounter {
    ...
    private MessageFilter makeDataInsertFilter(long timeout) {
        ...
        MessageFilter mfDataInsertRejected =
            MessageFilter.create().setType(DMT.FNPDataInsertRejected).setField(DMT.UID,
                                           uid).setSource(source).setTimeout(timeout);
        ...
        try {
            ...
            node.usm.addAsyncFilter(mf, new SlowAsyncMessageFilterCallback() {
                ...
                public void onTimeout() {
                    Logger.error(this,
                                 "No DataInsert for " + CHKInsertHandler.this + " from " + source + " ("
    ...
    private void finish(int code) {
        ...
        if ((code != CHKInsertSender.TIMED_OUT) && (code != CHKInsertSender.GENERATED_REJECTED_OVERLOAD)
            ...
            if (logMINOR) {
                Logger.minor(this,
                             "Remote CHK insert cost " + totalSent + '/' + totalReceived + " bytes (" + code
    ...
    private CHKBlock verify() {
        ...
        synchronized (this) {
            ...
            try {
                ...
                Logger.error(this,
                             "Verify failed in CHKInsertHandler: " + e + " - headers: " + HexUtil.bytesToHex(headers),
                             e);
