...
public class CHKInsertHandler implements PrioRunnable, ByteCounter {
    ...
    CHKInsertHandler(NodeCHK key, short htl, PeerNode source, long id, ProtectedNode node, long startTime, InsertTag tag, boolean forkOnCacheable, boolean preferInsert, boolean ignoreLowBackoff, boolean realTimeFlag) {
        this.node = node;
        this.uid = id;
        this.source = source;
