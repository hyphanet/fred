...
public interface StreamTransportPluginFactory {
	 ...
	 */
	public StreamTransportPlugin makeTransportPlugin(TransportMode transportMode, TransportConfig config, IOStatisticCollector collector, long startupTime) throws TransportInitException;;
