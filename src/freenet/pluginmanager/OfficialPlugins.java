...
public class OfficialPlugins {
	...
	private class OfficialPluginBuilder {
		...
		public OfficialPluginBuilder recommendedVersion(
		 ...
		 * to use USK or CHK! */
		public OfficialPluginBuilder loadedFrom(String uri)
		...
		private void addCurrentPluginDescription() {
			if (
				recommendedVersion == 0 && minimumVersion > 0
			) recommendedVersion = minimumVersion;
			if (minimumVersion == 0 && recommendedVersion > 0) minimumVersion =
				recommendedVersion;
