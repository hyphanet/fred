...
public class PluginInfoWrapper implements Comparable<PluginInfoWrapper> {
	...
	public PluginInfoWrapper(
		...
		isFCPServerPlugin = (plug instanceof
		...
		if (isConfigurablePlugin) {
			...
			config.finishedInit();
			configToadlet = new ConfigToadlet(
	...
	public void startShutdownPlugin(PluginManager manager, boolean reloading) {
		...
		Thread.currentThread()
			.setContextClassLoader(plug.getClass().getClassLoader());
	...
	public boolean finishShutdownPlugin(
