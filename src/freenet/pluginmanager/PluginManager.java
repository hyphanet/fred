...
//		installDir = pmconfig.getString("installdir");
	...
	static {
		...
		addOfficialPlugin("Library", false, 6, true, new FreenetURI("CHK@Kh~a8kqVOAhMNNy9szPVPXn3~0~dAMFU9-VSg~cOa1s,-XlmGPo9CcfEH6RXkAO82fZ23DNXjmKcI4BEpHC3gQ4,AAIC--8/Library.jar"));
		} catch (MalformedURLException e) {
