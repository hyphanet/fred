...
public class PluginTalker {
    ...
    public PluginTalker(FredPluginTalker fpt, Node node2, String pluginname2, String connectionIdentifier)
    ...
    public PluginTalker(Node node2, FCPConnectionHandler handler, String pluginname2, String connectionIdentifier,
                        boolean access2)
            throws PluginNotFoundException {
        node = node2;
        pluginName = pluginname2;
    ...
    public void sendSyncInternalOnly(final SimpleFieldSet plugparams, final Bucket data2) {
        try {
            ...
            Logger.error(this,
                         "Cought error while execute fcp plugin handler for '" + pluginName
