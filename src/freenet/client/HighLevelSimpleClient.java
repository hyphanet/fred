...
public interface HighLevelSimpleClient {
     ...
     */
    public ClientGetter fetch(FreenetURI uri, RequestClient context, ClientGetCallback callback, FetchContext fctx,
                              short prio)
     ...
     * @return The ClientGetter object, which will have been started already.
     */
    public ClientGetter fetchFromMetadata(Bucket initialMetadata, RequestClient context, ClientGetCallback callback,
     ...
     * @return The ClientGetter object, which will have been started already.
     */
    public ClientGetter fetch(FreenetURI uri, long maxSize, RequestClient context, ClientGetCallback callback,
                              FetchContext fctx)
            throws FetchException;
     ...
     */
    public ClientGetter fetch(FreenetURI uri, long maxSize, RequestClient context, ClientGetCallback callback,
                              FetchContext fctx, short priorityClass)
            throws FetchException;
