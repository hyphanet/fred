...
public class SplitfileProgressEvent implements ClientEvent {
    ...
    public SplitfileProgressEvent(int totalBlocks, int succeedBlocks, int failedBlocks, int fatallyFailedBlocks,
                                  int minSuccessfulBlocks, int minSuccessFetchBlocks, boolean finalizedTotal) {
        ...
        if (logMINOR) {
            Logger.minor(this,
                         "Created SplitfileProgressEvent: total=" + totalBlocks + " succeed=" + succeedBlocks
                         + " failed=" + failedBlocks + " fatally=" + fatallyFailedBlocks + " min success="
                         + minSuccessfulBlocks + " finalized=" + finalizedTotal);
        }
    }
