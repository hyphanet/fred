...
public class DefaultManifestPutter extends BaseManifestPutter {
    ...
    public DefaultManifestPutter(ClientPutCallback clientCallback, HashMap<String, Object> manifestElements,
                                 short prioClass, FreenetURI target, String defaultName, InsertContext ctx,
                                 boolean getCHKOnly, RequestClient clientContext, boolean earlyEncode,
                                 boolean persistent, byte[] forceCryptoKey, ObjectContainer container,
        ...
        super(clientCallback, manifestElements, prioClass, target, defaultName, ctx, getCHKOnly, clientContext,
              earlyEncode, ClientPutter.randomiseSplitfileKeys(target, ctx, persistent, container), forceCryptoKey,
              container, context);
    }
    ...
    private long makePutHandlers(ContainerBuilder containerBuilder, HashMap<String, Object> manifestElements,
                                 String defaultName, String prefix, long maxSize, String parentName)
            throws TooManyFilesInsertException {
