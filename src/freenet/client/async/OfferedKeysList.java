...
public class OfferedKeysList extends BaseSendableGet implements RequestClient {
    ...
    @Override
    public synchronized SendableRequestItem chooseKey(KeysFetchingLocally fetching, ObjectContainer container,
        ...
        if (keys.size() == 1) {
            ...
            if (fetching.hasKey(k, null, false, null)) {
                return null;
            }
    ...
    @Override
    public void internalError(Throwable t, RequestScheduler sched, ObjectContainer container, ClientContext context,
                              boolean persistent) {
