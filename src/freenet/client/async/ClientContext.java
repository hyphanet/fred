...
public class ClientContext {
    ...
    public ClientContext(long bootID, long nodeDBHandle, DBJobRunner jobRunner, FECQueue fecQueue,
                         Executor mainExecutor, BackgroundBlockEncoder blockEncoder, ArchiveManager archiveManager,
                         ...
                         Ticker ticker, FilenameGenerator fg, FilenameGenerator persistentFG, RealCompressor rc,
                         DatastoreChecker checker, LinkFilterExceptionProvider linkFilterExceptionProvider) {
        this.bootID = bootID;
     ...
     */
    public void start(final ClientPutter inserter, final boolean earlyEncode)
            throws InsertException, DatabaseDisabledException {
     ...
     */
    public void setPersistentBucketFactory(PersistentTempBucketFactory persistentTempBucketFactory,
