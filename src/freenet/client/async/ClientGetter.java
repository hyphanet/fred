...
implements WantsCooldownCallback, FileGetCompletionCallback, Serializable {
    ...
    public void onSuccess(File tempFile, long length, ClientMetadata metadata,
        ...
        try {
            ...
            worker = new ClientGetWorkerThread(is, new NullOutputStream(), uri, null, ctx.host, hashes, false, null, ctx.prefetchHook, ctx.tagReplacer, context.linkFilterExceptionProvider);
            worker.start();
