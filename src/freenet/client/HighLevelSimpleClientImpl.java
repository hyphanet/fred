...
public class HighLevelSimpleClientImpl implements HighLevelSimpleClient, RequestClient {
	...
	public InsertContext getInsertContext(boolean forceNonPersistent) {
		return new InsertContext(
				...
				eventProducer, CAN_WRITE_CLIENT_CACHE_INSERTS, Node.FORK_ON_CACHEABLE_DEFAULT, false, Compressor.DEFAULT_COMPRESSORDESCRIPTOR, EXTRA_INSERTS_SINGLE_BLOCK, EXTRA_INSERTS_SPLITFILE_HEADER, InsertContext.CompatibilityMode.COMPAT_NONE);
	}
