...
final class FCPPluginConnectionTracker extends NativeThread {
	...
	> closedConnectionsQueue = new ReferenceQueue<FCPPluginConnectionImpl>();
	...
	static final class ConnectionWeakReference
		...
		public ConnectionWeakReference(
			FCPPluginConnectionImpl referent,
	 ...
	 */
	public FCPPluginConnectionImpl getConnection(UUID connectionID)
		throws IOException {
