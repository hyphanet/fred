...
public class ExpectedHashes extends FCPMessage implements Serializable {
	...
	public ExpectedHashes(
		ExpectedHashesEvent event,
		String identifier,
		boolean global
	) {
	...
	public SimpleFieldSet getFieldSet() {
		if (hashes == null) {
			Logger.error(
				this,
				"Hashes == null, possibly persistence issue caused prior to build 1411 on " +
				this
			);
			return null;
		}
		...
		for (HashResult hash : hashes) {
			if (hash == null) {
				Logger.error(
					this,
					"Hash == null, possibly persistence issue caused prior to build 1411 on " +
					this
				);
				return null;
			}
