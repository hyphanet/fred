...
public final class FCPPluginMessage {
	...
	private FCPPluginMessage(
		...
		assert (params != null ||
			data != null ||
			success != null) : "Messages should not be empty";

		assert (errorCode == null ||
			(success != null &&
				success ==
					false)) : "errorCode should only be provided for reply messages which indicate failure.";
		...
		assert (errorMessage == null ||
			errorCode !=
				null) : "errorCode should always be provided if there is an errorMessage";
	 ...
	 * </code>
	 */
	public static FCPPluginMessage constructSuccessReply(
		FCPPluginMessage originalMessage
	) {
