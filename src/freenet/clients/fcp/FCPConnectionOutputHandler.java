...
public class FCPConnectionOutputHandler implements Runnable {
    ...
    /**
     * @deprecated Use {@link FCPConnectionHandler#send(FCPMessage)} instead of using public
     *             access to the member variable {@link FCPConnectionHandler#outputHandler} to call
     *             this function here upon the outputHandler. In other words: Replace
     *             <code>fcpConnectionHandler.outputHandler.queue(...)</code>
     *             with <code>fcpConnectionHandler.send(...)</code><br>
     *             TODO: The deprecation is merely to enforce people to stop using the said
     *             member variable in a public way. The function itself is fine to stay. Once the
     *             public usage has been replaced by the suggested way of using send(),  please make
     *             the member variable {@link FCPConnectionHandler#outputHandler} private and remove
     *             the deprecation at this function here.
     */
    @Deprecated
