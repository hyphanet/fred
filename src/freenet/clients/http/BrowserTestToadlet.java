...
public class BrowserTestToadlet extends Toadlet {
    final static String imgWarningMime = "R0lGODdh1AE8AOf9AAABAAcAAAkBAAoDARAAAQcECRYAAxoCAB4BACIBARMK"
    ...
    public void handleMethodGET(URI uri, HTTPRequest request, ToadletContext ctx)
        ...
        HTMLNode maxConnectionsPerServerContent = ctx.getPageMaker().getInfobox("infobox-warning",
                                                      "Number of connections", contentNode, "browser-connections",
                                                      true);
        ...
        maxConnectionsPerServerContent.addChild("img", new String[] { "src", "alt" },
                new String[] { "/static/themes/clean/success.gif",
                               "fail!" });
        ...
        jsTest.addChild("img", new String[] { "id", "src", "alt" }, new String[] { "JSTEST",
                "/static/themes/clean/success.gif", "fail!" });
        jsTest.addChild("script", "type", "text/javascript").addChild("%",
