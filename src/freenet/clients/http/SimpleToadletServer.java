...
public final class SimpleToadletServer implements ToadletContainer, Runnable, LinkFilterExceptionProvider {
    ...
    public SimpleToadletServer(SubConfig fproxyConfig, BucketFactory bucketFactory, Executor executor, Node node)
        ...
        fproxyConfig.register("css", "clean-dropdown", configItemOrder++, false, false, "SimpleToadletServer.cssName",
                              "SimpleToadletServer.cssNameLong", new FProxyCSSNameCallback());
        ...
        fproxyConfig.register("enableInlinePrefetch", false, configItemOrder++, true, false,
                              ...
                              "SimpleToadletServer.enableInlinePrefetchLong", new BooleanCallback() {
            @Override
            public Boolean get() {
                synchronized (SimpleToadletServer.this) {
        ...
        fproxyConfig.register("passthroughMaxSize", FProxyToadlet.MAX_LENGTH_NO_PROGRESS, configItemOrder++, true,
                              false, "SimpleToadletServer.passthroughMaxSize",
                              "SimpleToadletServer.passthroughMaxSizeLong", new FProxyPassthruMaxSizeNoProgress(),
                              true);
        ...
        fproxyConfig.register("passthroughMaxSizeProgress", FProxyToadlet.MAX_LENGTH_WITH_PROGRESS, configItemOrder++,
                              ...
                              new FProxyPassthruMaxSizeProgress(), true);
        ...
        fproxyConfig.register("maxFproxyConnections", 100, configItemOrder++, true, false,
                              ...
                              "SimpleToadletServer.maxFproxyConnectionsLong", new IntCallback() {
            @Override
            public Integer get() {
                synchronized (SimpleToadletServer.this) {
        ...
        fproxyConfig.register("refilterPolicy", "RE_FILTER", configItemOrder++, true, false,
                              "SimpleToadletServer.refilterPolicy", "SimpleToadletServer.refilterPolicyLong",
    ...
    public void run() {
        try {
            ...
            Logger.error(this,
                         "Could not set so-timeout to 500ms; on-the-fly disabling of the interface will not work");
        }
    ...
    public HTMLNode addFormChild(HTMLNode parentNode, String target, String id) {
        HTMLNode formNode = parentNode.addChild("div").addChild("form", new String[] { "action", "method", "enctype",
                "id", "accept-charset" }, new String[] { target, "post", "multipart/form-data", id, "utf-8" });

        formNode.addChild("input", new String[] { "type", "name", "value" }, new String[] { "hidden", "formPassword",
                getFormPassword() });
