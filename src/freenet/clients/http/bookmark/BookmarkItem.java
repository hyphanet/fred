...
public class BookmarkItem extends Bookmark {
    ...
    private class BookmarkUpdatedUserAlert extends AbstractUserAlert {
        ...
        public String getText() {
            return l10n("bookmarkUpdated", new String[] { "name", "edition" }, new String[] { name,
        ...
        public HTMLNode getHTMLText() {
            ...
            NodeL10n.getBase().addL10nSubstitution(n, "BookmarkItem.bookmarkUpdatedWithLink", new String[] { "link",
                    "name", "edition" }, new HTMLNode[] { HTMLNode.link("/" + key), HTMLNode.text(name),
