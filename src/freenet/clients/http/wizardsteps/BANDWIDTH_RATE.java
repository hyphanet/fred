...
//          new BandwidthLimit(128*KiB, 8*KiB, "bandwidthConnection2M"),
    ...
    public void getStep(HTTPRequest request, PageHelper helper) {
        ...
        customForm.addChild("td").addChild("input", new String[] { "type", "name" }, new String[] { "text",
                "customDown" });
...
//                      new String[] { "radio", "bandwidth", "custom" });
        infoBox.addChild("input", new String[] { "type", "name", "value" }, new String[] { "submit", "back",
                NodeL10n.getBase().getString("Toadlet.back") });
        infoBox.addChild("input", new String[] { "type", "name", "value" }, new String[] { "submit", "next",
    ...
    private void addLimitRow(HTMLNode table, PageHelper helper, BandwidthLimit limit, boolean recommended,
        ...
        HTMLNode radio = buttonCell.addChild("input", new String[] { "type", "name", "value" }, new String[] { "radio",
                "bandwidth", limit.downBytes + "/" + limit.upBytes });
