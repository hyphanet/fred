...
public class WELCOME implements Step {
    ...
    public void getStep(HTTPRequest request, PageHelper helper) {
        ...
        HTMLNode dropDown = ConfigToadlet.addComboBox(language.getValueString(), l10nCallback, language.getName(),
                                false);
    ...
    private void addSecurityTableCell(HTMLNode header, HTMLNode row, String preset, PageHelper helper,
        ...
        secForm.addChild("input", new String[] { "type", "name", "value", }, new String[] { "hidden", "incognito",
                String.valueOf(incognito), });
        secForm.addChild("input", new String[] { "type", "name", "value" }, new String[] { "submit", "preset" + preset,
