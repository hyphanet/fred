...
public class SECURITY_NETWORK implements Step {
    ...
    public void getStep(HTTPRequest request, PageHelper helper) {
        ...
        if (request.isParameterSet("confirm")) {
            ...
            if (newThreatLevel == SecurityLevels.NETWORK_THREAT_LEVEL.MAXIMUM) {
                ...
                formNode.addChild("p").addChild("input", new String[] { "type", "name", "value" },
                                  new String[] { "checkbox",
                                                 ...
                                                 "off" }, WizardL10n.l10nSec("maximumNetworkThreatLevelCheckbox"));
                ...
                NodeL10n.getBase().addL10nSubstitution(p, "FirstTimeWizardToadlet.highNetworkThreatLevelWarning",
                        new String[] { "bold",
                                       "addAFriend", "friends" }, new HTMLNode[] { HTMLNode.STRONG,
                ...
                HTMLNode checkbox = formNode.addChild("p").addChild("input", new String[] { "type", "name", "value" },
                                        new String[] { "checkbox",
                        "security-levels.networkThreatLevel.confirm", "off" });

                NodeL10n.getBase().addL10nSubstitution(checkbox,
                        "FirstTimeWizardToadlet.highNetworkThreatLevelCheckbox", new String[] { "bold",
                        "addAFriend" }, new HTMLNode[] { HTMLNode.STRONG,
                        new HTMLNode("#", NodeL10n.getBase().getString("FProxyToadlet.addFriendTitle")), });
            }
            ...
            formNode.addChild("input", new String[] { "type", "name", "value" }, new String[] { "submit",
                    "return-from-confirm", NodeL10n.getBase().getString("Toadlet.back") });
            formNode.addChild("input", new String[] { "type", "name", "value" }, new String[] { "submit", "next",
    ...
    private void securityLevelChoice(HTMLNode parent, SecurityLevels.NETWORK_THREAT_LEVEL level) {
        HTMLNode input = parent.addChild("p").addChild("input", new String[] { "type", "name", "value" },
                                         new String[] { "radio",
    ...
    public String postStep(HTTPRequest request) {
        ...
        if (request.isPartSet("return-from-confirm")) {
            ...
            if (isInPreset) {
                ...
                return FirstTimeWizardToadlet.getPreviousStep(FirstTimeWizardToadlet.WIZARD_STEP.SECURITY_NETWORK,
                        persistFields.preset).name();
            }
