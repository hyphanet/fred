...
public class SECURITY_PHYSICAL implements Step {
    ...
    public void getStep(HTTPRequest request, PageHelper helper) {
        ...
        div.addChild("p",
                     NodeL10n.getBase().getString("SecurityLevels.physicalThreatLevelSwapfile", "operatingSystem",
        ...
        form.addChild("input", new String[] { "type", "name", "value" }, new String[] { "submit", "back",
                NodeL10n.getBase().getString("Toadlet.back") });
        form.addChild("input", new String[] { "type", "name", "value" }, new String[] { "submit", "next",
    ...
    public String postStep(HTTPRequest request) throws IOException {
        ...
        if (((newThreatLevel == SecurityLevels.PHYSICAL_THREAT_LEVEL.LOW) || (newThreatLevel == SecurityLevels
                .PHYSICAL_THREAT_LEVEL.NORMAL)) && (oldThreatLevel == SecurityLevels.PHYSICAL_THREAT_LEVEL.HIGH)) {
            if (passwordIsBlank) {
    ...
    private String promptPassword(SecurityLevels.PHYSICAL_THREAT_LEVEL newThreatLevel, PASSWORD_PROMPT type) {
        ...
        StringBuilder destination = new StringBuilder(
                                        ...
                                        + "&error=pass&newThreatLevel=").append(newThreatLevel.name()).append(
    ...
    public void setThreatLevel(SecurityLevels.PHYSICAL_THREAT_LEVEL newThreatLevel,
        ...
        try {
            ...
            // Ignore, impossible???
            System.err.println(
                "Failed starting up database while switching physical security level to " + newThreatLevel + " from "
                + oldThreatLevel
    ...
    private void addBackToPhysicalSeclevelsButton(HTMLNode form) {
        form.addChild("p").addChild("input", new String[] { "type", "name", "value" }, new String[] { "submit",
                "backToMain", WizardL10n.l10n("backToSecurityLevels") });
    }
}
