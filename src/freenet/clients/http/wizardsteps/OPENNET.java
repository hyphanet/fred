...
public class OPENNET implements Step {
	...
	public void getStep(HTTPRequest request, PageHelper helper) {
		HTMLNode contentNode = helper.getPageContent(
			WizardL10n.l10n("opennetChoicePageTitle")
		);
		...
		infoboxContent.addChild(
			"p",
			WizardL10n.l10n("opennetChoiceIntroduction")
		);
		...
		p.addChild(
			"#",
			": " + WizardL10n.l10n("opennetChoiceConnectFriendsPRO") + "¹"
		);
		p.addChild("br");
		...
		p.addChild(
			"#",
			": " +
			WizardL10n.l10n("opennetChoiceConnectFriendsCON", "minfriends", "5")
		);
		...
		p.addChild(
			"#",
			": " + WizardL10n.l10n("opennetChoiceConnectStrangersPRO")
		);
		p.addChild("br");
		p.addChild("i", WizardL10n.l10n("opennetChoiceCon"));
		p.addChild(
			"#",
			": " + WizardL10n.l10n("opennetChoiceConnectStrangersCON")
		);
		...
		foot.addChild(
			"i",
			"¹: " + WizardL10n.l10n("opennetChoiceHowSafeIsFreenetToggle")
		);
		HTMLNode footHidden = foot.addChild("div", "class", "hidden");
		HTMLNode footList = footHidden.addChild("ol");
		footList.addChild(
			"li",
			WizardL10n.l10n("opennetChoiceHowSafeIsFreenetStupid")
		);
		footList.addChild(
			"li",
			WizardL10n.l10n("opennetChoiceHowSafeIsFreenetFriends") + "²"
		);
		footList.addChild(
			"li",
			WizardL10n.l10n("opennetChoiceHowSafeIsFreenetTrustworthy")
		);
		footList.addChild(
			"li",
			WizardL10n.l10n("opennetChoiceHowSafeIsFreenetNoSuspect")
		);
		footList.addChild(
			"li",
			WizardL10n.l10n("opennetChoiceHowSafeIsFreenetChangeID")
		);
		footList.addChild(
			"li",
			WizardL10n.l10n("opennetChoiceHowSafeIsFreenetSSK")
		);
		footList.addChild(
			"li",
			WizardL10n.l10n("opennetChoiceHowSafeIsFreenetOS")
		);
		footList.addChild(
			"li",
			WizardL10n.l10n("opennetChoiceHowSafeIsFreenetBigPriv")
		);
		footList.addChild(
			"li",
			WizardL10n.l10n("opennetChoiceHowSafeIsFreenetDistant")
		);
		footList.addChild(
			"li",
			WizardL10n.l10n("opennetChoiceHowSafeIsFreenetBugs")
		);
		HTMLNode foot2 = footHidden.addChild("p");
		foot2.addChild(
			"#",
			"²: " + WizardL10n.l10n("opennetChoiceHowSafeIsFreenetFoot2")
		);
	}
	...
	public String postStep(HTTPRequest request) {
		if (request.isPartSet("opennet")) {
			return (
				FirstTimeWizardToadlet.WIZARD_STEP.SECURITY_NETWORK +
				"&opennet=" +
