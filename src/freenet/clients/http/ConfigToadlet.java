...
public class ConfigToadlet extends Toadlet implements LinkEnabledCallback {
    ...
    public void handleMethodPOST(URI uri, HTTPRequest request, ToadletContext ctx)
        ...
        if (request.isPartSet("confirm-reset-to-defaults")) {
            ...
            formNode.addChild("input", new String[] { "type", "name", "value" }, new String[] { "hidden", "subconfig",
                    subconfig });
            ...
            formNode.addChild("input", new String[] { "type", "name", "value" }, new String[] { "submit",
                    "reset-to-defaults", NodeL10n.getBase().getString("Toadlet.yes") });
            formNode.addChild("input", new String[] { "type", "name", "value" }, new String[] { "submit",
                    "decline-default-reset", NodeL10n.getBase().getString("Toadlet.no") });
        ...
        if (errbuf.length() == 0) {
            ...
            HTMLNode content = ctx.getPageMaker().getInfobox("infobox-error", l10n("appliedFailureTitle"), contentNode,
                                   "configuration-error", true).addChild("div", "class", "infobox-content");
    ...
    public void handleMethodGET(URI uri, HTTPRequest req, ToadletContext ctx)
        ...
        formNode.addChild("input", new String[] { "type", "value", "class" }, new String[] { "submit", l10n("apply"),
                "invisible" });
        ...
        if (subConfig.getPrefix().equals("node") && WrapperConfig.canChangeProperties()) {
            ...
            if (curValue != null) {
                ...
                item.addChild("span", new String[] { "class", "title", "style" }, new String[] { "configshortdesc",
                        NodeL10n.getBase().getString("ConfigToadlet.defaultIs", new String[] { "default" },
                        new String[] { defaultValue }),
                        "cursor: help;" }).addChild(NodeL10n.getBase().getHTMLNode("WrapperConfig." + configName
                        + ".short"));
                item.addChild("span", "class", "config").addChild("input", new String[] { "type", "class", "name",
                        "value" }, new String[] { "text", "config", configName, curValue });
                item.addChild("span", "class",
                              "configlongdesc").addChild(NodeL10n.getBase().getHTMLNode("WrapperConfig." + configName
                                  + ".long"));
            }
        }
            ...
            if (!((!advancedModeEnabled) && o.isExpert())) {
                ...
                configItemNode.addChild("a", new String[] { "name", "id" },
                                        new String[] { configName, configName }).addChild("span",
                                            new String[] { "class",
                        "title", "style" }, new String[] { "configshortdesc",
                        NodeL10n.getBase().getString("ConfigToadlet.defaultIs", new String[] { "default" },
                        new String[] { defaultValue }) + (advancedModeEnabled ? " [" + fullName + ']' : ""),
        ...
        if (!subConfig.getPrefix().equals("node")) {
            formNode.addChild("input", new String[] { "type", "name", "value" }, new String[] { "submit",
                    "confirm-reset-to-defaults", l10n("resetToDefaults") });
        }
    ...
    public static HTMLNode addTextBox(String value, String fullName, Option<?> o, boolean disabled) {
        ...
        if (disabled) {
            result = new HTMLNode("input", new String[] {
                "type", "class", "disabled", "alt", "name", "value"
            },                                                                                          //
            new String[] {
                "text", "config", "disabled", o.getShortDesc(), fullName, value
            });
        } else {
    ...
    public static HTMLNode addComboBox(String value, EnumerableOptionCallback o, String fullName, boolean disabled) {
        ...
        for (String possibleValue : o.getPossibleValues()) {
            if (possibleValue.equals(value)) {
                result.addChild("option", new String[] { "value", "selected" }, new String[] { possibleValue,
    ...
    private class NeedRestartUserAlert extends AbstractUserAlert {
        ...
        public HTMLNode getHTMLText() {
            ...
            if (node.isUsingWrapper()) {
                ...
                HTMLNode restartForm = alertNode.addChild("form", new String[] { "action", "method", "enctype", "id",
                        "accept-charset" }, new String[] { "/", "post", "multipart/form-data", "restartForm",
                        "utf-8" }).addChild("div");

                restartForm.addChild("input", new String[] { "type", "name", "value" }, new String[] { "hidden",
