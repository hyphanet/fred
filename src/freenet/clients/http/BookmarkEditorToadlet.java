...
public class BookmarkEditorToadlet extends Toadlet {
    ...
    private void addCategoryToList(BookmarkCategory cat, String path, HTMLNode list, BookmarkManager bookmarkManager) {
        ...
        for (int i = 0; i < items.size(); i++) {
            ...
            actions.addChild("a", "href", "?action=edit&bookmark=" + itemPath).addChild("img", new String[] { "src",
                    "alt", "title" }, new String[] { "/static/icon/edit.png", edit, edit });
            actions.addChild("a", "href", "?action=del&bookmark=" + itemPath).addChild("img", new String[] { "src",
                    "alt", "title" }, new String[] { "/static/icon/delete.png", delete, delete });

            if (cutedPath == null) {
                actions.addChild("a", "href", "?action=cut&bookmark=" + itemPath).addChild("img", new String[] { "src",
                        "alt", "title" }, new String[] { "/static/icon/cut.png", cut, cut });
            }

            if (i != 0) {
                actions.addChild("a", "href", "?action=up&bookmark=" + itemPath).addChild("img", new String[] { "src",
                        "alt", "title" }, new String[] { "/static/icon/go-up.png", moveUp, moveUp });
            }

            if (i != items.size() - 1) {
                actions.addChild("a", "href", "?action=down&bookmark=" + itemPath).addChild("img", new String[] { "src",
        ...
        for (int i = 0; i < cats.size(); i++) {
            ...
            if (i != 0) {
                actions.addChild("a", "href", "?action=up&bookmark=" + catPathEncoded).addChild("img",
                                 new String[] { "src",
                                                "alt", "title" }, new String[] { "/static/icon/go-up.png", moveUp,
                                                moveUp });
            }
            ...
            if (i != cats.size() - 1) {
                actions.addChild("a", "href", "?action=down&bookmark=" + catPathEncoded).addChild("img",
                                 new String[] { "src",
                                                "alt", "title" }, new String[] { "/static/icon/go-down.png", moveDown,
                                                moveDown });
            }
            ...
            if ((cutedPath != null) &&!catPathEncoded.startsWith(cutedPath)
                ...
                actions.addChild("a", "href", "?action=paste&bookmark=" + catPathEncoded).addChild("img",
                                 new String[] { "src",
                                                "alt", "title" }, new String[] { "/static/icon/paste.png", paste,
                                                paste });
            }
    ...
    private HTMLNode getBookmarksList(BookmarkManager bookmarkManager) {
        ...
        actions.addChild("a", "href", "?action=addItem&bookmark=/").addChild("img", new String[] { "src", "alt",
                "title" }, new String[] { "/static/icon/bookmark-new.png", addBookmark, addBookmark });
        actions.addChild("a", "href", "?action=addCat&bookmark=/").addChild("img", new String[] { "src", "alt",
                "title" }, new String[] { "/static/icon/folder-new.png", addCategory, addCategory });

        if ((cutedPath != null) &&!"/".equals(bookmarkManager.parentPath(cutedPath))) {
            actions.addChild("a", "href", "?action=paste&bookmark=/").addChild("img", new String[] { "src", "alt",
    ...
    public void handleMethodGET(URI uri, HTTPRequest req, ToadletContext ctx)
        ...
        if ((req.getParam("action").length() > 0) && (originalBookmark.length() > 0)) {
            ...
            if (bookmark == null) {
                ...
                confirmForm.addChild("input", new String[] { "type", "name", "value" }, new String[] { "hidden",
                        "bookmark", bookmarkPath });
                confirmForm.addChild("input", new String[] { "type", "name", "value" }, new String[] { "submit",
                        "cancel", NodeL10n.getBase().getString("Toadlet.cancel") });
                confirmForm.addChild("input", new String[] { "type", "name", "value" }, new String[] { "submit",
                ...
                form.addChild("input", new String[] { "type", "id", "name", "size", "value" }, new String[] { "text",
                        "name", "name", "20", !isNew ? bookmark.getVisibleName() : "" });
                form.addChild("br");
                ...
                if (("edit".equals(action) && (bookmark instanceof BookmarkItem)) || "addItem".equals(action)
                    ...
                    if ("edit".equals(action) || "addItem".equals(action)) {
                        ...
                        form.addChild("textarea", new String[] { "id", "name", "row", "cols" }, new String[] { "descB",
                                "descB", "3", "70" }, (isNew ? "" : item.getDescription()));
                        form.addChild("br");
                        form.addChild("label", "for", "descB",
                        ...
                        form.addChild("textarea", new String[] { "id", "name", "row", "cols" },
                                      new String[] { "explain",
                                                     "explain", "3", "70" }, (isNew ? "" : item.getShortDescription()));
                        form.addChild("br");
                    }
                    ...
                    if (!isNew && item.hasAnActivelink()) {
                        form.addChild("input", new String[] { "type", "id", "name", "checked" },
                                      new String[] { "checkbox",
                                                     "hasAnActivelink", "hasAnActivelink",
                                                     String.valueOf(item.hasAnActivelink()) });
                    } else {
                        form.addChild("input", new String[] { "type", "id", "name" }, new String[] { "checkbox",
                                "hasAnActivelink", "hasAnActivelink" });
                    }
                    ...
                    if ((core.node.getDarknetConnections().length > 0)
                        ...
                        peerTable.addChild("th", "colspan", "2",
                        ...
                        for (DarknetPeerNode peer : core.node.getDarknetConnections()) {
                            ...
                            peerRow.addChild("td", "class", "peer-marker").addChild("input", new String[] { "type",
                                    "name" }, new String[] { "checkbox", "node_" + peer.hashCode() });
                        ...
                        form.addChild("br");
                        form.addChild("textarea", new String[] { "id", "name", "row", "cols" }, new String[] { "descB",
                                "publicDescB", "3", "70" }, (isNew ? "" : item.getDescription()));
                        form.addChild("br");
                    }
                }

                form.addChild("input", new String[] { "type", "name", "value" }, new String[] { "hidden", "bookmark",
                        bookmarkPath });
                form.addChild("input", new String[] { "type", "name", "value" }, new String[] { "hidden", "action",
                        req.getParam("action") });
        ...
        if (cutedPath != null) {
            HTMLNode infoBoxContent = pageMaker.getInfobox("infobox-normal",
                                          NodeL10n.getBase().getString("BookmarkEditorToadlet.pasteTitle"), content,
                                          null, false);
            ...
            cancelForm.addChild("input", new String[] { "type", "name", "value" }, new String[] { "hidden", "action",
                    "cancelCut" });
        }
        ...
        try {
            ...
            if ((bookmark == null) &&!req.isPartSet("cancelCut")) {
                pageMaker.getInfobox("infobox-error", NodeL10n.getBase().getString("BookmarkEditorToadlet.error"),
                                     content, "bookmark-error", false).addChild("#",
                                         NodeL10n.getBase().getString("BookmarkEditorToadlet.bookmarkDoesNotExist",
                                             new String[] { "bookmark" }, new String[] { bookmarkPath }));
                this.writeHTMLReply(ctx, 200, "OK", pageNode.generate());
            ...
            if (req.isPartSet("confirmdelete")) {
                ...
                pageMaker.getInfobox("infobox-success",
                                     ...
                                     content, "bookmark-successful-delete", false).addChild("p",
                                         NodeL10n.getBase().getString("BookmarkEditorToadlet.deleteSucceeded"));
                ...
                if ("edit".equals(action)) {
                    ...
                    if (bookmark instanceof BookmarkItem) {
                        ...
                        item.update(new FreenetURI(req.getPartAsStringFailsafe("key", MAX_KEY_LENGTH)),
                                    hasAnActivelink, req.getPartAsStringFailsafe("descB", MAX_KEY_LENGTH),
                    ...
                    pageMaker.getInfobox("infobox-success",
                                         ...
                                         content, "bookmark-error", false).addChild("p",
                                             NodeL10n.getBase().getString("BookmarkEditorToadlet.changesSaved"));
                    ...
                    if ("addItem".equals(action)) {
                        ...
                        if (name.contains("/")) {
                            pageMaker.getInfobox(
                                "infobox-error",
                                NodeL10n.getBase().getString("BookmarkEditorToadlet.invalidNameTitle"), content,
                                "bookmark-error", false).addChild(
                    ...
                    if (newBookmark != null) {
                        ...
                        pageMaker.getInfobox(
                            ...
                            "bookmark-add-new", false).addChild(
            ...
            pageMaker.getInfobox("infobox-error",
                                 NodeL10n.getBase().getString("BookmarkEditorToadlet.invalidKeyTitle"), content,
                                 "bookmark-error", false).addChild("#",
                                     NodeL10n.getBase().getString("BookmarkEditorToadlet.invalidKey"));
        }
