    ...
    public void handleMethodGET(URI uri, HTTPRequest request, ToadletContext ctx)
        ...
        if (request.isParameterSet("getOverrideTranlationFile")) {
            ...
            footer.addChild("a", "href",
                            TOADLET_URL + "?translate=" + key
                            + (showEverything ? "" : "&toTranslateOnly")).addChild("#", l10n("reEdit"));
            footer.addChild("%", "&nbsp;&nbsp;");
            ...
            contentRow.addChild("td", "class", "translation-key", key);
            contentRow.addChild("td", "class", "translation-orig", this.base.getDefaultString(key));
            contentRow.addChild("td", "class", "translation-new").addChild("textarea", new String[] { "name", "rows",
                    "cols" }, new String[] { "trans", "20", "80" }, this.base.getString(key));
            ...
            if (!showEverything) {
                updateForm.addChild("input", new String[] { "type", "name", "value" }, new String[] { "hidden",
                        "toTranslateOnly", key });
            }
            ...
            content.addChild("p").addChild("#",
                             NodeL10n.getBase().getString("TranslationToadlet.confirmRemoveOverride",
                                 new String[] { "key",
                    "value" }, new String[] { key, this.base.getString(key) }));
            ...
            removeForm.addChild("input", new String[] { "type", "name", "value" }, new String[] { "submit",
                    "remove_confirmed", l10n("remove") });
            removeForm.addChild("input", new String[] { "type", "name", "value" }, new String[] { "submit", "cancel",
                    NodeL10n.getBase().getString("Toadlet.cancel") });
            this.writeHTMLReply(ctx, 200, "OK", pageNode.generate());
        ...
        while (it.hasNext()) {
            ...
            contentRow.addChild("td", "class",
                                "translation-new").addChild(_setOrRemoveOverride(key, isOverriden, showEverything));
        }
        ...
        if (request.getPartAsStringFailsafe("translation_update", 32).length() > 0) {
            ...
            if ("on".equalsIgnoreCase(request.getPartAsStringFailsafe("gotoNext", 7))) {
                ...
                while (it.hasNext()) {
                    ...
                    redirectTo(ctx,
                               TOADLET_URL + "?gotoNext&translate=" + newKey
