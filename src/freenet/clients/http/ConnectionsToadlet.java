...
public abstract class ConnectionsToadlet extends Toadlet {
    ...
    public void handleMethodGET(URI uri, final HTTPRequest request, ToadletContext ctx)
        ...
        int numberOfNotConnected = numberOfTooNew + numberOfTooOld + numberOfNoLoadStats + numberOfDisconnected
                                   ...
                                   + numberOfListenOnly + numberOfClockProblem + numberOfConnError;
        ...
        if (peerNodeStatuses.length > 0) {
            if (advancedMode) {
                ...
                StatisticsToadlet.drawPeerStatsBox(peerStatsInfobox, advancedMode, numberOfConnected,
                                                   ...
                                                   numberOfBursting, numberOfListening, numberOfListenOnly, 0, 0,
            ...
            if (!isOpennet()) {
                ...
                myName.addChild("span",
                                NodeL10n.getBase().getString("DarknetConnectionsToadlet.myName", "name",
                                    node.getMyName()));
                myName.addChild("span", " [");
            ...
            if (peerNodeStatuses.length == 0) {
                ...
                if (hasNameColumn()) {
                    peerTableHeaderRow.addChild("th").addChild("a", "href",
                                                sortString(isReversed, "name")).addChild("span", new String[] { "title",
                            "style" }, new String[] { l10n("nameClickToMessage"),
                                                      "border-bottom: 1px dotted; cursor: help;" }, l10n("nameTitle"));
                }

                if (hasTrustColumn()) {
                    peerTableHeaderRow.addChild("th").addChild("a", "href",
                                                sortString(isReversed, "trust")).addChild("span",
                                                    new String[] { "title",
                            "style" }, new String[] { l10n("trustMessage"),
                                                      "border-bottom: 1px dotted; cursor: help;" }, l10n("trustTitle"));
                }
                ...
                if (hasVisibilityColumn()) {
                    peerTableHeaderRow.addChild("th").addChild("a", "href",
                            ...
                            "style" }, new String[] {
                                ...
                                "border-bottom: 1px dotted; cursor: help;" }, l10n("visibilityTitle"));
                }

                peerTableHeaderRow.addChild("th").addChild("a", "href",
                                            sortString(isReversed, "address")).addChild("span", new String[] { "title",
                        "style" }, new String[] { l10n("ipAddress"), "border-bottom: 1px dotted; cursor: help;" },
                                   l10n("ipAddressTitle"));
                peerTableHeaderRow.addChild("th").addChild("a", "href",
                                            sortString(isReversed, "version")).addChild("#", l10n("versionTitle"));

                if (advancedMode) {
                    peerTableHeaderRow.addChild("th").addChild("a", "href",
                                                sortString(isReversed, "location")).addChild("#",
                                                    l10n("locationTitle"));
                    peerTableHeaderRow.addChild("th").addChild("a", "href",
                                                sortString(isReversed, "backoffRT")).addChild("span",
                                                    new String[] { "title",
                            "style" }, new String[] {
                    ...
                    peerTableHeaderRow.addChild("th").addChild("a", "href",
                                                sortString(isReversed, "backoffBulk")).addChild("span",
                                                    new String[] { "title",
                            "style" }, new String[] {
                    ...
                    peerTableHeaderRow.addChild("th").addChild("a", "href",
                                                sortString(isReversed, "overload_p")).addChild("span",
                                                    new String[] { "title",
                            "style" }, new String[] {
                ...
                peerTableHeaderRow.addChild("th").addChild("a", "href",
                                            sortString(isReversed, "idle")).addChild("span", new String[] { "title",
                        "style" }, new String[] { l10n("idleTime"), "border-bottom: 1px dotted; cursor: help;" },
                                   l10n("idleTimeTitle"));

                if (hasPrivateNoteColumn()) {
                    peerTableHeaderRow.addChild("th").addChild("a", "href",
                                                sortString(isReversed, "privnote")).addChild("span",
                                                    new String[] { "title",
                            "style" }, new String[] { l10n("privateNote"),
                            "border-bottom: 1px dotted; cursor: help;" }, l10n("privateNoteTitle"));
                }

                if (advancedMode) {
                    peerTableHeaderRow.addChild("th").addChild("a", "href",
                                                sortString(isReversed, "time_routable")).addChild("#",
                                                    "%\u00a0Time Routable");
                    peerTableHeaderRow.addChild("th").addChild("a", "href",
                    ...
                    for (SimpleColumn col : endCols) {
                        ...
                        header.addChild("span", new String[] { "title", "style" },
                                        new String[] { NodeL10n.getBase().getString(col.getExplanationKey()),
                                                       "border-bottom: 1px dotted; cursor: help;" }, NodeL10n.getBase()
                                                           .getString(col.getTitleKey()));
                    }
                }
            ...
            if (advancedMode) {
                ...
                peerTableInfoboxContent.addChild("b",
                                                 l10n("secondDegreeConnectionsCountTitle", "count",
                ...
                if (!showTrivialFoafConnections) {
                    peerTableInfoboxContent.addChild("i",
                                                     l10n("secondDegreeTrivialHiddenCount", "count",
                                                         Integer.toString(trivialCount)));

                    // @todo: add "show these" link
                } else {
                    peerTableInfoboxContent.addChild("i",
                                                     l10n("secondDegreeNonTrivialCount", "count",
                ...
                if (transitiveCount > 0) {
                    peerTableInfoboxContent.addChild("i",
                                                     l10n("secondDegreeAlsoOurs", "count",
                ...
                if (results.containsKey(returnCode)) {
                    ...
                    statusBoxTable.addChild(new HTMLNode("tr", "style",
                            ...
                            + ((returnCode == PeerAdditionReturnCodes.OK)
                               ? "green" : "red"))).addChildren(new HTMLNode[] {
    ...
    void drawNoderefBox(HTMLNode contentNode, SimpleFieldSet fs, boolean showNoderef) {
        ...
        NodeL10n.getBase().addL10nSubstitution(headerReferenceInfobox, "DarknetConnectionsToadlet.myReferenceHeader",
                new String[] { "linkref",
                               "linktext" }, new HTMLNode[] { REF_LINK, REFTEXT_LINK });
    ...
    protected static void drawAddPeerBox(HTMLNode contentNode, ToadletContext ctx, boolean isOpennet,
        ...
        peerAdditionForm.addChild("textarea", new String[] { "id", "name", "rows", "cols" }, new String[] { "reftext",
                "ref", "8", "74" });
        peerAdditionForm.addChild("br");
        peerAdditionForm.addChild("#", (l10n("urlReference") + ' '));
        peerAdditionForm.addChild("input", new String[] { "id", "type", "name" }, new String[] { "refurl", "text",
                "url" });
        peerAdditionForm.addChild("br");
        peerAdditionForm.addChild("#", (l10n("fileReference") + ' '));
        peerAdditionForm.addChild("input", new String[] { "id", "type", "name" }, new String[] { "reffile", "file",
                "reffile" });
        peerAdditionForm.addChild("br");
        ...
        if (!isOpennet) {
            ...
            for (FRIEND_TRUST trust : FRIEND_TRUST.valuesBackwards()) {    // FIXME reverse order
                HTMLNode input = peerAdditionForm.addChild("br").addChild("input", new String[] { "type", "name",
                        "value" }, new String[] { "radio", "trust", trust.name() });
            ...
            for (FRIEND_VISIBILITY visibility : FRIEND_VISIBILITY.values()) {    // FIXME reverse order
                HTMLNode input = peerAdditionForm.addChild("br").addChild("input", new String[] { "type", "name",
                        "value" }, new String[] { "radio", "visibility", visibility.name() });
        ...
        if (!isOpennet) {
            ...
            peerAdditionForm.addChild("input", new String[] {
                "id", "type", "name", "size", "maxlength", "value"
            }, new String[] {
        ...
        peerAdditionForm.addChild("input", new String[] { "type", "name", "value" }, new String[] { "submit", "add",
                l10n("add") });
    }
    ...
    private void drawRow(HTMLNode peerTable, PeerNodeStatus peerNodeStatus, boolean advancedModeEnabled,
                         ...
                         SimpleColumn[] endCols, boolean drawMessageTypes, double totalSelectionRate,
                         DecimalFormat fix1) {
        ...
        peerRow.addChild("td", "class", "peer-status").addChild("span", "class", peerNodeStatus.getStatusCSSName(),
                         NodeL10n.getBase().getString("ConnectionsToadlet.nodeStatus." + statusString)
        ...
        if ((peerNodeStatus.getStatusValue() != PeerManager.PEER_NODE_STATUS_NEVER_CONNECTED)
                && (peerNodeStatus.isPublicInvalidVersion() || peerNodeStatus.isPublicReverseInvalidVersion())) {    // Don't draw attention to a version problem if NEVER CONNECTED
