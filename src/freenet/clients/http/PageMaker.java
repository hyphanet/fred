...
public final class PageMaker {
    ...
    public enum THEME {
        ...
        public static final String[] possibleValues = {
            BOXED.code, BOXED_CLASSIC.code, BOXED_DROPDOWN.code, BOXED_DYNAMIC.code, BOXED_STATIC.code, CLEAN.code,
            CLEAN_CLASSIC.code, CLEAN_DROPDOWN.code, CLEAN_STATIC.code, CLEAN_TOP.code, GRAYANDBLUE.code,
            GRAYANDBLUE_DYNAMIC.code, GRAYANDBLUE_DROPDOWN.code, GRAYANDBLUE_STATIC.code, GRAYANDBLUE_TOP.code,
            SKY.code, SKY_CLASSIC.code, SKY_DROPDOWN.code, SKY_DYNAMIC.code, SKY_STATIC.code, MINIMALBLUE.code,
            MINIMALISTIC.code, RABBIT_HOLE.code
        };
    ...
    public PageNode getPageNode(String title, ToadletContext ctx, RenderParameters renderParameters) {
        ...
        headNode.addChild("meta", new String[] { "http-equiv", "content" }, new String[] { "Content-Type",
        ...
        if (webPushingEnabled) {
            headNode.addChild("script", new String[] { "type", "language", "src" }, new String[] { "text/javascript",
                    "javascript", "/static/freenetjs/freenetjs.nocache.js" });
        }
        ...
        HTMLNode bodyNode = htmlNode.addChild("body", new String[] { "class", "id" }, new String[] { "fproxy-page",
                filterCSSIdentifier("page-" + activePath) });

        // Add a hidden input that has the request's id
        if (webPushingEnabled) {
            bodyNode.addChild("input", new String[] { "type", "name", "value", "id" }, new String[] { "hidden",
                    "requestId", ctx.getUniqueId(), "requestId" });
        }

        // Add the client-side localization only when pushing is enabled
        if (webPushingEnabled) {
            bodyNode.addChild("script", new String[] { "type", "language" }, new String[] { "text/javascript",
                    "javascript" }).addChild("%", PushingTagReplacerCallback.getClientSideLocalizationScript());
        }
        ...
        if (renderParameters.isRenderStatus() && fullAccess) {
            ...
            if ((node != null) && (node.clientCore != null)) {
                ...
                final HTMLNode physical =
                    secLevels.addChild("a", "href", "/seclevels/",
                ...
                progressBar.addChild("div", new String[] { "class", "title" },
                        ...
                        new String[] { Integer.toString(node.peers.countConnectedDarknetPeers()),
                                       Integer.toString(node.peers.countConnectedOpennetPeers()) }) }, Integer.toString(
                                           connectedPeers) + ((totalPeers != Integer.MAX_VALUE)
            ...
            synchronized (this) {
                for (SubMenu menu : menuList) {
                    ...
                    for (String navigationLink :
                        ...
                        if (navigationTitle != null) {
                            sublistItem.addChild("a", new String[] { "href", "title" }, new String[] { navigationPath,
                    ...
                    if (nonEmpty) {
                        ...
                        listItem.addChild("a", new String[] { "href", "title" },
                                          new String[] { menu.defaultNavigationLink,
                                                         menuItemTitle }, text);
    ...
    private HTMLNode getOverrideContent() {
        return new HTMLNode("link", new String[] { "rel", "href", "type", "media", "title" },
                            new String[] { "stylesheet",
                                           override, "text/css", "screen", "custom" });
    }
    ...
    private static class SubMenu {
        ...
        private final Map<String, LinkEnabledCallback> navigationLinkCallbacks = new HashMap<String,
                                                                                     LinkEnabledCallback>();
