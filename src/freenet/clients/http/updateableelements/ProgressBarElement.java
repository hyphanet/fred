            ...
            if (fr.isFinished() || fr.hasData() || (fr.failed != null)) {
                ...
                if (fr.finalizedBlocks) {
                    progressBar.addChild("div", new String[] { "class", "title" },
                            ...
                            prefix + NodeL10n.getBase().getString("QueueToadlet.progressbarAccurate") }, nf.format(
                                (int) ((fr.fetchedBlocks / (double) total) * 1000) / 10.0) + '%');
                } else {
                    ...
                    progressBar.addChild("div", new String[] { "class", "title" },
                            ...
                            prefix + NodeL10n.getBase().getString("QueueToadlet.progressbarNotAccurate") }, text);
                }
            }
        }
