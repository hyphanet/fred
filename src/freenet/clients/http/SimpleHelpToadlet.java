...
public class SimpleHelpToadlet extends Toadlet {
	...
	public void handleMethodGET(
		...
		PageNode page = ctx
			.getPageMaker()
			.getPageNode(
				"Freenet " + NodeL10n.getBase().getString("FProxyToadlet.help"),
				ctx
			);
		...
		// Description infobox
		HTMLNode helpScreenContent1 = ctx
			.getPageMaker()
			.getInfobox(
				"infobox-content",
				NodeL10n.getBase()
					.getString("SimpleHelpToadlet.descriptionTitle"),
				contentNode,
				"freenet-description",
				true
			);
		...
		// Definitions infobox
		HTMLNode helpScreenContent2 = ctx
			.getPageMaker()
			.getInfobox(
				"infobox-content",
				NodeL10n.getBase()
					.getString("SimpleHelpToadlet.definitionsTitle"),
				contentNode,
				"freenet-definitions",
				true
			);

		HTMLNode table = helpScreenContent2.addChild(
			"table",
		...
		row.addChild(
			"#",
			NodeL10n.getBase().getString("SimpleHelpToadlet.CHK")
		);
		row.addChild("br");
		row.addChild(
			"#",
			NodeL10n.getBase().getString("SimpleHelpToadlet.SSK")
		);
		row.addChild("br");
		row.addChild(
			"#",
			NodeL10n.getBase().getString("SimpleHelpToadlet.USK")
		);

		// Port forwarding, etc.
		HTMLNode helpScreenContent3 = ctx
			.getPageMaker()
			.getInfobox(
				"infobox-content",
				NodeL10n.getBase()
					.getString("SimpleHelpToadlet.connectivityTitle"),
				contentNode,
