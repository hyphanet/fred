...
public class SimpleHelpToadlet extends Toadlet {
    ...
    public void handleMethodGET(URI uri, HTTPRequest request, ToadletContext ctx)
        ...
        HTMLNode helpScreenContent1 = ctx.getPageMaker().getInfobox("infobox-content",
                                          ...
                                          contentNode, "freenet-description", true);
        ...
        HTMLNode helpScreenContent2 = ctx.getPageMaker().getInfobox("infobox-content",
                                          ...
                                          contentNode, "freenet-definitions", true);
        HTMLNode table = helpScreenContent2.addChild("table", new String[] { "border", "style" }, new String[] { "0",
                "border: none" });
        ...
        HTMLNode helpScreenContent3 = ctx.getPageMaker().getInfobox("infobox-content",
                                          ...
                                          contentNode, "freenet-connectivity", true);
