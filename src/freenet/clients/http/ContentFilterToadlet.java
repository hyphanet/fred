...
public class ContentFilterToadlet extends Toadlet implements LinkEnabledCallback {
     ...
     */
    public static enum ResultHandling { DISPLAY, SAVE }
            ...
            if (request.isPartSet("filter-local")) {
                try {
                    ...
                    responseHeaders.put("Location",
                                        LocalFileFilterToadlet.PATH + "?filter-operation=" + filterOperation
    ...
    private HTMLNode createContent(PageMaker pageMaker, ToadletContext ctx) {
        ...
        filterForm.addChild("input", new String[] { "type", "name", "value" }, new String[] { "hidden",
                "filter-operation", FilterOperation.BOTH.toString() });

        // display in browser or save to disk
        filterForm.addChild("input", new String[] { "type", "name", "value" }, new String[] { "radio",
        ...
        if (ctx.isAllowedFullAccess()) {
            ...
            filterForm.addChild("input", new String[] { "type", "name", "value" }, new String[] { "submit",
                    "filter-local", l10n("filterFileBrowseButton") + "..." });
            filterForm.addChild("br");
        }
        ...
        filterForm.addChild("#", " \u00a0 ");
        filterForm.addChild("input", new String[] { "type", "name", "value" }, new String[] { "submit", "filter-upload",
