...
public final class FProxyToadlet extends Toadlet implements RequestClient {
	...
	public void handleMethodGET(URI uri, HTTPRequest httprequest, ToadletContext ctx, int recursion) 
		...
		if(isBrowser(ua) && !ctx.disableProgressPage() && (accept == null || accept.indexOf("text/html") > -1) && !httprequest.isParameterSet("forcedownload") && !httprequest.isParameterSet("noprogress")) {
