...
public class ChatForumsToadlet extends Toadlet implements LinkEnabledCallback {
    ...
    public void handleMethodGET(URI uri, HTTPRequest req, ToadletContext ctx)
        ...
        NodeL10n.getBase().addL10nSubstitution(
            contentBox.addChild("p"), "ChatForumsToadlet.fsng", new String[] { "fsng" },
            new HTMLNode[] {
                HTMLNode.link(
        ...
        NodeL10n.getBase().addL10nSubstitution(
            li, "ChatForumsToadlet.fms", new String[] { "fms", "fms-help" }, new HTMLNode[] { HTMLNode.link(
        ...
        li = ul.addChild("li");
        NodeL10n.getBase().addL10nSubstitution(li, "ChatForumsToadlet.frost", new String[] { "frost-freenet",
                "frost-web" }, new HTMLNode[] { HTMLNode.link(
                "/freenet:USK@QRZAI1nSm~dAY2hTdzVWXmEhkaI~dso0OadnppBR7kE,wq5rHGBI7kpChBe4yRmgBChIGDug7Xa5SG9vYGXdxR0,AQACAAE/frost/14/"),
                HTMLNode.link(ExternalLinkToadlet.escape("http://jtcfrost.sourceforge.net/")) });
        li = ul.addChild("li");
        NodeL10n.getBase().addL10nSubstitution(
            li, "ChatForumsToadlet.sone", new String[] { "sone" }, new HTMLNode[] { HTMLNode.link(
                "/USK@nwa8lHa271k2QvJ8aa0Ov7IHAV-DFOCFgmDt3X6BpCI,DuQSUZiI~agF8c-6tjsFFGuZ8eICrzWCILB60nT8KKo,AQACAAE/sone/59/") });
