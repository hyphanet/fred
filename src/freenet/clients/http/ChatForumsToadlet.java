...
public class ChatForumsToadlet extends Toadlet implements LinkEnabledCallback {
    ...
    public void handleGet(URI uri, HTTPRequest req, ToadletContext ctx) throws ToadletContextClosedException, IOException {
		...
		L10n.addL10nSubstitution(li, "ChatForumsToadlet.frost", new String[] { "frost-freenet", "frost-web", "/link" }, 
				new String[] { "<a href=\"/freenet:USK@QRZAI1nSm~dAY2hTdzVWXmEhkaI~dso0OadnppBR7kE,wq5rHGBI7kpChBe4yRmgBChIGDug7Xa5SG9vYGXdxR0,AQACAAE/frost/9/\">", "<a href=\"/?_CHECKED_HTTP_=http://jtcfrost.sourceforge.net/\">", "</a>" });
		li = ul.addChild("li");
		L10n.addL10nSubstitution(li, "ChatForumsToadlet.fms", new String[] { "fms", "/link" }, new String[] { "<a href=\"/USK@0npnMrqZNKRCRoGojZV93UNHCMN-6UU3rRSAmP6jNLE,~BG-edFtdCC1cSH4O3BWdeIYa8Sw5DfyrSV-TKdO5ec,AQACAAE/fms/101/\">", "</a>" });
