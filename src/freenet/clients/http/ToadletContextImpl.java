...
public class ToadletContextImpl implements ToadletContext {
    ...
    public ToadletContextImpl(Socket sock, MultiValueTable<String, String> headers, BucketFactory bf,
                              ...
                              BookmarkManager bookmarkManager, URI uri, long uniqueID)
            throws IOException {
    ...
    private static void sendError(OutputStream os, int code, String httpReason, String message,
                                  boolean shouldDisconnect, MultiValueTable<String, String> mvt)
            throws IOException {
    ...
    private static void sendHTMLError(OutputStream os, int code, String httpReason, String htmlMessage,
                                      boolean disconnect, MultiValueTable<String, String> mvt)
            throws IOException {
        if (mvt == null) {
    ...
    public void sendReplyHeaders(int code, String desc, MultiValueTable<String, String> mvt, String mimeType,
                                 long length, boolean forceDisableJavascript)
            throws ToadletContextClosedException, IOException {
    ...
    public void sendReplyHeadersStatic(int replyCode, String replyDescription, MultiValueTable<String, String> mvt,
                                       String mimeType, long contentLength, Date mTime)
            throws ToadletContextClosedException, IOException {
        if (mTime == null) {
    ...
    private void sendReplyHeaders(int replyCode, String replyDescription, MultiValueTable<String, String> mvt,
                                  String mimeType, long contentLength, Date mTime, boolean isOutlinkConfirmationPage,
                                  boolean allowFrames, boolean enableJavascript)
            throws ToadletContextClosedException, IOException {
        if (closed) {
            throw new ToadletContextClosedException();
        }
    ...
    static void sendReplyHeaders(OutputStream sockOutputStream, int replyCode, String replyDescription,
                                 ...
                                 boolean disconnect, boolean allowScripts, boolean allowFrames)
            throws IOException {
    ...
    public static void handle(Socket sock, ToadletContainer container, PageMaker pageMaker,
        ...
        try {
            ...
            while (true) {
                ...
                if (split.length != 3) {
                    throw new ParseException("Could not parse request line (split.length=" + split.length + "): "
                                             + firstLine, -1);
                }
    ...
    private static void callToadletMethod(Toadlet t, String method, URI uri, HTTPRequestImpl req,
            ToadletContextImpl ctx, Bucket data, Socket sock, boolean methodIsConfigurable)
            throws Throwable {
