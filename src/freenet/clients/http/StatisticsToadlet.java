...
public class StatisticsToadlet extends Toadlet {
    ...
    public void handleMethodGET(URI uri, HTTPRequest request, ToadletContext ctx)
        ...
        synchronized (this) {
            ...
            if (node.isUsingWrapper()) {
                ...
                threadDumpForm.addChild("input", new String[] { "type", "name", "value" }, new String[] { "submit",
                        "getThreadDump", l10n("threadDumpButton") });
            }
            ...
            if (nodeConfig.config.get("logger").getBoolean("enabled")) {
                logsList.addChild("li").addChild("a", new String[] { "href", "target" }, new String[] { "/?latestlog",
                        "_blank" }, l10n("getLogs"));
            }
            ...
            if (advancedMode || (numberOfConnected + numberOfRoutingBackedOff > 0)) {
                ...
                drawPeerStatsBox(peerStatsInfobox, advancedMode, numberOfConnected, numberOfRoutingBackedOff,
                                 ...
                                 numberOfSeedServers, numberOfSeedClients, numberOfRoutingDisabled,
                                 numberOfClockProblem, numberOfConnError, numberOfDisconnecting, numberOfNoLoadStats,
                                 node);
            ...
            if (advancedMode) {
                ...
                if (incomingRequestsCount > 0) {
                    ...
                    addSpecialisation(nodeSpecialisationTable, myLocation, incomingRequestsCount,
                ...
                if ((outgoingLocalRequestsCount > 0) && (outgoingRequestsCount > 0)) {
                    ...
                    addCombinedSpecialisation(nodeSpecialisationTable, myLocation, outgoingLocalRequestsCount,
                                              outgoingLocalRequestLocation, outgoingRequestsCount,
    ...
    private void drawNodeVersionBox(HTMLNode versionInfobox) {
        ...
        versionInfoboxList.addChild("li",
                                    NodeL10n.getBase().getString("WelcomeToadlet.version", new String[] { "fullVersion",
                "build", "rev" }, new String[] { Version.publicVersion(), Integer.toString(Version.buildNumber()),
                Version.cvsRevision() }));
        versionInfoboxList.addChild("li",
                                    NodeL10n.getBase().getString("WelcomeToadlet.extVersion", new String[] { "build",
                "rev" }, new String[] { Integer.toString(NodeStarter.extBuildNumber), NodeStarter.extRevisionNumber }));
    ...
    private void drawJVMStatsBox(HTMLNode jvmStatsInfobox, boolean advancedModeEnabled) {
        ...
        jvmStatsList.addChild("li",
                              l10n("threads", new String[] { "running", "max" },
    ...
    protected static void drawPeerStatsBox(HTMLNode peerStatsInfobox, boolean advancedModeEnabled,
        ...
        if (numberOfConnected > 0) {
            ...
            peerStatsConnectedListItem.addChild("span", new String[] { "class", "title", "style" },
                    new String[] { "peer_connected",
                                   l10nDark("connected"),
                                   "border-bottom: 1px dotted; cursor: help;" }, l10nDark("connectedShort"));
        ...
        if (numberOfRoutingBackedOff > 0) {
            ...
            peerStatsRoutingBackedOffListItem.addChild("span", new String[] { "class", "title", "style" },
                    new String[] { "peer_backed_off",
                                   ...
                                   "border-bottom: 1px dotted; cursor: help;" }, l10nDark((advancedModeEnabled
                                       ? "backedOff" : "busy") + "Short"));
        ...
        if (numberOfTooNew > 0) {
            ...
            peerStatsTooNewListItem.addChild("span", new String[] { "class", "title", "style" },
                    ...
                    l10nDark("tooNew"), "border-bottom: 1px dotted; cursor: help;" }, l10nDark("tooNewShort"));
        ...
        if (numberOfTooOld > 0) {
            ...
            peerStatsTooOldListItem.addChild("span", new String[] { "class", "title", "style" },
                    ...
                    l10nDark("tooOld"), "border-bottom: 1px dotted; cursor: help;" }, l10nDark("tooOldShort"));
        ...
        if (numberOfDisconnected > 0) {
            ...
            peerStatsDisconnectedListItem.addChild("span", new String[] { "class", "title", "style" },
                    new String[] { "peer_disconnected",
                                   ...
                                   "border-bottom: 1px dotted; cursor: help;" }, l10nDark("notConnectedShort"));
        ...
        if (numberOfNeverConnected > 0) {
            ...
            peerStatsNeverConnectedListItem.addChild("span", new String[] { "class", "title", "style" },
                    new String[] { "peer_never_connected",
                                   ...
                                   "border-bottom: 1px dotted; cursor: help;" }, l10nDark("neverConnectedShort"));
        ...
        if (numberOfDisabled > 0) {
            ...
            peerStatsDisabledListItem.addChild("span", new String[] { "class", "title", "style" },
                    ...
                    l10nDark("disabled"), "border-bottom: 1px dotted; cursor: help;" }, l10nDark("disabledShort"));
        ...
        if (numberOfBursting > 0) {
            ...
            peerStatsBurstingListItem.addChild("span", new String[] { "class", "title", "style" },
                    ...
                    l10nDark("bursting"), "border-bottom: 1px dotted; cursor: help;" }, l10nDark("burstingShort"));
        ...
        if (numberOfListening > 0) {
            ...
            peerStatsListeningListItem.addChild("span", new String[] { "class", "title", "style" },
                    new String[] { "peer_listening",
                                   l10nDark("listening"),
                                   "border-bottom: 1px dotted; cursor: help;" }, l10nDark("listeningShort"));
        ...
        if (numberOfListenOnly > 0) {
            ...
            peerStatsListenOnlyListItem.addChild("span", new String[] { "class", "title", "style" },
                    new String[] { "peer_listen_only",
                                   l10nDark("listenOnly"),
                                   "border-bottom: 1px dotted; cursor: help;" }, l10nDark("listenOnlyShort"));
        ...
        if (numberOfClockProblem > 0) {
            ...
            peerStatsRoutingDisabledListItem.addChild("span", new String[] { "class", "title", "style" },
                    new String[] { "peer_clock_problem",
                                   l10nDark("clockProblem"),
                                   "border-bottom: 1px dotted; cursor: help;" }, l10nDark("clockProblemShort"));
        ...
        if (numberOfConnError > 0) {
            ...
            peerStatsRoutingDisabledListItem.addChild("span", new String[] { "class", "title", "style" },
                    new String[] { "peer_routing_disabled",
                                   l10nDark("connError"),
                                   "border-bottom: 1px dotted; cursor: help;" }, l10nDark("connErrorShort"));
            peerStatsRoutingDisabledListItem.addChild("span", ":\u00a0" + numberOfClockProblem);
        }
        ...
        if (numberOfDisconnecting > 0) {
            ...
            peerStatsListenOnlyListItem.addChild("span", new String[] { "class", "title", "style" },
                    new String[] { "peer_disconnecting",
                                   l10nDark("disconnecting"),
                                   "border-bottom: 1px dotted; cursor: help;" }, l10nDark("disconnectingShort"));
        ...
        if (numberOfSeedServers > 0) {
            ...
            peerStatsSeedServersListItem.addChild("span", new String[] { "class", "title", "style" },
                    new String[] { "peer_listening" /* FIXME */,
                                   l10nDark("seedServers"),
                                   "border-bottom: 1px dotted; cursor: help;" }, l10nDark("seedServersShort"));
        ...
        if (numberOfSeedClients > 0) {
            ...
            peerStatsSeedClientsListItem.addChild("span", new String[] { "class", "title", "style" },
                    new String[] { "peer_listening" /* FIXME */,
                                   ...
                                   "border-bottom: 1px dotted; cursor: help;" }, l10nDark("seedClientsShort"));
        ...
        if (numberOfRoutingDisabled > 0) {
            ...
            peerStatsRoutingDisabledListItem.addChild("span", new String[] { "class", "title", "style" },
                    new String[] { "peer_routing_disabled",
                                   ...
                                   "border-bottom: 1px dotted; cursor: help;" }, l10nDark("routingDisabledShort"));
        ...
        if (numberOfNoLoadStats > 0) {
            ...
            peerStatsNoLoadStatsListItem.addChild("span", new String[] { "class", "title", "style" },
                    new String[] { "peer_no_load_stats",
                                   l10nDark("noLoadStats"),
                                   "border-bottom: 1px dotted; cursor: help;" }, l10nDark("noLoadStatsShort"));
    ...
    static void drawBandwidth(HTMLNode activityList, Node node, long nodeUptimeSeconds, boolean isAdvancedModeEnabled) {
        ...
        activityList.addChild("li",
                              l10n("totalInput", new String[] { "total" },
                                   new String[] { SizeUtil.formatSize(overall_total_in, true) }));
        activityList.addChild("li",
                              l10n("totalOutput", new String[] { "total" },
        ...
        if (isAdvancedModeEnabled) {
            ...
            long totalBytesSentRemaining = total[0]
                                           - (totalPayload + totalBytesSentCHKRequests + totalBytesSentSSKRequests
                                              ...
                                              + totalBytesSentOfferedKeys + totalBytesSendOffers
                                              + totalBytesSentSwapOutput + totalBytesSentAuth + totalBytesSentAckOnly
                                              + totalBytesSentResends + totalBytesSentUOM + totalBytesSentAnnounce
                                              + totalBytesSentRoutingStatus + totalBytesSentNetworkColoring
                                              + totalBytesSentPing + totalBytesSentProbeRequest + totalBytesSentRouted
                                              + totalBytesSentDisconn + totalBytesSentInitial + totalBytesSentChangedIP
                                              + totalBytesSentNodeToNode + totalBytesSentAllocationNotices
                                              + totalBytesSentFOAF);
            ...
            activityList.addChild("li", l10n("adminBytes", new String[] { "routingStatus", "disconn", "initial",
                    "changedIP" }, new String[] { SizeUtil.formatSize(totalBytesSentRoutingStatus, true),
                    SizeUtil.formatSize(totalBytesSentDisconn, true), SizeUtil.formatSize(totalBytesSentInitial, true),
                    SizeUtil.formatSize(totalBytesSentChangedIP, true) }));
            activityList.addChild("li", l10n("debuggingBytes", new String[] { "netColoring", "ping", "probe",
                    "routed" }, new String[] { SizeUtil.formatSize(totalBytesSentNetworkColoring, true),
            ...
            activityList.addChild("li",
                                  l10n("nodeToNodeBytes", "total",
                                       SizeUtil.formatSize(totalBytesSentNodeToNode, true)));
            activityList.addChild("li",
                                  l10n("loadAllocationNoticesBytes", "total",
    ...
    static HTMLNode drawActivity(HTMLNode activityInfoboxContent, Node node) {
        ...
        if ((numTransferringRequests == 0) && (numCHKRequests == 0) && (numSSKRequests == 0) && (numCHKInserts == 0)
            ...
            if ((numCHKInserts > 0) || (numSSKInserts > 0)) {
                activityList.addChild("li",
                                      NodeL10n.getBase().getString("StatisticsToadlet.activityInserts",
                                          new String[] { "CHKhandlers",
                        "SSKhandlers", "local" }, new String[] { Integer.toString(numCHKInserts),
            ...
            if ((numCHKRequests > 0) || (numSSKRequests > 0)) {
                activityList.addChild("li",
                                      NodeL10n.getBase().getString("StatisticsToadlet.activityRequests",
                                          new String[] { "CHKhandlers",
                        "SSKhandlers", "local" }, new String[] { Integer.toString(numCHKRequests),
            ...
            if ((numTransferringRequests > 0) || (numTransferringRequestHandlers > 0)) {
                activityList.addChild("li",
                                      NodeL10n.getBase().getString("StatisticsToadlet.transferringRequests",
                                          new String[] { "senders",
                        "receivers", "turtles" }, new String[] { Integer.toString(numTransferringRequests),
                        Integer.toString(numTransferringRequestHandlers), "0" }));
            }

            if ((numCHKOfferReplys > 0) || (numSSKOfferReplys > 0)) {
                activityList.addChild("li",
                                      NodeL10n.getBase().getString("StatisticsToadlet.offerReplys",
                                          new String[] { "chk",
                        "ssk" }, new String[] { Integer.toString(numCHKOfferReplys),
            ...
            activityList.addChild("li",
                                  NodeL10n.getBase().getString("StatisticsToadlet.runningBlockTransfers",
                                      new String[] { "sends",
                    "receives" }, new String[] { Integer.toString(BlockTransmitter.getRunningSends()),
    ...
    private void drawOverviewBox(HTMLNode overviewInfobox, long nodeUptimeSeconds, long nodeUptimeTotal, long now,
        ...
        overviewList.addChild("li",
                              ...
                              + fix3p1pct.format(stats.pRejectIncomingInstantlyCHKRequestBulk()) + " (CHK) "
                              + fix3p1pct.format(stats.pRejectIncomingInstantlySSKRequestBulk()) + " (SSK)");
        overviewList.addChild("li",
                              "pInstantRejectInsertBulk:\u00a0"
                              + fix3p1pct.format(stats.pRejectIncomingInstantlyCHKInsertBulk()) + " (CHK) "
                              + fix3p1pct.format(stats.pRejectIncomingInstantlySSKInsertBulk()) + " (SSK)");
        overviewList.addChild("li",
                              "pInstantRejectRequestRT:\u00a0"
                              + fix3p1pct.format(stats.pRejectIncomingInstantlyCHKRequestRT()) + " (CHK) "
                              + fix3p1pct.format(stats.pRejectIncomingInstantlySSKRequestRT()) + " (SSK)");
        overviewList.addChild("li",
                              "pInstantRejectInsertRT:\u00a0"
                              + fix3p1pct.format(stats.pRejectIncomingInstantlyCHKInsertRT()) + " (CHK) "
                              + fix3p1pct.format(stats.pRejectIncomingInstantlySSKInsertRT()) + " (SSK)");
    ...
    private void getThreadNames(HTMLNode threadUsageList) {
        ...
        for (ThreadBunch bunch : bunches) {
            ...
            threadUsageList.addChild("li",
                                     "" + bunch.name + ":\u00a0" + Integer.toString(bunch.count) + "\u00a0("
    ...
    private void addNodeCircle(HTMLNode circleTable, double myLocation) {
        ...
        nodeCircleInfoboxContent.addChild("span", new String[] { "style", "class" },
                                          new String[] { generatePeerCircleStyleString(0, false, 1.0),
                "mark" }, "|");
        nodeCircleInfoboxContent.addChild("span", new String[] { "style", "class" },
                                          new String[] { generatePeerCircleStyleString(0.125, false, 1.0),
                "mark" }, "+");
        nodeCircleInfoboxContent.addChild("span", new String[] { "style", "class" },
                                          new String[] { generatePeerCircleStyleString(0.25, false, 1.0),
                "mark" }, "--");
        nodeCircleInfoboxContent.addChild("span", new String[] { "style", "class" },
                                          new String[] { generatePeerCircleStyleString(0.375, false, 1.0),
                "mark" }, "+");
        nodeCircleInfoboxContent.addChild("span", new String[] { "style", "class" },
                                          new String[] { generatePeerCircleStyleString(0.5, false, 1.0),
                "mark" }, "|");
        nodeCircleInfoboxContent.addChild("span", new String[] { "style", "class" },
                                          new String[] { generatePeerCircleStyleString(0.625, false, 1.0),
                "mark" }, "+");
        nodeCircleInfoboxContent.addChild("span", new String[] { "style", "class" },
                                          new String[] { generatePeerCircleStyleString(0.75, false, 1.0),
                "mark" }, "--");
        nodeCircleInfoboxContent.addChild("span", new String[] { "style", "class" },
                                          new String[] { generatePeerCircleStyleString(0.875, false, 1.0),
                "mark" }, "+");
        nodeCircleInfoboxContent.addChild("span", new String[] { "style", "class" },
                                          new String[] {
                                              "position: absolute; top: " + PEER_CIRCLE_RADIUS + "px; left: "
                                                  + (PEER_CIRCLE_RADIUS + PEER_CIRCLE_ADDITIONAL_FREE_SPACE) + "px",
                "mark" }, "+");
        ...
        for (int i = 0; i < locations.length; i++) {
            ...
            nodeCircleInfoboxContent.addChild("span", new String[] { "style", "class" },
                                              new String[] {
                                                  generatePeerCircleStyleString(location.doubleValue(), false,
                                                      strength),
                    "connected" }, "x");
        }

        nodeCircleInfoboxContent.addChild("span", new String[] { "style", "class" },
                                          new String[] { generatePeerCircleStyleString(myLocation, true, 1.0),
                "me" }, "x");
    ...
    private void addSpecialisation(HTMLNode table, double peerLocation, int incomingRequestsCount,
        ...
        for (int i = 0; i < incomingRequestLocation.length; i++) {
            ...
            nodeHistogramGraphCell.addChild("div", new String[] { "class", "style" },
                    ...
                    "height: " + fix3pctUS.format(((double) incomingRequestLocation[i]) / incomingRequestsCount)
                    + "; width: 100%;" }, "\u00a0");
        }
    }

    private void addCombinedSpecialisation(HTMLNode table, double peerLocation, int locallyOriginatingRequestsCount,
            int[] locallyOriginatingRequests, int remotelyOriginatingRequestsCount, int[] remotelyOriginatingRequests) {
    ...
    private void addPeerCircle(HTMLNode circleTable, PeerNodeStatus[] peerNodeStatuses, double myLocation) {
        ...
        for (int peerIndex = 0; peerIndex < peerCount; peerIndex++) {
            ...
            if ((peerLocation < 0.0) || (peerLocation > 1.0)) {
                continue;
            }
            ...
            if ((foafLocations != null) && peerNodeStatus.isRoutable()) {
                for (double foafLocation : foafLocations) {
                    ...
                    peerCircleInfoboxContent.addChild("span", new String[] { "style", "class" },
                                                      new String[] {
                                                          generatePeerCircleStyleString(foafLocation, false, 0.9),
                            "disconnected" }, ".");
                }
            }
            ...
            peerCircleInfoboxContent.addChild("span", new String[] { "style", "class" },
                                              new String[] {
                                                  generatePeerCircleStyleString(peerLocation, false,
                                                      (1.0 - peerNodeStatus.getPReject())),
                    ((peerNodeStatus.isConnected()) ? "connected" : "disconnected") }, ((peerNodeStatus.isOpennet())
                    ? "o" : "x"));
        }
        ...
        for (int i = 0; i < HISTOGRAM_LENGTH; i++) {
            ...
            peerHistogramLegendCell.addChild("div", "class", "histogramLabel").addChild("#",
                                             fix1p2.format(((double) i) / (HISTOGRAM_LENGTH * 2)));

            //
            histogramPercent = ((double) histogramConnected[i]) / newPeerCount;
            peerHistogramGraphCell.addChild("div", new String[] { "class", "style" },
                                            new String[] { "histogramConnected",
