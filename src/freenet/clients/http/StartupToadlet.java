...
public class StartupToadlet extends Toadlet {
	...
	public void handleMethodGET(URI uri, HTTPRequest req, ToadletContext ctx)
		...
		if (
			path.startsWith(StaticToadlet.ROOT_URL) && staticToadlet != null
			...
			headNode.addChild(
				...
				new String[] { "refresh", "1; url=" }
			);
			HTMLNode contentNode = page.content;

			if (!isPRNGReady) {
				HTMLNode prngInfoboxContent = ctx
					.getPageMaker()
					.getInfobox(
						"infobox-error",
						NodeL10n.getBase()
				...
				prngInfoboxContent.addChild(
					"#",
					NodeL10n.getBase()
						.getString("StartupToadlet.entropyErrorContent")
				);
			}
			...
			infoboxContent.addChild(
				"#",
				NodeL10n.getBase().getString("StartupToadlet.isStartingUp")
			);
