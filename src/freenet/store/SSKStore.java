...
public class SSKStore extends StoreCallback<SSKBlock> {
	...
	public SSKBlock construct(
		...
		if (data == null || headers == null) throw new SSKVerifyException(
			"Need data and headers"
		);
		if (fullKey == null) throw new SSKVerifyException(
			"Need full key to reconstruct an SSK"
		);
		NodeSSK key;
