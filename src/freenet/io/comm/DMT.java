...
public class DMT {
    ...
    public static final MessageType testSendCompleted = new MessageType("testSendCompleted", PRIORITY_UNSPECIFIED,
                                                            true, false) {
        {
            addField(UID, Long.class);
            addField(SUCCESS, Boolean.class);
    ...
    // FIXME get rid???
    public final static MessageType FNPOpennetAnnounceNodeNotWanted =
    ...
    public static int packetTransmitSize(int size, int _packets) {
        return size + 8 /* uid */ + 4 /* packet# */ + BitArray.serializedLength(_packets) + 4 /* Message header */;
    }
    ...
    public static Message createUOMAnnounce(String mainKey, String extraKey, String revocationKey,
            ...
            int revocationDNFCount, long revocationKeyLength, long mainJarLength, long extraJarLength, int pingTime,
