...
public class DMT {
	...
	public static final String ENABLE_INSERT_FORK_WHEN_CACHEABLE =
		"enableInsertForkWhenCacheable";
	...
	public static final MessageType packetTransmit = new MessageType(
		"packetTransmit",
		PRIORITY_BULK_DATA
	) {
		{
	...
	public static int packetTransmitSize(int size, int _packets) {
		return (
			...
			8 +
			/* uid */4 +
			/* packet# */BitArray.serializedLength(_packets) +
			4
		)/* Message header */;
	}
	...
	public static final MessageType allSent = new MessageType(
		"allSent",
		PRIORITY_BULK_DATA
	) {
		{
	...
	public static final MessageType allReceived = new MessageType(
		"allReceived",
	...
	public static final MessageType sendAborted = new MessageType(
		"sendAborted",
		PRIORITY_UNSPECIFIED
	) {
		{
	...
	public static Message createSendAborted(
		long uid,
		int reason,
		String description
	) {
	...
	public static final MessageType FNPBulkPacketSend = new MessageType(
		"FNPBulkPacketSend",
		PRIORITY_BULK_DATA
	) {
		{
	...
	public static Message createFNPBulkPacketSend(
		...
		return createFNPBulkPacketSend(
			uid,
			packetNo,
	...
	public static final MessageType FNPBulkSendAborted = new MessageType(
		"FNPBulkSendAborted",
		PRIORITY_UNSPECIFIED
	) {
		{
	...
	public static final MessageType FNPBulkReceiveAborted = new MessageType(
	...
	public static final MessageType FNPBulkReceivedAll = new MessageType(
		"FNPBulkReceivedAll",
		PRIORITY_UNSPECIFIED
	) {
		{
	...
	public static final MessageType testTransferSend = new MessageType(
		"testTransferSend",
		PRIORITY_UNSPECIFIED
	) {
		{
	...
	public static final MessageType testTransferSendAck = new MessageType(
		"testTransferSendAck",
		PRIORITY_UNSPECIFIED
	) {
		{
	...
	public static final MessageType testSendCHK = new MessageType(
		"testSendCHK",
		PRIORITY_UNSPECIFIED
	) {
		{
	...
	public static Message createTestSendCHK(
		long uid,
		String uri,
		Buffer header
	) {
	...
	public static final MessageType testRequest = new MessageType(
		"testRequest",
		PRIORITY_UNSPECIFIED
	) {
		{
	...
	public static final MessageType testDataNotFound = new MessageType(
		"testDataNotFound",
		PRIORITY_UNSPECIFIED
	) {
		{
	...
	public static final MessageType testDataReply = new MessageType(
		"testDataReply",
		PRIORITY_UNSPECIFIED
	) {
		{
	...
	public static final MessageType testSendCHKAck = new MessageType(
		"testSendCHKAck",
		PRIORITY_UNSPECIFIED
	) {
		{
	...
	public static final MessageType testDataReplyAck = new MessageType(
		"testDataReplyAck",
		PRIORITY_UNSPECIFIED
	) {
		{
	...
	public static final MessageType testDataNotFoundAck = new MessageType(
		"testDataNotFoundAck",
		PRIORITY_UNSPECIFIED
	) {
		{
	...
	public static final MessageType testReceiveCompleted = new MessageType(
	...
	public static Message createTestReceiveCompleted(
		long id,
		boolean success,
		String reason
	) {
	...
	public static final MessageType testSendCompleted = new MessageType(
		"testSendCompleted",
		PRIORITY_UNSPECIFIED,
		true,
		false
	...
	public static Message createTestSendCompleted(
		long id,
		boolean success,
		String reason
	) {
	...
	public static final MessageType nodeToNodeMessage = new MessageType(
		"nodeToNodeMessage",
		PRIORITY_LOW,
		false,
		false
	...
	// FNP messages
	public static final MessageType FNPCHKDataRequest = new MessageType(
		"FNPCHKDataRequest",
		PRIORITY_LOW
	) {
		{
	...
	public static Message createFNPCHKDataRequest(
		long id,
		short htl,
		NodeCHK key
	) {
	...
	public static final MessageType FNPSSKDataRequest = new MessageType(
		"FNPSSKDataRequest",
		PRIORITY_LOW
	) {
		{
	...
	public static final MessageType FNPRejectedLoop = new MessageType(
		"FNPRejectLoop",
		PRIORITY_HIGH
	) {
		{
	...
	public static final MessageType FNPRejectedOverload = new MessageType(
		"FNPRejectOverload",
		PRIORITY_HIGH
	) {
		{
	...
	public static Message createFNPRejectedOverload(
		...
		if (needsLoad) {
			if (realTimeFlag) msg.setNeedsLoadRT();
			else msg.setNeedsLoadBulk();
		}
		return msg;
	}

	public static final MessageType FNPAccepted = new MessageType(
		"FNPAccepted",
		PRIORITY_HIGH
	) {
		{
	...
	public static final MessageType FNPDataNotFound = new MessageType(
		"FNPDataNotFound",
		PRIORITY_UNSPECIFIED
	) {
		{
	...
	public static final MessageType FNPRecentlyFailed = new MessageType(
		"FNPRecentlyFailed",
		PRIORITY_HIGH
	) {
		{
	...
	public static final MessageType FNPCHKDataFound = new MessageType(
		"FNPCHKDataFound",
		PRIORITY_UNSPECIFIED
	) {
		{
	...
	public static final MessageType FNPRouteNotFound = new MessageType(
		"FNPRouteNotFound",
		PRIORITY_UNSPECIFIED
	) {
		{
	...
	public static final MessageType FNPInsertRequest = new MessageType(
		"FNPInsertRequest",
		PRIORITY_LOW
	) {
		{
	...
	public static final MessageType FNPInsertReply = new MessageType(
		"FNPInsertReply",
		PRIORITY_UNSPECIFIED
	) {
		{
	...
	public static final MessageType FNPDataInsert = new MessageType(
		"FNPDataInsert",
		PRIORITY_HIGH
	) {
		{
	...
	public static Message createFNPInsertTransfersCompleted(
		long uid,
		boolean anyTimedOut
	) {
	...
	public static final MessageType FNPRejectedTimeout = new MessageType(
		"FNPTooSlow",
		PRIORITY_UNSPECIFIED
	) {
		{
	...
	public static final MessageType FNPDataInsertRejected = new MessageType(
	...
	public static String getDataInsertRejectedReason(short reason) {
		if (
			reason == DATA_INSERT_REJECTED_VERIFY_FAILED
		) return "Verify failed";
		else if (
			reason == DATA_INSERT_REJECTED_RECEIVE_FAILED
		) return "Receive failed";
		else if (reason == DATA_INSERT_REJECTED_SSK_ERROR) return "SSK error";
		else if (
			reason == DATA_INSERT_REJECTED_TIMEOUT_WAITING_FOR_ACCEPTED
	...
	public static final MessageType FNPSSKInsertRequest = new MessageType(
		"FNPSSKInsertRequest",
		PRIORITY_BULK_DATA
	) {
		{
	...
	public static final MessageType FNPSSKInsertRequestNew = new MessageType(
	...
	public static Message createFNPSSKInsertRequestNew(
		long uid,
		short htl,
		NodeSSK myKey
	) {
	...
	public static final MessageType FNPSSKInsertRequestData = new MessageType(
	...
	public static Message createFNPSSKInsertRequestData(
		long uid,
		byte[] data,
		boolean realTime
	) {
	...
	public static final MessageType FNPSSKDataFoundHeaders = new MessageType(
	...
	public static Message createFNPSSKDataFoundHeaders(
		long uid,
		byte[] headers,
		boolean realTime
	) {
	...
	public static final MessageType FNPSSKDataFoundData = new MessageType(
		"FNPSSKDataFoundData",
		PRIORITY_BULK_DATA
	) {
		{
	...
	public static Message createFNPSSKDataFoundData(
		long uid,
		byte[] data,
		boolean realTime
	) {
	...
	public static final MessageType FNPSSKAccepted = new MessageType(
		"FNPSSKAccepted",
		PRIORITY_HIGH
	) {
		{
	...
	public static final MessageType FNPSSKPubKey = new MessageType(
		"FNPSSKPubKey",
		PRIORITY_BULK_DATA
	) {
		{
	...
	public static Message createFNPSSKPubKey(
		long uid,
		DSAPublicKey pubkey,
		boolean realTime
	) {
	...
	public static final MessageType FNPSSKPubKeyAccepted = new MessageType(
	...
	public static final MessageType FNPOpennetCompletedAck = new MessageType(
	 ...
	 */
	public static final MessageType FNPOpennetConnectReplyNew = new MessageType(
		"FNPConnectReplyNew",
		PRIORITY_UNSPECIFIED
	) {
		{
	 ...
	 */
	public static final MessageType FNPOpennetAnnounceRequest = new MessageType(
	 ...
	 */
	public static final MessageType FNPOpennetAnnounceReply = new MessageType(
	...
	public static final MessageType FNPOpennetDisabled = new MessageType(
		"FNPOpennetDisabled",
		PRIORITY_HIGH
	) {
		{
	...
	public static final MessageType FNPOpennetNoderefRejected = new MessageType(
	...
	public static Message createFNPOpennetNoderefRejected(
		long uid,
		int rejectCode
	) {
	...
	public static final MessageType FNPOfferKey = new MessageType(
		"FNPOfferKey",
		PRIORITY_LOW
	) {
		{
	...
	public static final MessageType FNPGetOfferedKey = new MessageType(
		"FNPGetOfferedKey",
		PRIORITY_LOW
	) {
		{
	...
	public static final MessageType FNPGetOfferedKeyInvalid = new MessageType(
	...
	public static Message createFNPGetOfferedKeyInvalid(
		long uid,
		short reason
	) {
	...
	public static final MessageType FNPPing = new MessageType(
		"FNPPing",
		PRIORITY_HIGH
	) {
		{
	...
	public static final MessageType FNPPong = new MessageType(
		"FNPPong",
		PRIORITY_HIGH
	) {
		{
	...
	public static final MessageType FNPRHProbeReply = new MessageType(
		"FNPRHProbeReply",
		PRIORITY_UNSPECIFIED
	) {
		{
	...
	public static final MessageType ProbeRequest = new MessageType(
		"ProbeRequest",
		PRIORITY_HIGH
	) {
		{
	...
	public static final MessageType ProbeError = new MessageType(
		"ProbeError",
		PRIORITY_HIGH
	) {
		{
	...
	public static final MessageType ProbeRefused = new MessageType(
		"ProbeRefused",
		PRIORITY_HIGH
	) {
		{
	...
	public static final MessageType ProbeBandwidth = new MessageType(
		"ProbeBandwidth",
		PRIORITY_HIGH
	) {
		{
	...
	public static final MessageType ProbeBuild = new MessageType(
		"ProbeBuild",
		PRIORITY_HIGH
	) {
		{
	...
	public static final MessageType ProbeIdentifier = new MessageType(
		"ProbeIdentifier",
		PRIORITY_HIGH
	) {
		{
	...
	public static final MessageType ProbeLinkLengths = new MessageType(
		"ProbeLinkLengths",
		PRIORITY_HIGH
	) {
		{
	 ...
	 * @return Message with requested attributes.
	 */
	public static Message createProbeLinkLengths(
		long uid,
		float[] linkLengths
	) {
	...
	public static final MessageType ProbeLocation = new MessageType(
		"ProbeLocation",
		PRIORITY_HIGH
	) {
		{
	...
	public static final MessageType ProbeStoreSize = new MessageType(
		"ProbeStoreSize",
		PRIORITY_HIGH
	) {
		{
	...
	public static final MessageType ProbeUptime = new MessageType(
		"ProbeUptime",
		PRIORITY_HIGH
	) {
		{
	...
	public static final MessageType ProbeRejectStats = new MessageType(
		"ProbeRejectStats",
		PRIORITY_HIGH
	) {
		{
	...
	public static final byte bandwidthClassForCapacityUsage(
		int bandwidthLimit
	) {
	...
	public static final MessageType FNPSwapRequest = new MessageType(
		"FNPSwapRequest",
		PRIORITY_HIGH
	) {
		{
	...
	public static final MessageType FNPSwapRejected = new MessageType(
		"FNPSwapRejected",
		PRIORITY_HIGH
	) {
		{
	...
	public static final MessageType FNPSwapReply = new MessageType(
		"FNPSwapReply",
		PRIORITY_HIGH
	) {
		{
	...
	public static final MessageType FNPSwapCommit = new MessageType(
		"FNPSwapCommit",
		PRIORITY_HIGH
	) {
		{
	...
	public static final MessageType FNPSwapComplete = new MessageType(
		"FNPSwapComplete",
		PRIORITY_HIGH
	) {
		{
	...
	public static Message createFNPLocChangeNotificationNew(
		double myLocation,
		double[] locations
	) {
	...
	public static final MessageType FNPRoutedPing = new MessageType(
		"FNPRoutedPing",
		PRIORITY_LOW
	) {
		{
	...
	public static final MessageType FNPRoutedPong = new MessageType(
		"FNPRoutedPong",
		PRIORITY_LOW
	) {
		{
	...
	public static final MessageType FNPRoutedRejected = new MessageType(
		"FNPRoutedRejected",
		PRIORITY_UNSPECIFIED
	) {
		{
	...
	public static final MessageType FNPDetectedIPAddress = new MessageType(
	...
	public static final MessageType FNPTime = new MessageType(
		"FNPTime",
		PRIORITY_HIGH
	) {
		{
	...
	public static final MessageType FNPUptime = new MessageType(
		"FNPUptime",
		PRIORITY_LOW
	) {
		{
	...
	public static final MessageType FNPVisibility = new MessageType(
		"FNPVisibility",
		PRIORITY_HIGH
	) {
		{
	...
	public static final MessageType FNPSentPackets = new MessageType(
		"FNPSentPackets",
		PRIORITY_HIGH
	) {
		{
	...
	public static final MessageType FNPVoid = new MessageType(
		"FNPVoid",
		PRIORITY_LOW,
		false,
		true
	...
	public static final MessageType FNPDisconnect = new MessageType(
		"FNPDisconnect",
		PRIORITY_HIGH
	) {
		{
	...
	public static final MessageType UOMAnnouncement = new MessageType(
		"UOMAnnouncement",
		PRIORITY_LOW
	) {
		{
	...
	public static final MessageType UOMRequestRevocation = new MessageType(
	...
	// Used by new UOM.
	public static final MessageType UOMRequestMainJar = new MessageType(
		"UOMRequestMainJar",
		PRIORITY_LOW
	) {
		{
	...
	public static final MessageType UOMSendingRevocation = new MessageType(
	...
	public static Message createUOMSendingRevocation(
		long uid,
		long length,
		String key
	) {
	...
	public static final MessageType UOMSendingMainJar = new MessageType(
		"UOMSendingMainJar",
		PRIORITY_LOW
	) {
		{
	...
	public static Message createUOMSendingMainJar(
		long uid,
		long length,
		String key,
		int version
	...
	public static final MessageType UOMFetchDependency = new MessageType(
		"UOMFetchDependency",
		PRIORITY_LOW
	) {
		{
	...
	public static Message createUOMFetchDependency(
		long uid,
		byte[] hash,
		long length
	) {
	...
	public static final MessageType FNPSwapNodeUIDs = new MessageType(
		"FNPSwapNodeUIDs",
		PRIORITY_UNSPECIFIED
	) {
		{
	...
	public static final MessageType FNPBestRoutesNotTaken = new MessageType(
	...
	public static final MessageType FNPRoutingStatus = new MessageType(
		"FNPRoutingStatus",
		PRIORITY_HIGH
	) {
		{
	...
	public static final MessageType FNPSubInsertForkControl = new MessageType(
	...
	public static Message createFNPSubInsertForkControl(
		boolean enableInsertForkWhenCacheable
	) {
	...
	public static final MessageType FNPSubInsertPreferInsert = new MessageType(
	...
	public static Message createFNPSubInsertIgnoreLowBackoff(
	...
	public static final MessageType FNPRejectIsSoft = new MessageType(
		"FNPRejectIsSoft",
		PRIORITY_HIGH
	) {
		{
	...
	public static final MessageType FNPPeerLoadStatusByte = new MessageType(
	...
	public static final MessageType FNPPeerLoadStatusShort = new MessageType(
	...
	public static final MessageType FNPPeerLoadStatusInt = new MessageType(
	...
	public static Message createFNPPeerLoadStatus(PeerLoadStats stats) {
		Message msg;
		if (
			stats.expectedTransfersInCHK < 256 &&
			stats.expectedTransfersInSSK < 256 &&
			stats.expectedTransfersOutCHK < 256 &&
			stats.expectedTransfersOutSSK < 256 &&
			stats.averageTransfersOutPerInsert < 256 &&
			stats.maxTransfersOut < 256 &&
			stats.maxTransfersOutLowerLimit < 256 &&
			...
			msg.set(
				...
				(byte) stats.expectedTransfersOutCHK
			);
			msg.set(
				OTHER_TRANSFERS_IN_CHK,
				(byte) stats.expectedTransfersInCHK
			);
			msg.set(
				OTHER_TRANSFERS_OUT_SSK,
				(byte) stats.expectedTransfersOutSSK
			);
			msg.set(
				OTHER_TRANSFERS_IN_SSK,
				(byte) stats.expectedTransfersInSSK
			);
			msg.set(
				AVERAGE_TRANSFERS_OUT_PER_INSERT,
				(byte) stats.averageTransfersOutPerInsert
			);
			msg.set(MAX_TRANSFERS_OUT, (byte) stats.maxTransfersOut);
			msg.set(
				MAX_TRANSFERS_OUT_PEER_LIMIT,
				(byte) stats.maxTransfersOutPeerLimit
			);
			msg.set(
				MAX_TRANSFERS_OUT_LOWER_LIMIT,
				(byte) stats.maxTransfersOutLowerLimit
			);
			msg.set(
				MAX_TRANSFERS_OUT_UPPER_LIMIT,
				(byte) stats.maxTransfersOutUpperLimit
			);
		} else if (
			stats.expectedTransfersInCHK < 65536 &&
			stats.expectedTransfersInSSK < 65536 &&
			stats.expectedTransfersOutCHK < 65536 &&
			stats.expectedTransfersOutSSK < 65536 &&
			stats.averageTransfersOutPerInsert < 65536 &&
			stats.maxTransfersOut < 65536 &&
			stats.maxTransfersOutLowerLimit < 65536 &&
			...
			msg.set(
				OTHER_TRANSFERS_OUT_CHK,
				(short) stats.expectedTransfersOutCHK
			);
			msg.set(
				OTHER_TRANSFERS_IN_CHK,
				(short) stats.expectedTransfersInCHK
			);
			msg.set(
				OTHER_TRANSFERS_OUT_SSK,
				(short) stats.expectedTransfersOutSSK
			);
			msg.set(
				OTHER_TRANSFERS_IN_SSK,
				(short) stats.expectedTransfersInSSK
			);
			msg.set(
				AVERAGE_TRANSFERS_OUT_PER_INSERT,
				(short) stats.averageTransfersOutPerInsert
			);
			msg.set(MAX_TRANSFERS_OUT, (short) stats.maxTransfersOut);
			msg.set(
				MAX_TRANSFERS_OUT_PEER_LIMIT,
				(short) stats.maxTransfersOutPeerLimit
			);
			msg.set(
				MAX_TRANSFERS_OUT_LOWER_LIMIT,
				(short) stats.maxTransfersOutLowerLimit
			);
			msg.set(
				MAX_TRANSFERS_OUT_UPPER_LIMIT,
				(short) stats.maxTransfersOutUpperLimit
			);
		} else {
			...
			msg.set(
				MAX_TRANSFERS_OUT_UPPER_LIMIT,
				stats.maxTransfersOutUpperLimit
			);
		}
		msg.set(
			OUTPUT_BANDWIDTH_LOWER_LIMIT,
			(int) stats.outputBandwidthLowerLimit
		);
		msg.set(
			OUTPUT_BANDWIDTH_UPPER_LIMIT,
			(int) stats.outputBandwidthUpperLimit
		);
		msg.set(
			OUTPUT_BANDWIDTH_PEER_LIMIT,
			(int) stats.outputBandwidthPeerLimit
		);
		msg.set(
			INPUT_BANDWIDTH_LOWER_LIMIT,
			(int) stats.inputBandwidthLowerLimit
		);
		msg.set(
			INPUT_BANDWIDTH_UPPER_LIMIT,
			(int) stats.inputBandwidthUpperLimit
		);
		msg.set(
			INPUT_BANDWIDTH_PEER_LIMIT,
			(int) stats.inputBandwidthPeerLimit
		);
		msg.set(REAL_TIME_FLAG, stats.realTime);
		return msg;
	}

	public static final String AVERAGE_TRANSFERS_OUT_PER_INSERT =
	...
	public static final String MAX_TRANSFERS_OUT_PEER_LIMIT =
		"maxTransfersOutPeerLimit";
	/** Maximum transfers out, lower limit. If total is over the lower limit and our usage is over the
	 * peer limit, we will be rejected. */
	public static final String MAX_TRANSFERS_OUT_LOWER_LIMIT =
		"maxTransfersOutLowerLimit";
	/** Maximum transfers out, upper limit. If total is over the upper limit, everything is rejected. */
	public static final String MAX_TRANSFERS_OUT_UPPER_LIMIT =
		"maxTransfersOutUpperLimit";

	public static final String OUTPUT_BANDWIDTH_LOWER_LIMIT =
		"outputBandwidthLowerLimit";
	public static final String OUTPUT_BANDWIDTH_UPPER_LIMIT =
		"outputBandwidthUpperLimit";
	public static final String OUTPUT_BANDWIDTH_PEER_LIMIT =
		"outputBandwidthPeerLimit";
	public static final String INPUT_BANDWIDTH_LOWER_LIMIT =
		"inputBandwidthLowerLimit";
	public static final String INPUT_BANDWIDTH_UPPER_LIMIT =
		"inputBandwidthUpperLimit";
	public static final String INPUT_BANDWIDTH_PEER_LIMIT =
		"inputBandwidthPeerLimit";

	public static final String REAL_TIME_FLAG = "realTimeFlag";

	public static final MessageType FNPRealTimeFlag = new MessageType(
		"FNPRealTimeFlag",
		PRIORITY_HIGH
	) {
		{
	...
	public static final MessageType FNPCheckStillRunning = new MessageType(
	...
	public static final MessageType FNPIsStillRunning = new MessageType(
		"FNPIsStillRunning",
		PRIORITY_HIGH
	) {
		{
	...
	public static final MessageType FNPGetYourFullNoderef = new MessageType(
	...
	public static final MessageType FNPMyFullNoderef = new MessageType(
		"FNPMyFullNoderef",
		PRIORITY_LOW
	) {
		{
