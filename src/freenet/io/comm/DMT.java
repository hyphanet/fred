...
public class DMT {
  ...
  public static final MessageType UOMAnnouncement =
      new MessageType("UOMAnnouncement", PRIORITY_LOW) {
        {
  ...
  public static final MessageType UOMRequestRevocation =
      new MessageType("UOMRequestRevocation", PRIORITY_HIGH) {
        {
          addField(UID, Long.class);
        }
      };
  ...
  public static final MessageType UOMRequestMainJar =
      new MessageType("UOMRequestMainJar", PRIORITY_LOW) {
        {
          addField(UID, Long.class);
        }
      };
  ...
  public static final MessageType UOMSendingRevocation =
      new MessageType("UOMSendingRevocation", PRIORITY_HIGH) {
        {
          addField(UID, Long.class);
  ...
  public static final MessageType UOMSendingMainJar =
      new MessageType("UOMSendingMainJar", PRIORITY_LOW) {
        {
          addField(UID, Long.class);
          addField(FILE_LENGTH, Long.class);
          addField(MAIN_JAR_KEY, String.class);
  ...
  public static final MessageType UOMFetchDependency =
      new MessageType("UOMFetchDependency", PRIORITY_LOW) {
        {
  ...
  public static Message createFNPPeerLoadStatus(PeerLoadStats stats) {
    Message msg;
    if (stats.expectedTransfersInCHK < 256
    ...
    } else if (stats.expectedTransfersInCHK < 65536
