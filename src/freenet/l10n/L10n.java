...
public class L10n {
	...
	*/
	...
	public static void addL10nHTML(HTMLNode node, String key){
		addL10nSubstitution(node, key, new String[] { "p", "/p", "b", "/b", "br", "hr", "pre", "/pre", "i", "/i", "ul", "/ul", "ol", "/ol", "li", "center", "/center", "strike", "/strike", "blockquote", "/blockquote", "h1", "/h1", "h2", "/h2", "h3", "/h3", "h4", "/h4", "h5", "/h5", "h6", "/h6", "strong", "/strong", "table", "/table", "th", "/th", "tr", "/tr", "td", "/td" }, new String[] { "<p>", "</p>", "<b>", "</b>", "<br>", "<hr>", "<pre>", "</pre>", "<i>", "</i>", "<ul>", "</ul>", "<ol>", "</ol>", "<li>", "<center>", "</center>", "<strike>", "</strike>", "<blockquote>", "</blockquote>", "<h1>", "</h1>", "<h2>", "</h2>", "<h3>", "</h3>", "<h4>", "</h4>", "<h5>", "</h5>", "<h6>", "</h6>", "<strong>", "</strong>", "<table>", "</table>", "<th>", "</th>", "<tr>", "</tr>", "<td>", "</td>" });
	}
