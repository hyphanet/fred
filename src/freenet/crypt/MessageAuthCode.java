...
public final class MessageAuthCode {
	 ...
	 * @throws InvalidKeyException
	 */
	public MessageAuthCode(MACType type, ByteBuffer cryptoKey)
		throws InvalidKeyException {
	...
	public static final boolean verify(ByteBuffer mac1, ByteBuffer mac2) {
		...
		return MessageDigest.isEqual(
			Fields.copyToArray(mac1),
			Fields.copyToArray(mac2)
		);
	}
	 ...
	 * @throws InvalidAlgorithmParameterException
	 */
	public final void setIV(IvParameterSpec iv)
		throws InvalidAlgorithmParameterException {
		if (type.ivlen == -1) {
			throw new UnsupportedTypeException(type);
		}
