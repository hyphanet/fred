...
public class EncryptingIoAdapter extends IoAdapter {
    ...
    public void delete(String arg0) {
        ...
        try {
            ...
            System.err.println("Unable to secure delete " + arg0 + " for db4o, passing on to underlying adapter "
                               + baseAdapter + " to attempt a normal deletion.");
    ...
    public IoAdapter open(String arg0, boolean arg1, long arg2, boolean arg3) throws Db4oIOException {
        EncryptingIoAdapter adapter = new EncryptingIoAdapter(baseAdapter.open(arg0, arg1, arg2, arg3), key, random);
