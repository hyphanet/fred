...
public class SubConfig implements Comparable<SubConfig> {
    ...
    public void register(String optionName, int defaultValue, int sortOrder, boolean expert, boolean forceWrite,
        ...
        register(new BandwidthOption(this, optionName, defaultValue, sortOrder, expert, forceWrite, shortDesc,
                                     longDesc, cb));
    }
    ...
    public void register(String optionName, String defaultValueString, int sortOrder, boolean expert,
        ...
        register(new IntOption(this, optionName, defaultValueString, sortOrder, expert, forceWrite, shortDesc,
                               longDesc, cb, isSize));
    }
    ...
    public void register(String optionName, short defaultValue, int sortOrder, boolean expert, boolean forceWrite,
        ...
        register(new ShortOption(this, optionName, defaultValue, sortOrder, expert, forceWrite, shortDesc, longDesc,
                                 cb, isSize));
    }

    public void register(String optionName, String[] defaultValue, int sortOrder, boolean expert, boolean forceWrite,
                         String shortDesc, String longDesc, StringArrCallback cb) {
        register(new StringArrOption(this, optionName, defaultValue, sortOrder, expert, forceWrite, shortDesc,
                                     longDesc, cb));
    }
        ...
        for (Entry<String, Option<?>> entry : map.entrySet()) {
            ...
            if (val != null) {
                try {
                    ...
                    String msg = "Invalid config value: " + prefix + SimpleFieldSet.MULTI_LEVEL_CHAR + key + " = "
                                 + val + " : error: " + e;
    ...
    public SimpleFieldSet exportFieldSet(Config.RequestType configRequestType, boolean withDefaults) {
        ...
        @SuppressWarnings("unchecked") Map.Entry<String, Option<?>>[] entries = new Map.Entry[map.size()];
