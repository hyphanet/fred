...
public class FreenetFilePersistentConfig extends FilePersistentConfig {
	...
	public FreenetFilePersistentConfig(
		SimpleFieldSet set,
		File filename,
		File tempFilename
	) throws IOException {
	...
	public static FreenetFilePersistentConfig constructFreenetFilePersistentConfig(
		...
		return new FreenetFilePersistentConfig(
	...
	public void setHasNodeStarted() {
		synchronized (this) {
			if (hasNodeStarted) Logger.error(
				this,
				"It has already been called! that shouldn't happen!"
			);
