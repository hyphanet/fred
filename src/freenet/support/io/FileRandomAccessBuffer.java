...
public class FileRandomAccessBuffer
	...
	public FileRandomAccessBuffer(File filename, boolean readOnly)
		throws IOException {
		raf = new RandomAccessFile(filename, readOnly ? "r" : "rw");
	...
	public void close() {
		...
		try {
			...
			Logger.error(
				this,
				"Could not close " + raf + " : " + e + " for " + this,
				e
			);
		}
	}
	...
	public void onResume(ClientContext context) throws ResumeFailedException {
		...
		if (file.length() != length) throw new ResumeFailedException(
			"File is wrong length"
		);
		try {
