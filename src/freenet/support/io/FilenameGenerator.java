...
public class FilenameGenerator {
    ...
    public long getID(File file) {
        if (!(FileUtil.getCanonicalFile(file.getParentFile()).equals(tmpDir))) {
            Logger.error(this,
                         "Not the same dir: parent=" + FileUtil.getCanonicalFile(file.getParentFile()) + " but tmpDir="
                         + tmpDir);
    ...
    public void init(File dir, String prefix, Random random) throws IOException {
        ...
        System.err.println("Old: " + oldDir + " prefix " + this.prefix + " from " + tmpDir + " old path "
                           + tmpDir.getPath() + " old parent " + tmpDir.getParent());
        ...
        if (oldDir.equals(newDir) && this.prefix.equals(prefix)) {
            Logger.normal(this,
                          "Initialised FilenameGenerator successfully - no change in dir and prefix: dir=" + dir
                          + " prefix=" + prefix);
            ...
            if ((!dir.exists()) && oldDir.renameTo(dir)) {
                ...
                if (failed > 0) {
                    ...
                    System.err.println("WARNING: Not all files successfully moved changing temp dir: " + failed
                                       + " failed.");
