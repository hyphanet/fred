...
public class PaddedRandomAccessBucket
	...
	public OutputStream getOutputStream() throws IOException {
		OutputStream os;
		synchronized (this) {
			if (outputStreamOpen) throw new IOException(
				"Already have an OutputStream for " + this
			);
	...
	private class MyOutputStream extends FilterOutputStream {
		...
		public String toString() {
			return (
				"TrivialPaddedBucketOutputStream:" +
				out +
				"(" +
	...
	public RandomAccessBucket createShadow() {
		...
		PaddedRandomAccessBucket ret = new PaddedRandomAccessBucket(
			shadow,
			size
		);
		ret.setReadOnly();
