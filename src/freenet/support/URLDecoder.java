...
public class URLDecoder {
	 ...
	 *
	 **/
	public static String decode(String s, boolean tolerant)
		...
		for (int i = 0; i < len; i++) {
			...
			if (c == '%') {
				...
				try {
					...
					if (read == 0) throw new URLEncodedFormatException(
						"Can't encode" + " 00"
					);
				...
				byte[] encoded = String.valueOf(c).getBytes(
