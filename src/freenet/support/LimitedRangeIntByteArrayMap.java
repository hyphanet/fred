...
public class LimitedRangeIntByteArrayMap {
    ...
    public synchronized void lock(int index) throws InterruptedException {
        ...
        if (logMINOR) {
            Logger.minor(this,
                         toString() + " lock(" + index + ") - minValue = " + minValue + ", maxValue = " + maxValue
                         + ", maxRange=" + maxRange);
        }
        ...
        while (true) {
            ...
            if ((index - minValue < maxRange) || (minValue == -1)) {
                if (logMINOR) {
                    Logger.minor(this,
                                 "index=" + index + ", minValue=" + minValue + ", maxRange=" + maxRange
                                 + " - returning");
                }
    ...
    public synchronized void lockNeverBlock(int index) throws WouldBlockException {
        ...
        throw new WouldBlockException(toString() + " WOULD BLOCK: lockNeverBlock(" + index + ") - minValue = "
