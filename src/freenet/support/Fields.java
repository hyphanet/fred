	...
	public static final long dateTime(String date)
		...
		if((date.charAt(0) == '-') || (date.charAt(0) == '+')) {
			...
			if(date.length() == chop) {
				...
				if(deltaTypeString.startsWith("y")) {
					deltaType = Calendar.YEAR;
				} else if(deltaTypeString.startsWith("mo")) {
					deltaType = Calendar.MONTH;
				} else if(deltaTypeString.startsWith("w")) {
					deltaType = Calendar.WEEK_OF_YEAR;
				} else if(deltaTypeString.startsWith("d")) {
					deltaType = Calendar.DAY_OF_YEAR;
				} else if(deltaTypeString.startsWith("h")) {
					deltaType = Calendar.HOUR;
				} else if(deltaTypeString.startsWith("mi")) {
					deltaType = Calendar.MINUTE;
				} else if(deltaTypeString.startsWith("s")) {
