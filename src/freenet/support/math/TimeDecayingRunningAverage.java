...
public final class TimeDecayingRunningAverage implements RunningAverage, Cloneable {
    ...
    public TimeDecayingRunningAverage(double defaultValue, double halfLife, double min, double max,
                                      DataInputStream dis, TimeSkewDetectorCallback callback)
            throws IOException {
        int m = dis.readInt();
    ...
    public void report(double d) {
        synchronized (this) {
            ...
            if (!started) {
                ...
                if (thisInterval < 0) {
                    Logger.error(this,
                                 "Clock (reporting) went back in time, ignoring report: " + now + " was "
                ...
                if (uptime < 0) {
                    Logger.error(this,
                                 "Clock (uptime) went back in time, ignoring report: " + now + " was " + createdTime
                                 + " (back " + (-uptime) + "ms)");
                ...
                if (logDEBUG) {
                    Logger.debug(this,
                                 "Reported " + d + " on " + this + ": thisInterval=" + thisInterval + ", halfLife="
                                 + halfLife + ", uptime=" + uptime + ", thisHalfLife=" + thisHalfLife
                                 + ", changeFactor=" + changeFactor + ", oldCurValue=" + oldCurValue
                                 + ", currentValue=" + currentValue() + ", thisInterval=" + thisInterval
                                 + ", thisHalfLife=" + thisHalfLife + ", uptime=" + uptime + ", changeFactor="
                                 + changeFactor);
                }
            }
