...
public abstract class LoggerHook extends Logger {
	...
	private LogLevel parseThreshold(String threshold)
	...
	public void setDetailedThresholds(String details)
		...
		while (st.hasMoreTokens()) {
			...
			stuff.add(
				new DetailedThreshold(
					section,
					parseThreshold(value.toUpperCase())
				)
			);
		}
	...
	private void notifyLogThresholdCallbacks() {
		for (LogThresholdCallback ltc : thresholdsCallbacks) ltc.shouldUpdate();
	}
}
