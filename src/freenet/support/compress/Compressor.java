...
public interface Compressor {
    ...
    public enum COMPRESSOR_TYPE implements Compressor {
        ...
        GZIP("GZIP", new GzipCompressor(), (short) 0), BZIP2("BZIP2", new Bzip2Compressor(), (short) 1),
         ...
         */
        public static COMPRESSOR_TYPE[] getCompressorsArray(String compressordescriptor, boolean pre1254)
                throws InvalidCompressionCodecException {
        ...
        public Bucket compress(Bucket data, BucketFactory bf, long maxReadLength, long maxWriteLength)
            ...
            if (compressor == null) {
                ...
                if (name != null) {
                    return getOfficial().compress(data, bf, maxReadLength, maxWriteLength);
                }
            }
        ...
        public long compress(InputStream is, OutputStream os, long maxReadLength, long maxWriteLength)
            ...
            if (compressor == null) {
                ...
                // DB4O VOODOO! See below.
                if (name != null) {
                    return getOfficial().compress(is, os, maxReadLength, maxWriteLength);
                }
            }
        ...
        public long decompress(InputStream input, OutputStream output, long maxLength, long maxEstimateSizeLength)
            ...
            if (compressor == null) {
                ...
                // DB4O VOODOO! See below.
                if (name != null) {
                    return getOfficial().decompress(input, output, maxLength, maxEstimateSizeLength);
                }
            }
        ...
        public int decompress(byte[] dbuf, int i, int j, byte[] output) throws CompressionOutputSizeException {
            if (compressor == null) {
                ...
                // DB4O VOODOO! See below.
                if (name != null) {
                    return getOfficial().decompress(dbuf, i, j, output);
                }
            }
        ...
        private Compressor getOfficial() {
            ...
            if (name.equals("LZMA_OLD")) {
                return LZMA;
            }

            if (name.equals("LZMA_NEW")) {
                return LZMA_NEW;
            }
     ...
     */
    public abstract Bucket compress(Bucket data, BucketFactory bf, long maxReadLength, long maxWriteLength)
            throws IOException, CompressionOutputSizeException;
     ...
     * @throws CompressionOutputSizeException If the compressed data is larger than maxWriteLength.
     */
    public abstract long compress(InputStream input, OutputStream output, long maxReadLength, long maxWriteLength)
            throws IOException, CompressionOutputSizeException;
     ...
     */
    public abstract long decompress(InputStream input, OutputStream output, long maxLength, long maxEstimateSizeLength)
            throws IOException, CompressionOutputSizeException;
