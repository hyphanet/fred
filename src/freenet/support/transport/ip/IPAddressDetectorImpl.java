...
public class IPAddressDetectorImpl implements Runnable, IPAddressDetector {
	
	private static volatile boolean logDEBUG;

	static {
		Logger.registerClass(IPAddressDetectorImpl.class);
	}
	...
	private final NodeIPDetector detector;
         ...
         * @param detector
         */
        public IPAddressDetectorImpl(long interval, NodeIPDetector detector) {
	...
	protected synchronized boolean checkpoint() {
		final boolean logDEBUG = IPAddressDetectorImpl.logDEBUG;
