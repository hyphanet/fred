...
We've included the [Gradle Wrapper](https://docs.gradle.org/current/userguide/gradle_wrapper.html) as
...
We've [configured it](gradle/wrapper/gradle-wrapper.properties) to [verify the checksum](https://docs.gradle.org/current/userguide/gradle_wrapper.html#wrapper_checksum_verification)
...
To override values set in `build.gradle` put them into [the file](https://docs.gradle.org/current/userguide/build_environment.html)
